...
public class CAConfig {
    ...
    public static class Common {
        ...
        Common(ForgeConfigSpec.Builder builder) {
            ...
            ultimateShovelDamage = builder.define("Damage of the Ultimate Shovel:", 39.0f);
            ...
            emeraldShovelDamage = builder.define("Damage of the Emerald Shovel:", 9.0f);
            ...
            rubyShovelDamage = builder.define("Damage of the Ruby Shovel:", 19.0f);
            ...
            amethystShovelDamage = builder.define("Damage of the Amethyst Shovel:", 14.0f);
            ...
            tigersEyeShovelDamage = builder.define("Damage of the Tiger's Eye Shovel:", 11.0f);
