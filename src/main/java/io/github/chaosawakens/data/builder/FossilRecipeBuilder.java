...
public class FossilRecipeBuilder {
	...
	public void build(Consumer<IFinishedRecipe> consumer) {
		ResourceLocation itemId = NameUtil.from(this.result);
		ResourceLocation serializerId = NameUtil.from(this.serializer);
	...
	public static class Result implements IFinishedRecipe {
		...
		public void serializeRecipeData(JsonObject json) {
			...
			json.addProperty("result", NameUtil.from(builder.result).toString());
