...
public class CALootModifierProvider extends GlobalLootModifierProvider{
	...
	public CALootModifierProvider(DataGenerator gen, String modid) {
		super(gen, modid);
	}
	...
	protected void start() {
		add("ultimate_pickaxe_smelting", CALootModifiers.ULTIMATE_PICKAXE_SMELTING.get(), new UltimatePickaxeItem.UltimateAutoSmeltingModifier(
                new ILootCondition[] {
