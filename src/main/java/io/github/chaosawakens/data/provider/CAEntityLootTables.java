	...
	protected void addTables() {
				...
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								...
								.add(ItemLootEntry.lootTableItem(Items.LEATHER)
										.apply(SetCount.setCount(RandomValueRange.between(0.0F, 1.0F)))
										.apply(LootingEnchantBonus.lootingMultiplier(RandomValueRange.between(0.0F, 1.0F))))));
		add(CAEntityTypes.TREE_FROG.get(),
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								.setRolls(ConstantRange.exactly(1))
		...
		add(CAEntityTypes.ROBO_JEFFERY.get(),
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								.setRolls(ConstantRange.exactly(1))
								.add(ItemLootEntry.lootTableItem(CAItems.URANIUM_INGOT.get())
										.apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F)))
										.apply(LootingEnchantBonus.lootingMultiplier(RandomValueRange.between(1.0F, 1.0F)))))
						.withPool(LootPool.lootPool()
								.setRolls(ConstantRange.exactly(1))
								.add(ItemLootEntry.lootTableItem(CAItems.TITANIUM_INGOT.get())
										.apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F)))
										.apply(LootingEnchantBonus.lootingMultiplier(RandomValueRange.between(1.0F, 1.0F)))))
						.withPool(LootPool.lootPool()
								.setRolls(ConstantRange.exactly(1))
								.add(ItemLootEntry.lootTableItem(CABlocks.ALUMINUM_BLOCK.get())
				...
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								...
								.add(ItemLootEntry.lootTableItem(Items.BONE_BLOCK)
										.apply(SetCount.setCount(RandomValueRange.between(4.0F, 6.0F)))
										.when(KilledByPlayer.killedByPlayer())))
						.withPool(LootPool.lootPool()
								.setRolls(ConstantRange.exactly(1))
				...
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								...
								.add(ItemLootEntry.lootTableItem(Items.FEATHER)
										...
										.apply(LootingEnchantBonus.lootingMultiplier(RandomValueRange.between(0.0F, 1.0F)))
										.when(KilledByPlayer.killedByPlayer()))));
		add(CAEntityTypes.LETTUCE_CHICKEN.get(),
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								.setRolls(ConstantRange.exactly(1))
								.add(ItemLootEntry.lootTableItem(Items.FEATHER)
