...
public class CABlockLootTableProvider extends BlockLootTables {
	...
	//	dropSelf(CABlocks.ROCK.get());
		...
		dropSelf(CABlocks.ROBO_GLASS.get());
		dropSelf(CABlocks.ROBO_GLASS_PANE.get());
		dropSelf(CABlocks.ROBO_BARS.get());
		...
		dropSelf(CABlocks.DOUBLE_COMPACT_ROBO_BLOCK.get());
...
*/
		...
		dropSelf(CABlocks.DEFOSSILIZER_BLOCKS.get(DefossilizerType.byId(DefossilizerType.COPPER.getId())).get());
		dropSelf(CABlocks.DEFOSSILIZER_BLOCKS.get(DefossilizerType.byId(DefossilizerType.IRON.getId())).get());
		dropSelf(CABlocks.DEFOSSILIZER_BLOCKS.get(DefossilizerType.byId(DefossilizerType.CRYSTAL.getId())).get());
