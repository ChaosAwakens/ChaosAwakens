...
public class CATagProvider extends BlockTagsProvider {
	...
	public static class CABlockTagProvider extends BlockTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Blocks.DUPLICATION_LOGS).add(CABlocks.DUPLICATION_LOG.get(), CABlocks.STRIPPED_DUPLICATION_LOG.get(), CABlocks.DEAD_DUPLICATION_LOG.get(), CABlocks.STRIPPED_DEAD_DUPLICATION_LOG.get(), CABlocks.DUPLICATION_WOOD.get(), CABlocks.STRIPPED_DUPLICATION_WOOD.get(), CABlocks.DEAD_DUPLICATION_WOOD.get(), CABlocks.STRIPPED_DEAD_DUPLICATION_WOOD.get());
			...
			this.tag(CATags.Blocks.SKYWOOD_LOGS).add(CABlocks.SKYWOOD_LOG.get(), CABlocks.STRIPPED_SKYWOOD_LOG.get(), CABlocks.SKYWOOD.get(), CABlocks.STRIPPED_SKYWOOD.get());
			...
			this.tag(CATags.Blocks.MESOZOIC_LOGS).add(CABlocks.MESOZOIC_LOG.get(), CABlocks.STRIPPED_MESOZOIC_LOG.get(), CABlocks.MESOZOIC_WOOD.get(), CABlocks.STRIPPED_MESOZOIC_WOOD.get());
			this.tag(CATags.Blocks.DENSEWOOD_LOGS).add(CABlocks.DENSEWOOD_LOG.get(), CABlocks.STRIPPED_DENSEWOOD_LOG.get(), CABlocks.DENSEWOOD.get(), CABlocks.STRIPPED_DENSEWOOD.get());
			this.tag(CATags.Blocks.CRYSTAL_LOGS).add(CABlocks.CRYSTALWOOD_LOG.get(), CABlocks.CRYSTALWOOD.get());
			...
			this.tag(CATags.Blocks.CRYSTAL_SAPLING).add(CABlocks.RED_CRYSTAL_SAPLING.get(), CABlocks.GREEN_CRYSTAL_SAPLING.get(), CABlocks.YELLOW_CRYSTAL_SAPLING.get(), CABlocks.PINK_CRYSTAL_SAPLING.get(), CABlocks.BLUE_CRYSTAL_SAPLING.get(), CABlocks.ORANGE_CRYSTAL_SAPLING.get());
			...
			this.tag(CATags.Blocks.FARMABLE).add(Blocks.FARMLAND, CABlocks.DENSE_FARMLAND.get(), CABlocks.TERRA_PRETA_FARMLAND.get());
			...
			this.tag(BlockTags.PLANKS).add(CABlocks.APPLE_PLANKS.get(), CABlocks.CHERRY_PLANKS.get(), CABlocks.PEACH_PLANKS.get(), CABlocks.DUPLICATION_PLANKS.get(), CABlocks.SKYWOOD_PLANKS.get(), CABlocks.GINKGO_PLANKS.get(), CABlocks.MESOZOIC_PLANKS.get(), CABlocks.DENSEWOOD_PLANKS.get(), CABlocks.MOLDY_PLANKS.get());
			this.tag(BlockTags.SAPLINGS).add(CABlocks.APPLE_SAPLING.get(), CABlocks.CHERRY_SAPLING.get(), CABlocks.PEACH_SAPLING.get(), CABlocks.MESOZOIC_SAPLING.get(), CABlocks.DENSEWOOD_SAPLING.get());
			this.tag(BlockTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get(), CABlocks.CHERRY_SLAB.get(), CABlocks.PEACH_SLAB.get(), CABlocks.DUPLICATION_SLAB.get(), CABlocks.SKYWOOD_SLAB.get(), CABlocks.GINKGO_SLAB.get(), CABlocks.MESOZOIC_SLAB.get(), CABlocks.DENSEWOOD_SLAB.get(), CABlocks.MOLDY_SLAB.get(), CABlocks.CRYSTALWOOD_SLAB.get());
			this.tag(BlockTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get(), CABlocks.CHERRY_STAIRS.get(), CABlocks.PEACH_STAIRS.get(), CABlocks.DUPLICATION_STAIRS.get(), CABlocks.SKYWOOD_STAIRS.get(), CABlocks.GINKGO_STAIRS.get(), CABlocks.MESOZOIC_STAIRS.get(), CABlocks.DENSEWOOD_STAIRS.get(), CABlocks.CRYSTALWOOD_STAIRS.get());
			this.tag(BlockTags.FENCE_GATES).add(CABlocks.APPLE_FENCE_GATE.get(), CABlocks.CHERRY_FENCE_GATE.get(), CABlocks.PEACH_FENCE_GATE.get(), CABlocks.DUPLICATION_FENCE_GATE.get(), CABlocks.SKYWOOD_FENCE_GATE.get(), CABlocks.GINKGO_FENCE_GATE.get(), CABlocks.MESOZOIC_FENCE_GATE.get(), CABlocks.DENSEWOOD_FENCE_GATE.get(), CABlocks.CRYSTALWOOD_FENCE_GATE.get());
			this.tag(BlockTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get(), CABlocks.CHERRY_FENCE.get(), CABlocks.PEACH_FENCE.get(), CABlocks.DUPLICATION_FENCE.get(), CABlocks.SKYWOOD_FENCE.get(), CABlocks.GINKGO_FENCE.get(), CABlocks.MESOZOIC_FENCE.get(), CABlocks.DENSEWOOD_FENCE.get(), CABlocks.MOLDY_FENCE.get(), CABlocks.CRYSTALWOOD_FENCE.get());
			this.tag(BlockTags.WOODEN_BUTTONS).add(CABlocks.APPLE_BUTTON.get(), CABlocks.CHERRY_BUTTON.get(), CABlocks.PEACH_BUTTON.get(), CABlocks.DUPLICATION_BUTTON.get(), CABlocks.SKYWOOD_BUTTON.get(), CABlocks.GINKGO_BUTTON.get(), CABlocks.MESOZOIC_BUTTON.get(), CABlocks.DENSEWOOD_BUTTON.get(), CABlocks.CRYSTALWOOD_BUTTON.get());
			...
			this.tag(BlockTags.CROPS).add(CABlocks.LETTUCE.get(), CABlocks.RADISH.get(), CABlocks.QUINOA.get());
			this.tag(BlockTags.STANDING_SIGNS).add(CABlocks.APPLE_SIGN.get(), CABlocks.CHERRY_SIGN.get(), CABlocks.DUPLICATION_SIGN.get(), CABlocks.GINKGO_SIGN.get(), CABlocks.MESOZOIC_SIGN.get(), CABlocks.DENSEWOOD_SIGN.get(), CABlocks.PEACH_SIGN.get(), CABlocks.SKYWOOD_SIGN.get());
			this.tag(BlockTags.WALL_SIGNS).add(CABlocks.APPLE_WALL_SIGN.get(), CABlocks.CHERRY_WALL_SIGN.get(), CABlocks.DUPLICATION_WALL_SIGN.get(), CABlocks.GINKGO_WALL_SIGN.get(), CABlocks.MESOZOIC_WALL_SIGN.get(), CABlocks.DENSEWOOD_WALL_SIGN.get(), CABlocks.PEACH_WALL_SIGN.get(), CABlocks.SKYWOOD_WALL_SIGN.get());
			this.tag(BlockTags.WOODEN_TRAPDOORS).add(CABlocks.APPLE_TRAPDOOR.get(), CABlocks.CHERRY_TRAPDOOR.get(), CABlocks.DUPLICATION_TRAPDOOR.get(), CABlocks.GINKGO_TRAPDOOR.get(), CABlocks.MESOZOIC_TRAPDOOR.get(), CABlocks.DENSEWOOD_TRAPDOOR.get(), CABlocks.PEACH_TRAPDOOR.get(), CABlocks.SKYWOOD_TRAPDOOR.get(), CABlocks.CRYSTALWOOD_TRAPDOOR.get());
			this.tag(BlockTags.DOORS).add(CABlocks.APPLE_DOOR.get(), CABlocks.CHERRY_DOOR.get(), CABlocks.DUPLICATION_DOOR.get(), CABlocks.GINKGO_DOOR.get(), CABlocks.MESOZOIC_DOOR.get(), CABlocks.DENSEWOOD_DOOR.get(), CABlocks.PEACH_DOOR.get(), CABlocks.SKYWOOD_DOOR.get(), CABlocks.CRYSTALWOOD_DOOR.get());
			this.tag(BlockTags.ENDERMAN_HOLDABLE).add(CABlocks.DENSE_GRASS_BLOCK.get(), CABlocks.DENSE_DIRT.get(), CABlocks.LATOSOL.get(), CABlocks.TERRA_PRETA.get());
			...
			this.tag(BlockTags.CLIMBABLE).add(CABlocks.MESOZOIC_VINES.get(), CABlocks.MESOZOIC_VINES_PLANT.get());

			this.tag(BlockTags.VALID_SPAWN).add(CABlocks.DENSE_GRASS_BLOCK.get());
			
			this.tag(Tags.Blocks.DIRT).add(CABlocks.CRYSTAL_GRASS_BLOCK.get(), CABlocks.DENSE_GRASS_BLOCK.get(), CABlocks.DENSE_DIRT.get(), CABlocks.TERRA_PRETA.get());
	...
	public static class CAItemTagProvider extends ItemTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Items.DUPLICATION_LOGS).add(CABlocks.DUPLICATION_LOG.get().asItem(), CABlocks.STRIPPED_DUPLICATION_LOG.get().asItem(), CABlocks.DEAD_DUPLICATION_LOG.get().asItem(), CABlocks.STRIPPED_DEAD_DUPLICATION_LOG.get().asItem(), CABlocks.DUPLICATION_WOOD.get().asItem(), CABlocks.STRIPPED_DUPLICATION_WOOD.get().asItem(), CABlocks.DEAD_DUPLICATION_WOOD.get().asItem(), CABlocks.STRIPPED_DEAD_DUPLICATION_WOOD.get().asItem());
			...
			this.tag(CATags.Items.SKYWOOD_LOGS).add(CABlocks.SKYWOOD_LOG.get().asItem(), CABlocks.STRIPPED_SKYWOOD_LOG.get().asItem(), CABlocks.SKYWOOD.get().asItem(), CABlocks.STRIPPED_SKYWOOD.get().asItem());
			...
			this.tag(CATags.Items.MESOZOIC_LOGS).add(CABlocks.MESOZOIC_LOG.get().asItem(), CABlocks.STRIPPED_MESOZOIC_LOG.get().asItem(), CABlocks.MESOZOIC_WOOD.get().asItem(), CABlocks.STRIPPED_MESOZOIC_WOOD.get().asItem());
			this.tag(CATags.Items.DENSEWOOD_LOGS).add(CABlocks.DENSEWOOD_LOG.get().asItem(), CABlocks.STRIPPED_DENSEWOOD_LOG.get().asItem(), CABlocks.DENSEWOOD.get().asItem(), CABlocks.STRIPPED_DENSEWOOD.get().asItem());
			this.tag(CATags.Items.CRYSTAL_LOGS).add(CABlocks.CRYSTALWOOD_LOG.get().asItem(), CABlocks.CRYSTALWOOD.get().asItem());
			...
			this.tag(CATags.Items.PLANTS).add(CAItems.STRAWBERRY.get(), CAItems.CHERRIES.get(), CAItems.TOMATO.get(), CAItems.PEACH.get(), CAItems.CORN.get(), CAItems.LETTUCE.get(), CAItems.RADISH.get(), CAItems.QUINOA.get());
			this.tag(CATags.Items.SEEDS).add(CAItems.STRAWBERRY_SEEDS.get(), CAItems.TOMATO_SEEDS.get(), CAItems.CORN_SEEDS.get(), CAItems.LETTUCE_SEEDS.get(), CAItems.RADISH_SEEDS.get(), CAItems.QUINOA_SEEDS.get());
			...
			this.tag(ItemTags.LOGS_THAT_BURN).addTags(CATags.Items.APPLE_LOGS, CATags.Items.CHERRY_LOGS, CATags.Items.PEACH_LOGS, CATags.Items.SKYWOOD_LOGS, CATags.Items.GINKGO_LOGS, CATags.Items.MESOZOIC_LOGS, CATags.Items.DENSEWOOD_LOGS, CATags.Items.CRYSTAL_LOGS);
			...
			this.tag(ItemTags.LEAVES).add(CABlocks.APPLE_LEAVES.get().asItem(), CABlocks.CHERRY_LEAVES.get().asItem(), CABlocks.PEACH_LEAVES.get().asItem(), CABlocks.SKYWOOD_LEAVES.get().asItem(), CABlocks.GINKGO_LEAVES.get().asItem(), CABlocks.MESOZOIC_LEAVES.get().asItem(), CABlocks.DENSEWOOD_LEAVES.get().asItem());
			this.tag(ItemTags.SAPLINGS).add(CABlocks.APPLE_SAPLING.get().asItem(), CABlocks.CHERRY_SAPLING.get().asItem(), CABlocks.PEACH_SAPLING.get().asItem(), CABlocks.MESOZOIC_SAPLING.get().asItem(), CABlocks.DENSEWOOD_SAPLING.get().asItem());
			this.tag(ItemTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get().asItem(), CABlocks.CHERRY_SLAB.get().asItem(), CABlocks.PEACH_SLAB.get().asItem(), CABlocks.DUPLICATION_SLAB.get().asItem(), CABlocks.SKYWOOD_SLAB.get().asItem(), CABlocks.GINKGO_SLAB.get().asItem(), CABlocks.MESOZOIC_SLAB.get().asItem(), CABlocks.DENSEWOOD_SLAB.get().asItem(), CABlocks.MOLDY_SLAB.get().asItem(), CABlocks.CRYSTALWOOD_SLAB.get().asItem());
			this.tag(ItemTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get().asItem(), CABlocks.CHERRY_STAIRS.get().asItem(), CABlocks.PEACH_STAIRS.get().asItem(), CABlocks.DUPLICATION_STAIRS.get().asItem(), CABlocks.SKYWOOD_STAIRS.get().asItem(), CABlocks.GINKGO_STAIRS.get().asItem(), CABlocks.MESOZOIC_STAIRS.get().asItem(), CABlocks.DENSEWOOD_STAIRS.get().asItem(), CABlocks.CRYSTALWOOD_STAIRS.get().asItem());
			this.tag(ItemTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get().asItem(), CABlocks.CHERRY_FENCE.get().asItem(), CABlocks.PEACH_FENCE.get().asItem(), CABlocks.DUPLICATION_FENCE.get().asItem(), CABlocks.SKYWOOD_FENCE.get().asItem(), CABlocks.GINKGO_FENCE.get().asItem(), CABlocks.MESOZOIC_FENCE.get().asItem(), CABlocks.DENSEWOOD_FENCE.get().asItem(), CABlocks.MOLDY_FENCE.get().asItem(), CABlocks.CRYSTALWOOD_FENCE.get().asItem());
