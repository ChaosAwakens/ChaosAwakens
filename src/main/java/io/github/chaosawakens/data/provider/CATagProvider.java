...
public class CATagProvider extends BlockTagsProvider {
	...
	public static class CABlockTagProvider extends BlockTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Blocks.DENSEWOOD_LOGS).add(CABlocks.DENSEWOOD_LOG.get(), CABlocks.STRIPPED_DENSEWOOD_LOG.get(), CABlocks.DENSEWOOD_WOOD.get(), CABlocks.STRIPPED_DENSEWOOD_WOOD.get());
			...
			this.tag(BlockTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get(), CABlocks.CHERRY_SLAB.get(), CABlocks.PEACH_SLAB.get(), CABlocks.DUPLICATION_SLAB.get(), CABlocks.SKYWOOD_SLAB.get(), CABlocks.GINKGO_SLAB.get(), CABlocks.MESOZOIC_SLAB.get(), CABlocks.DENSEWOOD_SLAB.get(), CABlocks.MOLDY_SLAB.get(), CABlocks.CRYSTAL_SLAB.get());
			this.tag(BlockTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get(), CABlocks.CHERRY_STAIRS.get(), CABlocks.PEACH_STAIRS.get(), CABlocks.DUPLICATION_STAIRS.get(), CABlocks.SKYWOOD_STAIRS.get(), CABlocks.GINKGO_STAIRS.get(), CABlocks.MESOZOIC_STAIRS.get(), CABlocks.DENSEWOOD_STAIRS.get(), CABlocks.CRYSTAL_STAIRS.get());
			this.tag(BlockTags.FENCE_GATES).add(CABlocks.APPLE_FENCE_GATE.get(), CABlocks.CHERRY_FENCE_GATE.get(), CABlocks.PEACH_FENCE_GATE.get(), CABlocks.DUPLICATION_FENCE_GATE.get(), CABlocks.SKYWOOD_FENCE_GATE.get(), CABlocks.GINKGO_FENCE_GATE.get(), CABlocks.MESOZOIC_FENCE_GATE.get(), CABlocks.DENSEWOOD_FENCE_GATE.get(), CABlocks.CRYSTAL_FENCE_GATE.get());
			this.tag(BlockTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get(), CABlocks.CHERRY_FENCE.get(), CABlocks.PEACH_FENCE.get(), CABlocks.DUPLICATION_FENCE.get(), CABlocks.SKYWOOD_FENCE.get(), CABlocks.GINKGO_FENCE.get(), CABlocks.MESOZOIC_FENCE.get(), CABlocks.DENSEWOOD_FENCE.get(), CABlocks.MOLDY_FENCE.get(), CABlocks.CRYSTAL_FENCE.get());
			this.tag(BlockTags.WOODEN_BUTTONS).add(CABlocks.APPLE_BUTTON.get(), CABlocks.CHERRY_BUTTON.get(), CABlocks.PEACH_BUTTON.get(), CABlocks.DUPLICATION_BUTTON.get(), CABlocks.SKYWOOD_BUTTON.get(), CABlocks.GINKGO_BUTTON.get(), CABlocks.MESOZOIC_BUTTON.get(), CABlocks.DENSEWOOD_BUTTON.get(), CABlocks.CRYSTAL_BUTTON.get());
			...
			this.tag(BlockTags.WOODEN_TRAPDOORS).add(CABlocks.APPLE_TRAPDOOR.get(), CABlocks.CHERRY_TRAPDOOR.get(), CABlocks.DUPLICATION_TRAPDOOR.get(), CABlocks.GINKGO_TRAPDOOR.get(), CABlocks.MESOZOIC_TRAPDOOR.get(), CABlocks.DENSEWOOD_TRAPDOOR.get(), CABlocks.PEACH_TRAPDOOR.get(), CABlocks.SKYWOOD_TRAPDOOR.get());
			this.tag(BlockTags.DOORS).add(CABlocks.APPLE_DOOR.get(), CABlocks.CHERRY_DOOR.get(), CABlocks.DUPLICATION_DOOR.get(), CABlocks.GINKGO_DOOR.get(), CABlocks.MESOZOIC_DOOR.get(), CABlocks.DENSEWOOD_DOOR.get(), CABlocks.PEACH_DOOR.get(), CABlocks.SKYWOOD_DOOR.get());
	...
	public static class CAItemTagProvider extends ItemTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Items.DENSEWOOD_LOGS).add(CABlocks.DENSEWOOD_LOG.get().asItem(), CABlocks.STRIPPED_DENSEWOOD_LOG.get().asItem(), CABlocks.DENSEWOOD_WOOD.get().asItem(), CABlocks.STRIPPED_DENSEWOOD_WOOD.get().asItem());
			...
			this.tag(ItemTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get().asItem(), CABlocks.CHERRY_SLAB.get().asItem(), CABlocks.PEACH_SLAB.get().asItem(), CABlocks.DUPLICATION_SLAB.get().asItem(), CABlocks.SKYWOOD_SLAB.get().asItem(), CABlocks.GINKGO_SLAB.get().asItem(), CABlocks.MESOZOIC_SLAB.get().asItem(), CABlocks.DENSEWOOD_SLAB.get().asItem(), CABlocks.MOLDY_SLAB.get().asItem(), CABlocks.CRYSTAL_SLAB.get().asItem());
			this.tag(ItemTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get().asItem(), CABlocks.CHERRY_STAIRS.get().asItem(), CABlocks.PEACH_STAIRS.get().asItem(), CABlocks.DUPLICATION_STAIRS.get().asItem(), CABlocks.SKYWOOD_STAIRS.get().asItem(), CABlocks.GINKGO_STAIRS.get().asItem(), CABlocks.MESOZOIC_STAIRS.get().asItem(), CABlocks.DENSEWOOD_STAIRS.get().asItem(), CABlocks.CRYSTAL_STAIRS.get().asItem());
			this.tag(ItemTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get().asItem(), CABlocks.CHERRY_FENCE.get().asItem(), CABlocks.PEACH_FENCE.get().asItem(), CABlocks.DUPLICATION_FENCE.get().asItem(), CABlocks.SKYWOOD_FENCE.get().asItem(), CABlocks.GINKGO_FENCE.get().asItem(), CABlocks.MESOZOIC_FENCE.get().asItem(), CABlocks.DENSEWOOD_FENCE.get().asItem(), CABlocks.MOLDY_FENCE.get().asItem(), CABlocks.CRYSTAL_FENCE.get().asItem());
			this.tag(ItemTags.WOODEN_BUTTONS).add(CABlocks.APPLE_BUTTON.get().asItem(), CABlocks.CHERRY_BUTTON.get().asItem(), CABlocks.PEACH_BUTTON.get().asItem(), CABlocks.DUPLICATION_BUTTON.get().asItem(), CABlocks.SKYWOOD_BUTTON.get().asItem(), CABlocks.GINKGO_BUTTON.get().asItem(), CABlocks.MESOZOIC_BUTTON.get().asItem(), CABlocks.DENSEWOOD_BUTTON.get().asItem(), CABlocks.CRYSTAL_BUTTON.get().asItem());
