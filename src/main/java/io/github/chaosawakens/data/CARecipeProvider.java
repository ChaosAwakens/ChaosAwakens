...
public class CARecipeProvider extends RecipeProvider {
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(CABlocks.CRYSTAL_CRAFTING_TABLE.get()).define('#', CABlocks.CRYSTAL_PLANKS.get())
				.pattern("##").pattern("##")
				.unlockedBy("has_" + CABlocks.CRYSTAL_PLANKS.get().asItem(), has(CABlocks.CRYSTAL_PLANKS.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CABlocks.CRYSTAL_FURNACE.get()).define('#', CABlocks.KYANITE.get()).pattern("###")
				.pattern("# #").pattern("###")
				.unlockedBy("has_" + CABlocks.KYANITE.get().asItem(), has(CABlocks.KYANITE.get())).save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.CRYSTAL_SHARD.get(), 4).define('#', CABlocks.CRYSTAL_PLANKS.get())
				.pattern("#").pattern("#")
				.unlockedBy("has_" + CABlocks.CRYSTAL_PLANKS.get().asItem(), has(CABlocks.CRYSTAL_PLANKS.get()))
				.save(consumer);

		ShapedRecipeBuilder.shaped(CAItems.CRYSTAL_TORCH.get(), 4).define('#', CABlocks.CRYSTAL_ENERGY.get())
				.define('$', CAItems.CRYSTAL_SHARD.get()).pattern("#").pattern("$")
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.EXTREME_TORCH.get(), 2).requires(Tags.Items.RODS_WOODEN)
				.requires(ItemTags.COALS).requires(Tags.Items.DUSTS_REDSTONE).requires(CAItems.SUNSTONE.get())
		...
		ShapelessRecipeBuilder.shapeless(CAItems.EXTREME_TORCH.get(), 2).requires(Items.REDSTONE_TORCH)
				.requires(ItemTags.COALS).requires(CAItems.SUNSTONE.get())
		...
		ShapelessRecipeBuilder.shapeless(CAItems.EXTREME_TORCH.get(), 2).requires(CAItems.SUNSTONE_TORCH.get())
				.requires(ItemTags.COALS).requires(Tags.Items.DUSTS_REDSTONE)
		...
		ShapelessRecipeBuilder.shapeless(CAItems.EXTREME_TORCH.get(), 2).requires(Items.TORCH)
				.requires(Tags.Items.DUSTS_REDSTONE).requires(CAItems.SUNSTONE.get())
				.unlockedBy("has_" + Items.TORCH.asItem(), has(Items.TORCH))
				.unlockedBy("has_" + Tags.Items.DUSTS_REDSTONE.getName(), has(Tags.Items.DUSTS_REDSTONE))
				.unlockedBy("has_" + CAItems.SUNSTONE.get().asItem(), has(CAItems.SUNSTONE.get()))
				.save(consumer, "chaosawakens:extreme_torch_from_torch");
		ShapedRecipeBuilder.shaped(CAItems.SUNSTONE_TORCH.get(), 2).define('#', CAItems.SUNSTONE.get())
				.define('$', Tags.Items.RODS_WOODEN).pattern("#").pattern("$")
				.unlockedBy("has_" + CAItems.SUNSTONE.get().asItem(), has(CAItems.SUNSTONE.get()))
				.unlockedBy("has_" + Tags.Items.RODS_WOODEN.getName(), has(Tags.Items.RODS_WOODEN)).save(consumer);

		ShapedRecipeBuilder.shaped(CAItems.BEETROOT_ON_A_STICK.get(), 1).define('S', Tags.Items.RODS_WOODEN)
				.define('B', Items.BEETROOT).pattern("  S").pattern(" SB").pattern("S  ")
				.unlockedBy("has_" + Items.BEETROOT, has(Items.BEETROOT))
				.unlockedBy("has_" + Tags.Items.RODS_WOODEN.getName(), has(Tags.Items.RODS_WOODEN)).save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.CRYSTAL_BEETROOT_ON_A_STICK.get(), 1).define('S', Tags.Items.RODS_WOODEN)
				.define('B', CAItems.CRYSTAL_BEETROOT.get()).pattern("  S").pattern(" SB").pattern("S  ")
				.unlockedBy("has_" + CAItems.CRYSTAL_BEETROOT.get().asItem(), has(CAItems.CRYSTAL_BEETROOT.get()))
				.unlockedBy("has_" + Tags.Items.RODS_WOODEN.getName(), has(Tags.Items.RODS_WOODEN)).save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.GOLDEN_BEETROOT_ON_A_STICK.get(), 1).define('S', Tags.Items.RODS_WOODEN)
				.define('B', CAItems.GOLDEN_BEETROOT.get()).pattern("  S").pattern(" SB").pattern("S  ")
		...
		surroundItem(consumer, CAItems.EXPERIENCE_CHESTPLATE.get(), Items.EXPERIENCE_BOTTLE,
				CAItems.EMERALD_CHESTPLATE.get());
		surroundItem(consumer, CAItems.EXPERIENCE_LEGGINGS.get(), Items.EXPERIENCE_BOTTLE,
				CAItems.EMERALD_LEGGINGS.get());
		surroundItem(consumer, CAItems.EXPERIENCE_BOOTS.get(), Items.EXPERIENCE_BOTTLE, CAItems.EMERALD_BOOTS.get());

		ShapedRecipeBuilder.shaped(CABlocks.CHISELED_MARBLE_BRICKS.get()).define('#', CABlocks.MARBLE_BRICKS_SLAB.get())
				.pattern("#").pattern("#")
				.unlockedBy("has_" + CABlocks.MARBLE_BRICKS_SLAB.get().asItem(), has(CABlocks.MARBLE_BRICKS_SLAB.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CABlocks.MARBLE_PILLAR.get()).define('#', CABlocks.POLISHED_MARBLE.get())
				.pattern("#").pattern("#")
				.unlockedBy("has_" + CABlocks.POLISHED_MARBLE.get().asItem(), has(CABlocks.POLISHED_MARBLE.get()))
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(CABlocks.MOSSY_MARBLE_BRICKS.get()).requires(CABlocks.MARBLE_BRICKS.get())
				.requires(Items.VINE)
		...
		ShapedRecipeBuilder.shaped(CABlocks.CHISELED_LIMESTONE_BRICKS.get())
				.define('#', CABlocks.LIMESTONE_BRICKS_SLAB.get()).pattern("#").pattern("#")
				.unlockedBy("has_" + CABlocks.LIMESTONE_BRICKS_SLAB.get().asItem(),
						has(CABlocks.LIMESTONE_BRICKS_SLAB.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CABlocks.LIMESTONE_PILLAR.get()).define('#', CABlocks.POLISHED_LIMESTONE.get())
				.pattern("#").pattern("#")
		...
		ShapelessRecipeBuilder.shapeless(CABlocks.MOSSY_LIMESTONE_BRICKS.get())
				.requires(CABlocks.LIMESTONE_BRICKS.get()).requires(Items.VINE)
		...
		stonecutting(consumer, CABlocks.CRACKED_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_TERRACOTTA_BRICK_SLAB.get(),
				2);
		...
		stonecutting(consumer, CABlocks.WHITE_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_WHITE_TERRACOTTA_BRICKS.get(),
				1);
		stonecutting(consumer, CABlocks.WHITE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_WHITE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.WHITE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_WHITE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.WHITE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_WHITE_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_WHITE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_WHITE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_WHITE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_WHITE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_WHITE_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, CABlocks.ORANGE_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICKS.get(),
				1);
		stonecutting(consumer, CABlocks.ORANGE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.ORANGE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.ORANGE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_ORANGE_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, CABlocks.MAGENTA_TERRACOTTA_BRICKS.get(), CABlocks.MAGENTA_TERRACOTTA_BRICK_SLAB.get(),
				2);
		...
		stonecutting(consumer, CABlocks.MAGENTA_TERRACOTTA_BRICKS.get(), CABlocks.MAGENTA_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.MAGENTA_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICKS.get(), 1);
		stonecutting(consumer, CABlocks.MAGENTA_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.MAGENTA_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.MAGENTA_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_MAGENTA_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, Blocks.LIGHT_BLUE_TERRACOTTA, CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICK_SLAB.get(),
				2);
		stonecutting(consumer, Blocks.LIGHT_BLUE_TERRACOTTA, CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICK_STAIRS.get(),
				1);
		stonecutting(consumer, Blocks.LIGHT_BLUE_TERRACOTTA, CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.LIGHT_BLUE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.LIGHT_BLUE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.LIGHT_BLUE_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICKS.get(), 1);
		stonecutting(consumer, CABlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_LIGHT_BLUE_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, CABlocks.YELLOW_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICKS.get(),
				1);
		stonecutting(consumer, CABlocks.YELLOW_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.YELLOW_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.YELLOW_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_YELLOW_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, CABlocks.LIME_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_LIME_TERRACOTTA_BRICK_SLAB.get(),
				2);
		stonecutting(consumer, CABlocks.LIME_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIME_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.LIME_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_LIME_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.CRACKED_LIME_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIME_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_LIME_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIME_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_LIME_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIME_TERRACOTTA_BRICK_WALL.get(), 1);
		...
		stonecutting(consumer, CABlocks.PINK_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_PINK_TERRACOTTA_BRICK_SLAB.get(),
				2);
		stonecutting(consumer, CABlocks.PINK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PINK_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.PINK_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_PINK_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.CRACKED_PINK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PINK_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_PINK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PINK_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_PINK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PINK_TERRACOTTA_BRICK_WALL.get(), 1);
		...
		stonecutting(consumer, CABlocks.GRAY_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_GRAY_TERRACOTTA_BRICK_SLAB.get(),
				2);
		stonecutting(consumer, CABlocks.GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GRAY_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.GRAY_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_GRAY_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.CRACKED_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GRAY_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GRAY_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GRAY_TERRACOTTA_BRICK_WALL.get(), 1);
		...
		stonecutting(consumer, Blocks.LIGHT_GRAY_TERRACOTTA, CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICK_SLAB.get(),
				2);
		stonecutting(consumer, Blocks.LIGHT_GRAY_TERRACOTTA, CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICK_STAIRS.get(),
				1);
		stonecutting(consumer, Blocks.LIGHT_GRAY_TERRACOTTA, CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.LIGHT_GRAY_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.LIGHT_GRAY_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.LIGHT_GRAY_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICKS.get(), 1);
		stonecutting(consumer, CABlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_LIGHT_GRAY_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, CABlocks.CYAN_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_CYAN_TERRACOTTA_BRICK_SLAB.get(),
				2);
		stonecutting(consumer, CABlocks.CYAN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_CYAN_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CYAN_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_CYAN_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.CRACKED_CYAN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_CYAN_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_CYAN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_CYAN_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_CYAN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_CYAN_TERRACOTTA_BRICK_WALL.get(), 1);
		...
		stonecutting(consumer, CABlocks.PURPLE_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICKS.get(),
				1);
		stonecutting(consumer, CABlocks.PURPLE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.PURPLE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.PURPLE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_PURPLE_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, CABlocks.BLUE_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_BLUE_TERRACOTTA_BRICK_SLAB.get(),
				2);
		stonecutting(consumer, CABlocks.BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLUE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.BLUE_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_BLUE_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.CRACKED_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLUE_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLUE_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_BLUE_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLUE_TERRACOTTA_BRICK_WALL.get(), 1);
		...
		stonecutting(consumer, CABlocks.BROWN_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_BROWN_TERRACOTTA_BRICKS.get(),
				1);
		stonecutting(consumer, CABlocks.BROWN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BROWN_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.BROWN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BROWN_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.BROWN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BROWN_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_BROWN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BROWN_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_BROWN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BROWN_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_BROWN_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, CABlocks.GREEN_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_GREEN_TERRACOTTA_BRICKS.get(),
				1);
		stonecutting(consumer, CABlocks.GREEN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GREEN_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.GREEN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GREEN_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.GREEN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GREEN_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_GREEN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GREEN_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_GREEN_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_GREEN_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_GREEN_TERRACOTTA_BRICKS.get(),
		...
		stonecutting(consumer, CABlocks.RED_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_RED_TERRACOTTA_BRICK_SLAB.get(),
				2);
		stonecutting(consumer, CABlocks.RED_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_RED_TERRACOTTA_BRICK_STAIRS.get(),
				1);
		stonecutting(consumer, CABlocks.RED_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_RED_TERRACOTTA_BRICK_WALL.get(),
				1);
		stonecutting(consumer, CABlocks.CRACKED_RED_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_RED_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_RED_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_RED_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_RED_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_RED_TERRACOTTA_BRICK_WALL.get(), 1);
		...
		stonecutting(consumer, CABlocks.BLACK_TERRACOTTA_BRICKS.get(), CABlocks.CRACKED_BLACK_TERRACOTTA_BRICKS.get(),
				1);
		stonecutting(consumer, CABlocks.BLACK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLACK_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.BLACK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLACK_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.BLACK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLACK_TERRACOTTA_BRICK_WALL.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_BLACK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLACK_TERRACOTTA_BRICK_SLAB.get(), 2);
		stonecutting(consumer, CABlocks.CRACKED_BLACK_TERRACOTTA_BRICKS.get(),
				CABlocks.CRACKED_BLACK_TERRACOTTA_BRICK_STAIRS.get(), 1);
		stonecutting(consumer, CABlocks.CRACKED_BLACK_TERRACOTTA_BRICKS.get(),
		...
		ShapedRecipeBuilder.shaped(CAItems.CRITTER_CAGE.get()).define('#', Items.STICK).define('$', Items.IRON_INGOT)
		...
		ShapedRecipeBuilder.shaped(CAItems.CRITTER_CAGE.get()).define('#', CAItems.CRYSTAL_SHARD.get())
				.define('$', CAItems.PINK_TOURMALINE_INGOT.get()).pattern("$#$").pattern("# #").pattern("$#$")
				.unlockedBy("has_" + CAItems.CRYSTAL_SHARD.get().asItem(), has(CAItems.CRYSTAL_SHARD.get()))
				.unlockedBy("has_" + CAItems.PINK_TOURMALINE_INGOT.get().asItem(),
						has(CAItems.PINK_TOURMALINE_INGOT.get()))
				.save(consumer,
						new ResourceLocation(ChaosAwakens.MODID, CAItems.CRITTER_CAGE.get() + "_crystal_world"));
		...
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_HELMET.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES).pattern("TIT")
				.pattern("U U")
				...
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_CHESTPLATE.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES).pattern("I I")
				.pattern("TTT").pattern("UUU")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_LEGGINGS.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES).pattern("III")
				.pattern("T T").pattern("U U")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_BOOTS.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).pattern("T T").pattern("U U")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		...
		toolSword(consumer, CAItems.CRYSTAL_WOOD_SWORD.get(), CAItems.CRYSTAL_SHARD.get(),
				CABlocks.CRYSTAL_PLANKS.get());
		toolShovel(consumer, CAItems.CRYSTAL_WOOD_SHOVEL.get(), CAItems.CRYSTAL_SHARD.get(),
				CABlocks.CRYSTAL_PLANKS.get());
		toolPickaxe(consumer, CAItems.CRYSTAL_WOOD_PICKAXE.get(), CAItems.CRYSTAL_SHARD.get(),
				CABlocks.CRYSTAL_PLANKS.get());
		...
		toolPickaxe(consumer, CAItems.CATS_EYE_PICKAXE.get(), CAItems.CRYSTAL_SHARD.get(),
				CAItems.CATS_EYE_INGOT.get());
		...
		toolSword(consumer, CAItems.PINK_TOURMALINE_SWORD.get(), CAItems.CRYSTAL_SHARD.get(),
				CAItems.PINK_TOURMALINE_INGOT.get());
		toolShovel(consumer, CAItems.PINK_TOURMALINE_SHOVEL.get(), CAItems.CRYSTAL_SHARD.get(),
				CAItems.PINK_TOURMALINE_INGOT.get());
		toolPickaxe(consumer, CAItems.PINK_TOURMALINE_PICKAXE.get(), CAItems.CRYSTAL_SHARD.get(),
				CAItems.PINK_TOURMALINE_INGOT.get());
		toolAxe(consumer, CAItems.PINK_TOURMALINE_AXE.get(), CAItems.CRYSTAL_SHARD.get(),
				CAItems.PINK_TOURMALINE_INGOT.get());
		toolHoe(consumer, CAItems.PINK_TOURMALINE_HOE.get(), CAItems.CRYSTAL_SHARD.get(),
				CAItems.PINK_TOURMALINE_INGOT.get());
		...
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_SWORD.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES).pattern("T")
				.pattern("U").pattern("I")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_SHOVEL.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES).pattern("U")
				.pattern("T").pattern("I")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_PICKAXE.get()).define('T', CAItems.TITANIUM_INGOT.get())
				...
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_AXE.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES).pattern("TT")
				.pattern("UI").pattern(" I")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_HOE.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES).pattern("TU")
				.pattern(" I").pattern(" I")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_FISHING_ROD.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES)
				.define('S', Tags.Items.STRING).pattern("  T").pattern(" US").pattern("I S")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_BOW.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES)
				.define('S', Tags.Items.STRING).pattern(" TS").pattern("I S").pattern(" US")
				.unlockedBy("has_" + CAItems.TITANIUM_INGOT.get().asItem(), has(CAItems.TITANIUM_INGOT.get()))
				.unlockedBy("has_" + CAItems.URANIUM_INGOT.get().asItem(), has(CAItems.URANIUM_INGOT.get()))
				.save(consumer);

		ShapedRecipeBuilder.shaped(CAItems.SKATE_STRING_BOW.get()).define('C', CAItems.CRYSTAL_SHARD.get())
				.define('S', Tags.Items.STRING).pattern(" CS").pattern("C S").pattern(" CS")
				.unlockedBy("has_" + CAItems.CRYSTAL_SHARD.get().asItem(), has(CAItems.CRYSTAL_SHARD.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.IRUKANDJI_ARROW.get(), 4).define('I', CAItems.CRYSTAL_SHARD.get())
				.define('#', CAItems.DEAD_IRUKANDJI.get()).define('P', CAItems.PEACOCK_FEATHER.get()).pattern("I")
				.pattern("#").pattern("P")
				.unlockedBy("has_" + CAItems.CRYSTAL_SHARD.get().asItem(), has(CAItems.CRYSTAL_SHARD.get()))
		...
		ShapelessRecipeBuilder.shapeless(CAItems.ATTITUDE_ADJUSTER.get()).requires(CAItems.ULTIMATE_SWORD.get())
				.requires(CAItems.ULTIMATE_AXE.get()).requires(CAItems.BIG_HAMMER.get())
				...
				.unlockedBy("has_" + CAItems.TRIFFID_GOO.get().asItem(), has(CAItems.TRIFFID_GOO.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.BIG_BERTHA.get()).requires(CAItems.BIG_BERTHA_BLADE.get())
				.requires(CAItems.BIG_BERTHA_GUARD.get()).requires(CAItems.BIG_BERTHA_HANDLE.get())
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.BATTLE_AXE.get()).requires(CAItems.ULTIMATE_SWORD.get())
				.requires(CAItems.ULTIMATE_AXE.get()).requires(CAItems.TRIFFID_GOO.get())
				.unlockedBy("has_" + CAItems.ULTIMATE_SWORD.get().asItem(), has(CAItems.ULTIMATE_SWORD.get()))
				.unlockedBy("has_" + CAItems.ULTIMATE_AXE.get().asItem(), has(CAItems.ULTIMATE_AXE.get()))
				.unlockedBy("has_" + CAItems.TRIFFID_GOO.get().asItem(), has(CAItems.TRIFFID_GOO.get())).save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.QUEEN_SCALE_BATTLE_AXE.get()).define('B', CAItems.BATTLE_AXE.get())
				.define('P', CATags.Items.ULTIMATE_GEAR_HANDLES).define('S', CAItems.QUEEN_SCALE.get()).pattern("SBS")
				.pattern("SPS").pattern(" P ")
				.unlockedBy("has_" + CAItems.BATTLE_AXE.get().asItem(), has(CAItems.BATTLE_AXE.get()))
				.unlockedBy("has_" + CAItems.QUEEN_SCALE.get().asItem(), has(CAItems.QUEEN_SCALE.get())).save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.NIGHTMARE_SWORD.get()).define('N', CAItems.NIGHTMARE_SCALE.get())
				.define('T', CAItems.TITANIUM_INGOT.get()).define('R', Tags.Items.DUSTS_REDSTONE)
				.define('D', Tags.Items.GEMS_DIAMOND).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES).pattern("NDN")
				.pattern("RTR").pattern("NIN")
				...
				.unlockedBy("has_" + CATags.Items.ULTIMATE_GEAR_HANDLES.getName(),
						has(CATags.Items.ULTIMATE_GEAR_HANDLES))
				.save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.PRISMATIC_REAPER.get()).define('S', Tags.Items.RODS_WOODEN)
				.define('A', CAItems.AMETHYST.get()).define('D', Tags.Items.GEMS_DIAMOND)
				.define('E', Tags.Items.GEMS_EMERALD).define('R', CAItems.RUBY.get()).pattern("ADE").pattern("RS ")
				.pattern("S  ").unlockedBy("has_" + CAItems.AMETHYST.get().asItem(), has(CAItems.AMETHYST.get()))
				.unlockedBy("has_" + Tags.Items.GEMS_DIAMOND.getName(), has(Tags.Items.GEMS_DIAMOND))
				.unlockedBy("has_" + Tags.Items.GEMS_EMERALD.getName(), has(Tags.Items.GEMS_EMERALD))
				.unlockedBy("has_" + CAItems.RUBY.get().asItem(), has(CAItems.RUBY.get())).save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.THUNDER_STAFF.get()).define('D', Tags.Items.GEMS_DIAMOND)
				.define('R', CAItems.RUBY.get()).pattern("DR ").pattern("RR ").pattern("  R")
				.unlockedBy("has_" + Tags.Items.GEMS_DIAMOND.getName(), has(Tags.Items.GEMS_DIAMOND))
				.unlockedBy("has_" + CAItems.RUBY.get().asItem(), has(CAItems.RUBY.get())).save(consumer);

		ShapedRecipeBuilder.shaped(CAItems.MINERS_DREAM.get()).define('C', Blocks.CACTUS)
				.define('R', Tags.Items.STORAGE_BLOCKS_REDSTONE).define('G', Items.GUNPOWDER).pattern("CCC")
				.pattern("RRR").pattern("GGG").unlockedBy("has_" + Blocks.CACTUS.asItem(), has(Blocks.CACTUS))
				.unlockedBy("has_" + Tags.Items.STORAGE_BLOCKS_REDSTONE.getName(),
		...
		blockToMaterial(consumer, CABlocks.ENDER_EYE_BLOCK.get(), Items.ENDER_EYE,
				new ResourceLocation(ChaosAwakens.MODID, "ender_eye"));
		materialToBlock(consumer, CABlocks.ENDER_PEARL_BLOCK.get(), Items.ENDER_PEARL);
		blockToMaterial(consumer, CABlocks.ENDER_PEARL_BLOCK.get(), Items.ENDER_PEARL,
				new ResourceLocation(ChaosAwakens.MODID, "ender_pearl"));
		...
		ShapelessRecipeBuilder.shapeless(Items.CYAN_DYE).requires(CABlocks.CYAN_ROSE.get()).group("cyan_dye")
				.unlockedBy("has_" + CABlocks.CYAN_ROSE.get().asItem(), has(CABlocks.CYAN_ROSE.get()))
				.save(consumer, "chaosawakens:cyan_dye_from_cyan_rose");
		ShapelessRecipeBuilder.shapeless(Items.RED_DYE).requires(CABlocks.RED_ROSE.get()).group("red_dye")
				.unlockedBy("has_" + CABlocks.RED_ROSE.get().asItem(), has(CABlocks.RED_ROSE.get()))
				.save(consumer, "chaosawakens:red_dye_from_red_rose");
		ShapelessRecipeBuilder.shapeless(Items.PURPLE_DYE).requires(CABlocks.PAEONIA.get()).group("purple_dye")
				.unlockedBy("has_" + CABlocks.PAEONIA.get().asItem(), has(CABlocks.PAEONIA.get()))
				.save(consumer, "chaosawakens:purple_dye_from_paeonia");
		ShapelessRecipeBuilder.shapeless(Items.BLUE_DYE).requires(CABlocks.BLUE_BULB.get()).group("purple_dye")
				.unlockedBy("has_" + CABlocks.BLUE_BULB.get().asItem(), has(CABlocks.BLUE_BULB.get()))
				.save(consumer, "chaosawakens:blue_dye_from_blue_bulb");
		ShapelessRecipeBuilder.shapeless(Items.PINK_DYE).requires(CABlocks.PINK_BULB.get()).group("purple_dye")
				.unlockedBy("has_" + CABlocks.PINK_BULB.get().asItem(), has(CABlocks.PINK_BULB.get()))
				.save(consumer, "chaosawakens:pink_dye_from_pink_bulb");
		ShapelessRecipeBuilder.shapeless(Items.PURPLE_DYE).requires(CABlocks.PURPLE_BULB.get()).group("purple_dye")
				.unlockedBy("has_" + CABlocks.PURPLE_BULB.get().asItem(), has(CABlocks.PURPLE_BULB.get()))
				.save(consumer, "chaosawakens:purple_dye_from_purple_bulb");
		...
		surroundItem(consumer, Items.ENCHANTED_GOLDEN_APPLE, Items.GOLD_BLOCK, Items.APPLE,
				new ResourceLocation(ChaosAwakens.MODID, "enchanted_golden_apple"));
		...
		ShapelessRecipeBuilder.shapeless(CAItems.BACON.get(), 2).requires(Items.PORKCHOP).requires(CAItems.SALT.get())
				.unlockedBy("has_" + Items.PORKCHOP.asItem(), has(Items.PORKCHOP))
				.unlockedBy("has_" + CAItems.SALT.get().asItem(), has(CAItems.SALT.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.BLT_SANDWICH.get()).requires(Items.BREAD)
				.requires(CAItems.LETTUCE.get()).requires(CAItems.TOMATO.get()).requires(CAItems.COOKED_BACON.get())
				.requires(CAItems.BUTTER.get()).unlockedBy("has_" + Items.BREAD.asItem(), has(Items.BREAD))
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.BUTTER.get(), 4).requires(Items.MILK_BUCKET, 2)
				.unlockedBy("has_" + Items.MILK_BUCKET.asItem(), has(Items.MILK_BUCKET)).save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.CHEESE.get(), 2).requires(Items.MILK_BUCKET, 4)
				.unlockedBy("has_" + Items.MILK_BUCKET.asItem(), has(Items.MILK_BUCKET)).save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.CORNDOG.get()).requires(CAItems.CORN.get())
				.requires(Tags.Items.RODS_WOODEN).requires(Items.PORKCHOP).requires(Items.CHICKEN)
				.unlockedBy("has_" + CAItems.CORN.get().asItem(), has(CAItems.CORN.get()))
				.unlockedBy("has_" + Items.PORKCHOP.asItem(), has(Items.PORKCHOP))
				.unlockedBy("has_" + Items.CHICKEN.asItem(), has(Items.CHICKEN)).save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.GARDEN_SALAD.get()).requires(Items.BOWL)
				.requires(CAItems.LETTUCE.get()).requires(CAItems.TOMATO.get()).requires(CAItems.RADISH.get())
		...
		ShapelessRecipeBuilder.shapeless(CAItems.RADISH_STEW.get()).requires(Items.BOWL).requires(CAItems.RADISH.get())
				.requires(CAItems.RADISH.get()).requires(CAItems.RADISH.get()).requires(CAItems.RADISH.get())
				.requires(CAItems.RADISH.get()).requires(CAItems.RADISH.get())
				.unlockedBy("has_" + CAItems.RADISH.get().asItem(), has(CAItems.RADISH.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.SEAFOOD_PATTY.get()).requires(Items.BREAD)
				.requires(CAItems.LETTUCE.get()).requires(CAItems.TOMATO.get()).requires(CAItems.COOKED_CRAB_MEAT.get())
				.unlockedBy("has_" + CAItems.LETTUCE.get().asItem(), has(CAItems.LETTUCE.get()))
				.unlockedBy("has_" + CAItems.TOMATO.get().asItem(), has(CAItems.TOMATO.get()))
				.unlockedBy("has_" + CAItems.COOKED_CRAB_MEAT.get().asItem(), has(CAItems.COOKED_CRAB_MEAT.get()))
				.save(consumer);

		ShapedRecipeBuilder.shaped(CAItems.ULTIMATE_APPLE.get()).define('T', CAItems.TITANIUM_INGOT.get())
				.define('U', CAItems.URANIUM_INGOT.get()).define('I', CATags.Items.ULTIMATE_GEAR_HANDLES)
				.define('A', Items.ENCHANTED_GOLDEN_APPLE).pattern("TIU").pattern("IAI").pattern("UIT")
		...
		cooking(consumer, CAItems.GOLDEN_POTATO.get(), CAItems.GOLDEN_BAKED_POTATO.get(), 100, "smoking",
				IRecipeSerializer.SMOKING_RECIPE);
		cooking(consumer, CAItems.GOLDEN_POTATO.get(), CAItems.GOLDEN_BAKED_POTATO.get(), 600, "campfire_cooking",
				IRecipeSerializer.CAMPFIRE_COOKING_RECIPE);

		smelting(consumer, CAItems.BACON.get(), CAItems.COOKED_BACON.get(), 0.35F, 200);
		cooking(consumer, CAItems.BACON.get(), CAItems.COOKED_BACON.get(), 100, "smoking",
				IRecipeSerializer.SMOKING_RECIPE);
		cooking(consumer, CAItems.BACON.get(), CAItems.COOKED_BACON.get(), 600, "campfire_cooking",
				IRecipeSerializer.CAMPFIRE_COOKING_RECIPE);
		smelting(consumer, CAItems.CORNDOG.get(), CAItems.COOKED_CORNDOG.get(), 0.35F, 200);
		cooking(consumer, CAItems.CORNDOG.get(), CAItems.COOKED_CORNDOG.get(), 100, "smoking",
				IRecipeSerializer.SMOKING_RECIPE);
		cooking(consumer, CAItems.CORNDOG.get(), CAItems.COOKED_CORNDOG.get(), 600, "campfire_cooking",
				IRecipeSerializer.CAMPFIRE_COOKING_RECIPE);
		smelting(consumer, CAItems.CRAB_MEAT.get(), CAItems.COOKED_CRAB_MEAT.get(), 0.35F, 200);
		cooking(consumer, CAItems.CRAB_MEAT.get(), CAItems.COOKED_CRAB_MEAT.get(), 100, "smoking",
				IRecipeSerializer.SMOKING_RECIPE);
		cooking(consumer, CAItems.CRAB_MEAT.get(), CAItems.COOKED_CRAB_MEAT.get(), 600, "campfire_cooking",
				IRecipeSerializer.CAMPFIRE_COOKING_RECIPE);
		smelting(consumer, CAItems.PEACOCK_LEG.get(), CAItems.COOKED_PEACOCK_LEG.get(), 0.35F, 200);
		cooking(consumer, CAItems.PEACOCK_LEG.get(), CAItems.COOKED_PEACOCK_LEG.get(), 100, "smoking",
				IRecipeSerializer.SMOKING_RECIPE);
		cooking(consumer, CAItems.PEACOCK_LEG.get(), CAItems.COOKED_PEACOCK_LEG.get(), 600, "campfire_cooking",
				IRecipeSerializer.CAMPFIRE_COOKING_RECIPE);
		smelting(consumer, CAItems.VENISON.get(), CAItems.COOKED_VENISON.get(), 0.35F, 200);
		cooking(consumer, CAItems.VENISON.get(), CAItems.COOKED_VENISON.get(), 100, "smoking",
				IRecipeSerializer.SMOKING_RECIPE);
		cooking(consumer, CAItems.VENISON.get(), CAItems.COOKED_VENISON.get(), 600, "campfire_cooking",
				IRecipeSerializer.CAMPFIRE_COOKING_RECIPE);
		...
		ShapelessRecipeBuilder.shapeless(CAItems.INSTANT_SURVIVAL_SHELTER.get())
				.requires(Tags.Items.STORAGE_BLOCKS_REDSTONE).requires(Tags.Items.RODS_WOODEN)
		...
		ShapelessRecipeBuilder.shapeless(CAItems.ZOO_CAGE_EXTRA_SMALL.get()).requires(Tags.Items.STORAGE_BLOCKS_IRON)
				.requires(Tags.Items.STORAGE_BLOCKS_QUARTZ).requires(Tags.Items.GLASS).group("zoo_cage")
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.ZOO_CAGE_SMALL.get()).requires(Tags.Items.STORAGE_BLOCKS_IRON)
				.requires(Tags.Items.STORAGE_BLOCKS_QUARTZ).requires(Tags.Items.GLASS)
				.requires(CAItems.ZOO_CAGE_EXTRA_SMALL.get()).group("zoo_cage")
				.unlockedBy("has_" + CAItems.ZOO_CAGE_EXTRA_SMALL.get().asItem(),
						has(CAItems.ZOO_CAGE_EXTRA_SMALL.get()))
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.ZOO_CAGE_MEDIUM.get()).requires(Tags.Items.STORAGE_BLOCKS_IRON)
				.requires(Tags.Items.STORAGE_BLOCKS_QUARTZ).requires(Tags.Items.GLASS)
				.requires(CAItems.ZOO_CAGE_SMALL.get()).group("zoo_cage")
				.unlockedBy("has_" + CAItems.ZOO_CAGE_SMALL.get().asItem(), has(CAItems.ZOO_CAGE_SMALL.get()))
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.ZOO_CAGE_LARGE.get()).requires(Tags.Items.STORAGE_BLOCKS_IRON)
				.requires(Tags.Items.STORAGE_BLOCKS_QUARTZ).requires(Tags.Items.GLASS)
				.requires(CAItems.ZOO_CAGE_MEDIUM.get()).group("zoo_cage")
				.unlockedBy("has_" + CAItems.ZOO_CAGE_MEDIUM.get().asItem(), has(CAItems.ZOO_CAGE_MEDIUM.get()))
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(CAItems.ZOO_CAGE_EXTRA_LARGE.get()).requires(Tags.Items.STORAGE_BLOCKS_IRON)
				.requires(Tags.Items.STORAGE_BLOCKS_QUARTZ).requires(Tags.Items.GLASS)
				.requires(CAItems.ZOO_CAGE_LARGE.get()).group("zoo_cage")
				.unlockedBy("has_" + CAItems.ZOO_CAGE_LARGE.get().asItem(), has(CAItems.ZOO_CAGE_LARGE.get()))
				.save(consumer);

		ShapedRecipeBuilder.shaped(CABlocks.DEFOSSILIZER.get()).define('I', Tags.Items.INGOTS_IRON)
				.define('B', Items.BUCKET).define('S', Blocks.SMOOTH_STONE).define('L', Blocks.SMOOTH_STONE_SLAB)
				.pattern("III").pattern("SBS").pattern("LLL")
				...
				.unlockedBy("has_" + Blocks.SMOOTH_STONE_SLAB.asItem(), has(Blocks.SMOOTH_STONE_SLAB)).save(consumer);
		ShapedRecipeBuilder.shaped(CAItems.ALUMINUM_POWER_CHIP.get()).define('R', Tags.Items.DUSTS_REDSTONE)
				.define('A', CAItems.ALUMINUM_INGOT.get()).define('I', Tags.Items.INGOTS_IRON).pattern("ARA")
				.pattern("RIR").pattern("ARA")
				.unlockedBy("has_" + Tags.Items.DUSTS_REDSTONE.getName(), has(Tags.Items.DUSTS_REDSTONE))
				.unlockedBy("has_" + CAItems.ALUMINUM_INGOT.get().asItem(), has(CAItems.ALUMINUM_INGOT.get()))
				.unlockedBy("has_" + Tags.Items.INGOTS_IRON.getName(), has(Tags.Items.INGOTS_IRON)).save(consumer);
	...
	private void buildDefossilizingRecipes(Consumer<IFinishedRecipe> consumer) {
		// Overworld (CA)
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_ACACIA_ENT.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.ACACIA_ENT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_ACACIA_ENT.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_BIRCH_ENT.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.BIRCH_ENT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_BIRCH_ENT.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_DARK_OAK_ENT.get()), Ingredient.of(Items.WATER_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.DARK_OAK_ENT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_DARK_OAK_ENT.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_JUNGLE_ENT.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.JUNGLE_ENT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_JUNGLE_ENT.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_OAK_ENT.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.OAK_ENT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_OAK_ENT.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_SPRUCE_ENT.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.SPRUCE_ENT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_SPRUCE_ENT.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_HERCULES_BEETLE.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.HERCULES_BEETLE_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_HERCULES_BEETLE.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_RUBY_BUG.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.RUBY_BUG_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_RUBY_BUG.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_EMERALD_GATOR.get()), Ingredient.of(Items.WATER_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.EMERALD_GATOR_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_EMERALD_GATOR.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_GREEN_FISH.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.GREEN_FISH_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_GREEN_FISH.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_ROCK_FISH.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.ROCK_FISH_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_ROCK_FISH.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_SPARK_FISH.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.SPARK_FISH_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_SPARK_FISH.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_WOOD_FISH.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.WOOD_FISH_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_WOOD_FISH.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
//		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
...
//				CAItems.SCORPION_SPAWN_EGG.get(), 1, 20).build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/" + CABlocks.FOSSILISED_SCORPION.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_WASP.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.WASP_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_WASP.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_WHALE.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.WHALE_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_WHALE.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
//		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
...
//				CAItems.PIRAPORU_SPAWN_EGG.get(), 1, 20).build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/" + CABlocks.FOSSILISED_PIRAPORU.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_APPLE_COW.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.APPLE_COW_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_APPLE_COW.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_GOLDEN_APPLE_COW.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.GOLDEN_APPLE_COW_SPAWN_EGG.get(), 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_GOLDEN_APPLE_COW.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_CARROT_PIG.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.CARROT_PIG_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_CARROT_PIG.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_GOLDEN_CARROT_PIG.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.GOLDEN_CARROT_PIG_SPAWN_EGG.get(), 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_GOLDEN_CARROT_PIG.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_BIRD.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.BIRD_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_BIRD.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_DIMETRODON.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.DIMETRODON_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_DIMETRODON.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_FROG.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.FROG_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_FROG.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));

		// Overworld (Vanilla)
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_BAT.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.BAT_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_BAT.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_BEE.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.BEE_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_BEE.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_CAVE_SPIDER.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.CAVE_SPIDER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_CAVE_SPIDER.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_CHICKEN.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.CHICKEN_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_CHICKEN.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_COD.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.COD_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_COD.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_COW.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.COW_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_COW.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_CREEPER.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.CREEPER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_CREEPER.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_DOLPHIN.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.DOLPHIN_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_DOLPHIN.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_DONKEY.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.DONKEY_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_DONKEY.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_DROWNED.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.DROWNED_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_DROWNED.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_ENDERMAN.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.ENDERMAN_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_ENDERMAN.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_EVOKER.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.EVOKER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_EVOKER.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_FOX.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.FOX_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_FOX.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_GIANT.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.GIANT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_GIANT.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_GUARDIAN.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.GUARDIAN_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_GUARDIAN.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_HORSE.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.HORSE_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_HORSE.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_HUSK.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.HUSK_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_HUSK.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_HUSK_SANDSTONE.get()), Ingredient.of(Items.WATER_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.HUSK_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_HUSK_SANDSTONE.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_ILLUSIONER.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.ILLUSIONER_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_ILLUSIONER.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_IRON_GOLEM.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.IRON_GOLEM_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_IRON_GOLEM.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_LLAMA.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.LLAMA_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_LLAMA.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_MOOSHROOM.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.MOOSHROOM_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_MOOSHROOM.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_OCELOT.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.OCELOT_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_OCELOT.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_PANDA.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.PANDA_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_PANDA.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_PIG.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.PIG_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_PIG.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_PHANTOM.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.PHANTOM_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_PHANTOM.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_PILLAGER.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.PILLAGER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_PILLAGER.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FROZEN_POLAR_BEAR.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.POLAR_BEAR_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FROZEN_POLAR_BEAR.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_PUFFERFISH.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.PUFFERFISH_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_PUFFERFISH.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_RABBIT.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.RABBIT_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_RABBIT.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_RAVAGER.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.RAVAGER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_RAVAGER.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_SALMON.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.SALMON_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_SALMON.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_SHEEP.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.SHEEP_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_SHEEP.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_SKELETON.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.SKELETON_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_SKELETON.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_SKELETON_HORSE.get()), Ingredient.of(Items.WATER_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.SKELETON_HORSE_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_SKELETON_HORSE.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_SLIME.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.SLIME_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_SLIME.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FROZEN_SNOW_GOLEM.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.SNOW_GOLEM_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FROZEN_SNOW_GOLEM.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_SPIDER.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.SPIDER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_SPIDER.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_SQUID.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.SQUID_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_SQUID.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FROZEN_STRAY.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.STRAY_SPAWN_EGG, 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FROZEN_STRAY.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_TROPICAL_FISH.get()), Ingredient.of(Items.WATER_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.TROPICAL_FISH_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_TROPICAL_FISH.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_TURTLE.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.TURTLE_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_TURTLE.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_VILLAGER.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.VILLAGER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_VILLAGER.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_VINDICATOR.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.VINDICATOR_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_VINDICATOR.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_WANDERING_TRADER.get()), Ingredient.of(Items.WATER_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.WANDERING_TRADER_SPAWN_EGG, 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_WANDERING_TRADER.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_WITCH.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.WITCH_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_WITCH.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_WOLF.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.WOLF_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_WOLF.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_ZOMBIE.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.ZOMBIE_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_ZOMBIE.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_ZOMBIE_HORSE.get()), Ingredient.of(Items.WATER_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.ZOMBIE_HORSE_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_ZOMBIE_HORSE.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));

		// Nether (CA)
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_CRIMSON_ENT.get()),
						Ingredient.of(Items.LAVA_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.CRIMSON_ENT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_CRIMSON_ENT.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_WARPED_ENT.get()),
						Ingredient.of(Items.LAVA_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.WARPED_ENT_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_WARPED_ENT.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_LAVA_EEL.get()),
						Ingredient.of(Items.LAVA_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						CAItems.LAVA_EEL_SPAWN_EGG.get(), 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_LAVA_EEL.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));

		// Nether (Vanilla)
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_BLAZE.get()), Ingredient.of(Items.LAVA_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.BLAZE_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_BLAZE.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_GHAST.get()), Ingredient.of(Items.LAVA_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.GHAST_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_GHAST.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_HOGLIN.get()), Ingredient.of(Items.LAVA_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.HOGLIN_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_HOGLIN.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_ENDERMAN_NETHERRACK.get()), Ingredient.of(Items.LAVA_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.ENDERMAN_SPAWN_EGG, 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_ENDERMAN_NETHERRACK.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_MAGMA_CUBE_NETHERRACK.get()), Ingredient.of(Items.LAVA_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.MAGMA_CUBE_SPAWN_EGG, 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_MAGMA_CUBE_NETHERRACK.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_MAGMA_CUBE_BLACKSTONE.get()), Ingredient.of(Items.LAVA_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.MAGMA_CUBE_SPAWN_EGG, 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_MAGMA_CUBE_BLACKSTONE.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_PIGLIN.get()), Ingredient.of(Items.LAVA_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.PIGLIN_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_PIGLIN.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_SKELETON_SOUL_SOIL.get()), Ingredient.of(Items.LAVA_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.SKELETON_SPAWN_EGG, 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_SKELETON_SOUL_SOIL.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_STRIDER.get()), Ingredient.of(Items.LAVA_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.STRIDER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_STRIDER.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_WITHER_SKELETON.get()), Ingredient.of(Items.LAVA_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.WITHER_SKELETON_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_WITHER_SKELETON.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_ZOMBIFIED_PIGLIN.get()), Ingredient.of(Items.LAVA_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.ZOMBIFIED_PIGLIN_SPAWN_EGG, 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_ZOMBIFIED_PIGLIN.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		...
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
						Ingredient.of(CABlocks.FOSSILISED_ENDERMAN_END_STONE.get()), Ingredient.of(Items.WATER_BUCKET),
						Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.ENDERMAN_SPAWN_EGG, 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.FOSSILISED_ENDERMAN_END_STONE.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
		FossilRecipeBuilder
				.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(), Ingredient.of(CABlocks.FOSSILISED_ENDERMITE.get()),
						Ingredient.of(Items.WATER_BUCKET), Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
						Items.ENDERMITE_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
								+ CABlocks.FOSSILISED_ENDERMITE.getId().toString().replaceAll("chaosawakens:", "")
								+ "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.FOSSILISED_SHULKER.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), Items.SHULKER_SPAWN_EGG, 1, 20)
				.build(consumer,
						new ResourceLocation(ChaosAwakens.MODID,
								"defossilizing/"
										+ CABlocks.FOSSILISED_SHULKER.getId().toString().replaceAll("chaosawakens:", "")
										+ "_to_spawn_egg"));

		// Crystalworld (CA)
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				Ingredient.of(CABlocks.CRYSTALISED_CRYSTAL_APPLE_COW.get()), Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()), CAItems.CRYSTAL_APPLE_COW_SPAWN_EGG.get(), 1, 20)
				.build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/"
						+ CABlocks.CRYSTALISED_CRYSTAL_APPLE_COW.getId().toString().replaceAll("chaosawakens:", "")
						+ "_to_spawn_egg"));
	}
	...
	private static void woodenPlanks(Consumer<IFinishedRecipe> consumer, IItemProvider pPlanks, ITag<Item> pLog) {
		ShapelessRecipeBuilder.shapeless(pPlanks, 4).requires(pLog).group("planks").unlockedBy("has_log", has(pLog))
				.save(consumer);
	}
	...
	private static void woodenSlab(Consumer<IFinishedRecipe> consumer, IItemProvider pSlab, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pSlab, 6).define('#', pMaterial).pattern("###").group("wooden_slab")
				.unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}

	private static void woodenStairs(Consumer<IFinishedRecipe> consumer, IItemProvider pStairs,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pStairs, 4).define('#', pMaterial).pattern("#  ").pattern("## ").pattern("###")
				.group("wooden_stairs").unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}

	private static void woodenFence(Consumer<IFinishedRecipe> consumer, IItemProvider pFence, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pFence, 3).define('#', Items.STICK).define('W', pMaterial).pattern("W#W")
				.pattern("W#W").group("wooden_fence").unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}

	private static void woodenFenceGate(Consumer<IFinishedRecipe> consumer, IItemProvider pFenceGate,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pFenceGate).define('#', Items.STICK).define('W', pMaterial).pattern("#W#")
				.pattern("#W#").group("wooden_fence_gate").unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}

	private static void woodenPressurePlate(Consumer<IFinishedRecipe> consumer, IItemProvider pPressurePlate,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pPressurePlate).define('#', pMaterial).pattern("##").group("wooden_pressure_plate")
				.unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}

	private static void woodenButton(Consumer<IFinishedRecipe> consumer, IItemProvider pButton,
			IItemProvider pMaterial) {
		ShapelessRecipeBuilder.shapeless(pButton).requires(pMaterial).group("wooden_button")
				.unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}

	private static void woodenTrapdoor(Consumer<IFinishedRecipe> consumer, IItemProvider pTrapdoor,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pTrapdoor).define('#', pMaterial).pattern("###").pattern("###")
				.group("wooden_trapdoor").unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}

	private static void woodenWood(Consumer<IFinishedRecipe> consumer, IItemProvider pWood, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pWood, 3).define('#', pMaterial).pattern("##").pattern("##")
				.unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void leafCarpet(Consumer<IFinishedRecipe> consumer, IItemProvider pLeadCarpet,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pLeadCarpet).define('#', pMaterial).pattern("##").group("leaf_carpet")
				.unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}

	private static void surroundItem(Consumer<IFinishedRecipe> consumer, IItemProvider pOutput,
			IItemProvider pSurroundMaterial, IItemProvider pItemMaterial) {
		ShapedRecipeBuilder.shaped(pOutput).define('#', pSurroundMaterial).define('X', pItemMaterial).pattern("###")
				.pattern("#X#").pattern("###").unlockedBy("has_" + pSurroundMaterial.asItem(), has(pSurroundMaterial))
				.save(consumer);
	}

	private static void surroundItem(Consumer<IFinishedRecipe> consumer, IItemProvider pOutput,
			IItemProvider pSurroundMaterial, IItemProvider pItemMaterial, ResourceLocation name) {
		ShapedRecipeBuilder.shaped(pOutput).define('#', pSurroundMaterial).define('X', pItemMaterial).pattern("###")
				.pattern("#X#").pattern("###").unlockedBy("has_" + pSurroundMaterial.asItem(), has(pSurroundMaterial))
				.save(consumer, name);
	}

	private static void armorHelmet(Consumer<IFinishedRecipe> consumer, IItemProvider pArmorHelmet,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pArmorHelmet).define('#', pMaterial).pattern("###").pattern("# #")
				.unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void armorChestplate(Consumer<IFinishedRecipe> consumer, IItemProvider pArmorChestplate,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pArmorChestplate).define('#', pMaterial).pattern("# #").pattern("###").pattern("###")
				.unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void armorLeggings(Consumer<IFinishedRecipe> consumer, IItemProvider pArmorLeggings,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pArmorLeggings).define('#', pMaterial).pattern("###").pattern("# #").pattern("# #")
				.unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void armorBoots(Consumer<IFinishedRecipe> consumer, IItemProvider pArmorBoots,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pArmorBoots).define('#', pMaterial).pattern("# #").pattern("# #")
				.unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolSword(Consumer<IFinishedRecipe> consumer, IItemProvider pToolSword,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolSword).define('S', Items.STICK).define('#', pMaterial).pattern("#").pattern("#")
				.pattern("S").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolShovel(Consumer<IFinishedRecipe> consumer, IItemProvider pToolShovel,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolShovel).define('S', Items.STICK).define('#', pMaterial).pattern("#")
				.pattern("S").pattern("S").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolPickaxe(Consumer<IFinishedRecipe> consumer, IItemProvider pToolPickaxe,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolPickaxe).define('S', Items.STICK).define('#', pMaterial).pattern("###")
				.pattern(" S ").pattern(" S ").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolAxe(Consumer<IFinishedRecipe> consumer, IItemProvider pToolAxe, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolAxe).define('S', Items.STICK).define('#', pMaterial).pattern("##").pattern("#S")
				.pattern(" S").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolHoe(Consumer<IFinishedRecipe> consumer, IItemProvider pToolHoe, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolHoe).define('S', Items.STICK).define('#', pMaterial).pattern("##").pattern(" S")
				.pattern(" S").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolSword(Consumer<IFinishedRecipe> consumer, IItemProvider pToolSword,
			IItemProvider pToolStick, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolSword).define('S', pToolStick).define('#', pMaterial).pattern("#").pattern("#")
				.pattern("S").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolShovel(Consumer<IFinishedRecipe> consumer, IItemProvider pToolShovel,
			IItemProvider pToolStick, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolShovel).define('S', pToolStick).define('#', pMaterial).pattern("#").pattern("S")
				.pattern("S").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolPickaxe(Consumer<IFinishedRecipe> consumer, IItemProvider pToolPickaxe,
			IItemProvider pToolStick, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolPickaxe).define('S', pToolStick).define('#', pMaterial).pattern("###")
				.pattern(" S ").pattern(" S ").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolAxe(Consumer<IFinishedRecipe> consumer, IItemProvider pToolAxe, IItemProvider pToolStick,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolAxe).define('S', pToolStick).define('#', pMaterial).pattern("##").pattern("#S")
				.pattern(" S").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void toolHoe(Consumer<IFinishedRecipe> consumer, IItemProvider pToolHoe, IItemProvider pToolStick,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pToolHoe).define('S', pToolStick).define('#', pMaterial).pattern("##").pattern(" S")
				.pattern(" S").unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void materialToBlock(Consumer<IFinishedRecipe> consumer, IItemProvider pBlock,
			IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pBlock).define('#', pMaterial).pattern("###").pattern("###").pattern("###")
				.unlockedBy("has_" + pMaterial.asItem(), has(pMaterial)).save(consumer);
	}

	private static void blockToMaterial(Consumer<IFinishedRecipe> consumer, IItemProvider pBlock,
			IItemProvider pMaterial) {
		ShapelessRecipeBuilder.shapeless(pMaterial, 9).requires(pBlock)
				.unlockedBy("has_" + pBlock.asItem(), has(pBlock)).save(consumer);
	}

	private static void blockToMaterial(Consumer<IFinishedRecipe> consumer, IItemProvider pBlock,
			IItemProvider pMaterial, ResourceLocation name) {
		ShapelessRecipeBuilder.shapeless(pMaterial, 9).requires(pBlock)
				.unlockedBy("has_" + pBlock.asItem(), has(pBlock)).save(consumer, name);
	}

	private static void nuggetToIngot(Consumer<IFinishedRecipe> consumer, IItemProvider pIngot, IItemProvider pNugget) {
		ShapedRecipeBuilder.shaped(pIngot).define('#', pNugget).pattern("###").pattern("###").pattern("###")
	...
	private static void ingotToNugget(Consumer<IFinishedRecipe> consumer, IItemProvider pIngot, IItemProvider pNugget) {
		ShapelessRecipeBuilder.shapeless(pNugget, 9).requires(pIngot).unlockedBy("has_" + pIngot.asItem(), has(pIngot))
				.save(consumer);
	}
	...
	private static void stonecutting(Consumer<IFinishedRecipe> consumer, IItemProvider pInput, IItemProvider pOutput,
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(pInput), pOutput, count)
				...
				.save(consumer, new ResourceLocation(ChaosAwakens.MODID,
						pOutput.asItem() + "_from_" + pInput.asItem() + "_stonecutting"));
	}

	private static void smelting(Consumer<IFinishedRecipe> consumer, IItemProvider pInput, IItemProvider pOutput,
			Float experience, int cookingTime) {
		CookingRecipeBuilder.smelting(Ingredient.of(pInput), pOutput, experience, cookingTime)
				.unlockedBy("has_" + pInput, has(pInput)).save(consumer, "chaosawakens:" + pOutput + "_from_smelting");
	}

	private static void blasting(Consumer<IFinishedRecipe> consumer, IItemProvider pInput, IItemProvider pOutput,
			Float experience, int cookingTime) {
		CookingRecipeBuilder.blasting(Ingredient.of(pInput), pOutput, experience, cookingTime)
				.unlockedBy("has_" + pInput, has(pInput)).save(consumer, "chaosawakens:" + pOutput + "_from_blasting");
	}

	private static void cooking(Consumer<IFinishedRecipe> consumer, IItemProvider pInput, IItemProvider pOutput,
			int cookingTime, String CookingRecipeSerializerID, CookingRecipeSerializer<?> cookingRecipeSerializer) {
	...
	private static void plantSeeds(Consumer<IFinishedRecipe> consumer, IItemProvider pSeeds, IItemProvider pPlant) {
		ShapelessRecipeBuilder.shapeless(pSeeds, 2).requires(pPlant).unlockedBy("has_" + pPlant.asItem(), has(pPlant))
				.save(consumer);
	}

	private static void philoConversionRecipe(Consumer<IFinishedRecipe> consumer, IItemProvider a, int aAmount,
			IItemProvider b, int bAmount) {
		whenModLoaded(ShapelessRecipeBuilder.shapeless(b, bAmount).requires(PEItems.PHILOSOPHERS_STONE)
				.requires(a, aAmount).unlockedBy("has_" + a.asItem(), hasItems(PEItems.PHILOSOPHERS_STONE, a)),
				"projecte").generateAdvancement().build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "conversions/" + a + "_to_" + b));
		whenModLoaded(ShapelessRecipeBuilder.shapeless(a, aAmount).requires(PEItems.PHILOSOPHERS_STONE)
				.requires(b, bAmount).unlockedBy("has_" + b.asItem(), hasItems(PEItems.PHILOSOPHERS_STONE, b)),
				"projecte").generateAdvancement().build(consumer,
						new ResourceLocation(ChaosAwakens.MODID, "conversions/" + b + "_to_" + a));
	}
