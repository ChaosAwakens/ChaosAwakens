...
public class CARecipeProvider extends RecipeProvider {
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(CABlocks.CHISELED_MARBLE_BRICKS.get()).define('#', CABlocks.MARBLE_BRICKS_SLAB.get()).pattern("#").pattern("#").unlockedBy("has_" + CABlocks.MARBLE_BRICKS_SLAB.get().asItem(), has(CABlocks.MARBLE_BRICKS_SLAB.get())).save(consumer);
		ShapedRecipeBuilder.shaped(CABlocks.MARBLE_PILLAR.get()).define('#', CABlocks.POLISHED_MARBLE.get()).pattern("#").pattern("#").unlockedBy("has_" + CABlocks.POLISHED_MARBLE.get().asItem(), has(CABlocks.POLISHED_MARBLE.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(CABlocks.MOSSY_MARBLE_BRICKS.get()).requires(CABlocks.MARBLE_BRICKS.get()).requires(Items.VINE).unlockedBy("has_" + CABlocks.MARBLE_BRICKS.get().asItem(), has(CABlocks.MARBLE_BRICKS.get())).unlockedBy("has_" + Items.VINE.asItem(), has(Items.VINE)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(CABlocks.CHISELED_LIMESTONE_BRICKS.get()).define('#', CABlocks.LIMESTONE_BRICKS_SLAB.get()).pattern("#").pattern("#").unlockedBy("has_" + CABlocks.LIMESTONE_BRICKS_SLAB.get().asItem(), has(CABlocks.LIMESTONE_BRICKS_SLAB.get())).save(consumer);
		ShapedRecipeBuilder.shaped(CABlocks.LIMESTONE_PILLAR.get()).define('#', CABlocks.POLISHED_LIMESTONE.get()).pattern("#").pattern("#").unlockedBy("has_" + CABlocks.POLISHED_LIMESTONE.get().asItem(), has(CABlocks.POLISHED_LIMESTONE.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(CABlocks.MOSSY_LIMESTONE_BRICKS.get()).requires(CABlocks.LIMESTONE_BRICKS.get()).requires(Items.VINE).unlockedBy("has_" + CABlocks.LIMESTONE_BRICKS.get().asItem(), has(CABlocks.LIMESTONE_BRICKS.get())).unlockedBy("has_" + Items.VINE.asItem(), has(Items.VINE)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(CAItems.CRITTER_CAGE.get())
				.define('#', Items.STICK)
...
//				CAItems.PIRAPORU_SPAWN_EGG.get(), 1, 20).build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/" + CABlocks.FOSSILISED_PIRAPORU.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		...
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				...
				Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
				Items.POLAR_BEAR_SPAWN_EGG, 1, 20).build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/" + CABlocks.FROZEN_POLAR_BEAR.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
		...
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				...
				Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
				CAItems.SNOW_GOLEM_SPAWN_EGG.get(), 1, 20).build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/" + CABlocks.FROZEN_SNOW_GOLEM.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
		...
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				...
				Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
				Items.STRAY_SPAWN_EGG, 1, 20).build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/" + CABlocks.FROZEN_STRAY.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
	...
	private static void smelting(Consumer<IFinishedRecipe> consumer, IItemProvider pInput, IItemProvider pOutput, Float experience, int cookingTime) {
		CookingRecipeBuilder
				.smelting(Ingredient.of(pInput), pOutput, experience, cookingTime)
	...
	private static void blasting(Consumer<IFinishedRecipe> consumer, IItemProvider pInput, IItemProvider pOutput, Float experience, int cookingTime) {
		CookingRecipeBuilder
				.blasting(Ingredient.of(pInput), pOutput, experience, cookingTime)
				.unlockedBy("has_" + pInput, has(pInput))
	...
	private static void cooking(Consumer<IFinishedRecipe> consumer, IItemProvider pInput, IItemProvider pOutput, int cookingTime, String CookingRecipeSerializerID, CookingRecipeSerializer<?> cookingRecipeSerializer) {
		CookingRecipeBuilder
				.cooking(Ingredient.of(pInput), pOutput, 0.35F, cookingTime, cookingRecipeSerializer)
	...
	private static void philoConversionRecipe(Consumer<IFinishedRecipe> consumer, IItemProvider a, int aAmount, IItemProvider b, int bAmount) {
		whenModLoaded(ShapelessRecipeBuilder
				.shapeless(b, bAmount)
