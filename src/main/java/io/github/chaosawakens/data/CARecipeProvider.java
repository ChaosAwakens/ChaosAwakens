...
public class CARecipeProvider extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(CAItems.BEETROOT_ON_A_STICK.get(), 1).define('S', Tags.Items.RODS_WOODEN).define('B', Items.BEETROOT).pattern("  S").pattern(" SB").pattern("S  ").unlockedBy("has_" + Items.BEETROOT, has(Items.BEETROOT)).unlockedBy("has_" + Tags.Items.RODS_WOODEN.getName(), has(Tags.Items.RODS_WOODEN)).save(consumer);
        ShapedRecipeBuilder.shaped(CAItems.CRYSTAL_BEETROOT_ON_A_STICK.get(), 1).define('S', Tags.Items.RODS_WOODEN).define('B', CAItems.CRYSTAL_BEETROOT.get()).pattern("  S").pattern(" SB").pattern("S  ").unlockedBy("has_" + CAItems.CRYSTAL_BEETROOT.get().asItem(), has(CAItems.CRYSTAL_BEETROOT.get())).unlockedBy("has_" + Tags.Items.RODS_WOODEN.getName(), has(Tags.Items.RODS_WOODEN)).save(consumer);
        ShapedRecipeBuilder.shaped(CAItems.GOLDEN_BEETROOT_ON_A_STICK.get(), 1).define('S', Tags.Items.RODS_WOODEN).define('B', CAItems.GOLDEN_BEETROOT.get()).pattern("  S").pattern(" SB").pattern("S  ").unlockedBy("has_" + CAItems.GOLDEN_BEETROOT.get().asItem(), has(CAItems.GOLDEN_BEETROOT.get())).unlockedBy("has_" + Tags.Items.RODS_WOODEN.getName(), has(Tags.Items.RODS_WOODEN)).save(consumer);
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.MARBLE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.CHISELED_MARBLE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.POLISHED_MARBLE.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.MARBLE_BRICKS_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.CHISELED_MARBLE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.POLISHED_MARBLE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.MARBLE_BRICK_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.CHISELED_MARBLE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.POLISHED_MARBLE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.MARBLE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.MARBLE_BRICK_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.CHISELED_MARBLE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE.get()), CABlocks.POLISHED_MARBLE_STAIRS.get(), 1);
        
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.MARBLE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.CHISELED_MARBLE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.POLISHED_MARBLE.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.MARBLE_BRICKS_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.CHISELED_MARBLE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.POLISHED_MARBLE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.MARBLE_BRICK_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.CHISELED_MARBLE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.POLISHED_MARBLE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.MARBLE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.MARBLE_BRICK_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.CHISELED_MARBLE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.MARBLE_BRICKS.get()), CABlocks.POLISHED_MARBLE_STAIRS.get(), 1);
        
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.MARBLE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.CHISELED_MARBLE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.POLISHED_MARBLE.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.MARBLE_BRICKS_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.CHISELED_MARBLE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.POLISHED_MARBLE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.MARBLE_BRICK_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.CHISELED_MARBLE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.POLISHED_MARBLE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.MARBLE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.MARBLE_BRICK_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.CHISELED_MARBLE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_MARBLE_BRICKS.get()), CABlocks.POLISHED_MARBLE_STAIRS.get(), 1);
        
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.MARBLE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.CHISELED_MARBLE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.POLISHED_MARBLE.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.MARBLE_BRICKS_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.CHISELED_MARBLE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.POLISHED_MARBLE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.MARBLE_BRICK_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.CHISELED_MARBLE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.POLISHED_MARBLE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.MARBLE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.MARBLE_BRICK_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.CHISELED_MARBLE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_MARBLE.get()), CABlocks.POLISHED_MARBLE_STAIRS.get(), 1);
        
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.LIMESTONE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.CHISELED_LIMESTONE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.POLISHED_LIMESTONE.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.LIMESTONE_BRICKS_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.CHISELED_LIMESTONE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.POLISHED_LIMESTONE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.LIMESTONE_BRICK_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.CHISELED_LIMESTONE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.POLISHED_LIMESTONE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.LIMESTONE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.LIMESTONE_BRICK_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.CHISELED_LIMESTONE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE.get()), CABlocks.POLISHED_LIMESTONE_STAIRS.get(), 1);
        
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.CHISELED_LIMESTONE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.POLISHED_LIMESTONE.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_BRICKS_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.CHISELED_LIMESTONE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.POLISHED_LIMESTONE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_BRICK_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.CHISELED_LIMESTONE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.POLISHED_LIMESTONE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_BRICK_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.CHISELED_LIMESTONE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.LIMESTONE_BRICKS.get()), CABlocks.POLISHED_LIMESTONE_STAIRS.get(), 1);
        
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.CHISELED_LIMESTONE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.POLISHED_LIMESTONE.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_BRICKS_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.CHISELED_LIMESTONE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.POLISHED_LIMESTONE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_BRICK_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.CHISELED_LIMESTONE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.POLISHED_LIMESTONE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.LIMESTONE_BRICK_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.CHISELED_LIMESTONE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.CHISELED_LIMESTONE_BRICKS.get()), CABlocks.POLISHED_LIMESTONE_STAIRS.get(), 1);
        
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.LIMESTONE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.CHISELED_LIMESTONE_BRICKS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.POLISHED_LIMESTONE.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.LIMESTONE_BRICKS_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.CHISELED_LIMESTONE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.POLISHED_LIMESTONE_SLAB.get(), 2);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.LIMESTONE_BRICK_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.CHISELED_LIMESTONE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.POLISHED_LIMESTONE_WALL.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.LIMESTONE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.LIMESTONE_BRICK_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.CHISELED_LIMESTONE_STAIRS.get(), 1);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CABlocks.POLISHED_LIMESTONE.get()), CABlocks.POLISHED_LIMESTONE_STAIRS.get(), 1);
        ...
        ShapelessRecipeBuilder.shapeless(Items.BLUE_DYE).requires(CABlocks.BLUE_BULB.get()).group("purple_dye").unlockedBy("has_" + CABlocks.BLUE_BULB.get().asItem(), has(CABlocks.BLUE_BULB.get())).save(consumer, "chaosawakens:blue_dye_from_blue_bulb");
        ShapelessRecipeBuilder.shapeless(Items.PINK_DYE).requires(CABlocks.PINK_BULB.get()).group("purple_dye").unlockedBy("has_" + CABlocks.PINK_BULB.get().asItem(), has(CABlocks.PINK_BULB.get())).save(consumer, "chaosawakens:pink_dye_from_pink_bulb");
        ShapelessRecipeBuilder.shapeless(Items.PURPLE_DYE).requires(CABlocks.PURPLE_BULB.get()).group("purple_dye").unlockedBy("has_" + CABlocks.PURPLE_BULB.get().asItem(), has(CABlocks.PURPLE_BULB.get())).save(consumer, "chaosawakens:purple_dye_from_purple_bulb");
...
//				CAItems.PIRAPORU_SPAWN_EGG.get(), 1, 20).build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/" + CABlocks.FOSSILISED_PIRAPORU.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		...
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
				...
				Ingredient.of(Items.WATER_BUCKET),
				Ingredient.of(CAItems.ALUMINUM_POWER_CHIP.get()),
				Items.HUSK_SPAWN_EGG, 1, 20).build(consumer, new ResourceLocation(ChaosAwakens.MODID, "defossilizing/" + CABlocks.FOSSILISED_HUSK_SANDSTONE.getId().toString().replaceAll("chaosawakens:", "") + "_to_spawn_egg"));
		FossilRecipeBuilder.builder(CARecipes.DEFOSSILIZING_SERIALIZER.get(),
	...
	private static void woodenTrapdoor(Consumer<IFinishedRecipe> consumer, IItemProvider pTrapdoor, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pTrapdoor).define('#', pMaterial).pattern("###").pattern("###").group("wooden_trapdoor").unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}
	...
	private static void leafCarpet(Consumer<IFinishedRecipe> consumer, IItemProvider pLeadCarpet, IItemProvider pMaterial) {
		ShapedRecipeBuilder.shaped(pLeadCarpet).define('#', pMaterial).pattern("##").group("leaf_carpet").unlockedBy("has_planks", has(pMaterial)).save(consumer);
	}
