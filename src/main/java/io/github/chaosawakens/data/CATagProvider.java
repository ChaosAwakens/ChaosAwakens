...
public class CATagProvider extends BlockTagsProvider {
	...
	public static class CABlockTagProvider extends BlockTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Blocks.BASE_STONE_MINING).addTags(BlockTags.BASE_STONE_OVERWORLD).add(CABlocks.MARBLE.get()).add(CABlocks.LIMESTONE.get());
			this.tag(CATags.Blocks.BASE_STONE_VILLAGE).addTags(BlockTags.BASE_STONE_OVERWORLD);
			this.tag(CATags.Blocks.MINERS_DREAM_MINEABLE).addTags(BlockTags.BASE_STONE_OVERWORLD, BlockTags.BASE_STONE_NETHER, CATags.Blocks.BASE_STONE_CRYSTAL, CATags.Blocks.BASE_STONE_MINING, Tags.Blocks.STONE, Tags.Blocks.NETHERRACK, Tags.Blocks.SANDSTONE, Tags.Blocks.END_STONES, Tags.Blocks.GRAVEL, Tags.Blocks.SAND, Tags.Blocks.DIRT).add(Blocks.ICE);
			...
			this.tag(BlockTags.LEAVES).add(CABlocks.APPLE_LEAVES.get(), CABlocks.CHERRY_LEAVES.get(), CABlocks.GINKGO_LEAVES.get(), CABlocks.PEACH_LEAVES.get(), CABlocks.SKYWOOD_LEAVES.get());
			this.tag(BlockTags.SAPLINGS).add(CABlocks.APPLE_SAPLING.get(), CABlocks.CHERRY_SAPLING.get(), CABlocks.PEACH_SAPLING.get());
			this.tag(BlockTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get(), CABlocks.CHERRY_SLAB.get(), CABlocks.DUPLICATION_SLAB.get(), CABlocks.GINKGO_SLAB.get(), CABlocks.PEACH_SLAB.get(), CABlocks.SKYWOOD_SLAB.get(), CABlocks.MOLDY_SLAB.get(), CABlocks.CRYSTAL_SLAB.get());
			this.tag(BlockTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get(), CABlocks.CHERRY_STAIRS.get(), CABlocks.DUPLICATION_STAIRS.get(), CABlocks.GINKGO_STAIRS.get(), CABlocks.PEACH_STAIRS.get(), CABlocks.SKYWOOD_STAIRS.get(), CABlocks.CRYSTAL_STAIRS.get());
			this.tag(BlockTags.FENCE_GATES).add(CABlocks.APPLE_FENCE_GATE.get(), CABlocks.CHERRY_FENCE_GATE.get(), CABlocks.DUPLICATION_FENCE_GATE.get(), CABlocks.GINKGO_FENCE_GATE.get(), CABlocks.PEACH_FENCE_GATE.get(), CABlocks.SKYWOOD_FENCE_GATE.get(), CABlocks.CRYSTAL_FENCE_GATE.get());
			this.tag(BlockTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get(), CABlocks.CHERRY_FENCE.get(), CABlocks.DUPLICATION_FENCE.get(), CABlocks.GINKGO_FENCE.get(), CABlocks.PEACH_FENCE.get(), CABlocks.SKYWOOD_FENCE.get(), CABlocks.MOLDY_FENCE.get(), CABlocks.CRYSTAL_FENCE.get());
			this.tag(BlockTags.WOODEN_BUTTONS).add(CABlocks.APPLE_BUTTON.get(), CABlocks.CHERRY_BUTTON.get(), CABlocks.DUPLICATION_BUTTON.get(), CABlocks.GINKGO_BUTTON.get(), CABlocks.PEACH_BUTTON.get(), CABlocks.SKYWOOD_BUTTON.get(), CABlocks.CRYSTAL_BUTTON.get());
			this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(CABlocks.APPLE_PRESSURE_PLATE.get(), CABlocks.CHERRY_PRESSURE_PLATE.get(), CABlocks.DUPLICATION_PRESSURE_PLATE.get(), CABlocks.GINKGO_PRESSURE_PLATE.get(), CABlocks.PEACH_PRESSURE_PLATE.get(), CABlocks.SKYWOOD_PRESSURE_PLATE.get(), CABlocks.CRYSTAL_PRESSURE_PLATE.get());
	...
	public static class CAItemTagProvider extends ItemTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Items.FISH).add(CAItems.BLUE_FISH.get(), CAItems.FIRE_FISH.get(), CAItems.GRAY_FISH.get(), CAItems.GREEN_FISH.get(), CAItems.PINK_FISH.get(), CAItems.ROCK_FISH.get(), CAItems.SPARK_FISH.get(), CAItems.SUN_FISH.get(), CAItems.WOOD_FISH.get());
			...
			this.tag(CATags.Items.FOSSILS_STONE_CHAOSAWAKENS).add(CABlocks.FOSSILISED_ACACIA_ENT.get().asItem(), CABlocks.FOSSILISED_BIRCH_ENT.get().asItem(), CABlocks.FOSSILISED_DARK_OAK_ENT.get().asItem(), CABlocks.FOSSILISED_JUNGLE_ENT.get().asItem(),
					CABlocks.FOSSILISED_OAK_ENT.get().asItem(), CABlocks.FOSSILISED_SPRUCE_ENT.get().asItem(), CABlocks.FOSSILISED_HERCULES_BEETLE.get().asItem(), CABlocks.FOSSILISED_RUBY_BUG.get().asItem(),
			...
			this.tag(CATags.Items.FOSSILS_KYANITE).add(CABlocks.CRYSTALLISED_CRYSTAL_APPLE_COW.get().asItem());
			...
			this.tag(ItemTags.LOGS_THAT_BURN).addTags(CATags.Items.APPLE_LOGS, CATags.Items.CHERRY_LOGS, CATags.Items.GINKGO_LOGS, CATags.Items.PEACH_LOGS, CATags.Items.SKYWOOD_LOGS, CATags.Items.CRYSTAL_LOGS);
			this.tag(ItemTags.PLANKS).add(CABlocks.APPLE_PLANKS.get().asItem(), CABlocks.CHERRY_PLANKS.get().asItem(), CABlocks.DUPLICATION_PLANKS.get().asItem(), CABlocks.GINKGO_PLANKS.get().asItem(), CABlocks.PEACH_PLANKS.get().asItem(), CABlocks.SKYWOOD_PLANKS.get().asItem(), CABlocks.MOLDY_PLANKS.get().asItem());
			this.tag(ItemTags.LEAVES).add(CABlocks.APPLE_LEAVES.get().asItem(), CABlocks.CHERRY_LEAVES.get().asItem(), CABlocks.GINKGO_LEAVES.get().asItem(), CABlocks.PEACH_LEAVES.get().asItem(), CABlocks.SKYWOOD_LEAVES.get().asItem());
			...
			this.tag(ItemTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get().asItem(), CABlocks.CHERRY_SLAB.get().asItem(), CABlocks.DUPLICATION_SLAB.get().asItem(), CABlocks.GINKGO_SLAB.get().asItem(), CABlocks.PEACH_SLAB.get().asItem(), CABlocks.SKYWOOD_SLAB.get().asItem(), CABlocks.MOLDY_SLAB.get().asItem(), CABlocks.CRYSTAL_SLAB.get().asItem());
			this.tag(ItemTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get().asItem(), CABlocks.CHERRY_STAIRS.get().asItem(), CABlocks.DUPLICATION_STAIRS.get().asItem(), CABlocks.GINKGO_STAIRS.get().asItem(), CABlocks.PEACH_STAIRS.get().asItem(), CABlocks.SKYWOOD_STAIRS.get().asItem(), CABlocks.CRYSTAL_STAIRS.get().asItem());
			this.tag(ItemTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get().asItem(), CABlocks.CHERRY_FENCE.get().asItem(), CABlocks.DUPLICATION_FENCE.get().asItem(), CABlocks.GINKGO_FENCE.get().asItem(), CABlocks.PEACH_FENCE.get().asItem(), CABlocks.SKYWOOD_FENCE.get().asItem(), CABlocks.MOLDY_FENCE.get().asItem(), CABlocks.CRYSTAL_FENCE.get().asItem());
			this.tag(ItemTags.WOODEN_BUTTONS).add(CABlocks.APPLE_BUTTON.get().asItem(), CABlocks.CHERRY_BUTTON.get().asItem(), CABlocks.DUPLICATION_BUTTON.get().asItem(), CABlocks.GINKGO_BUTTON.get().asItem(), CABlocks.PEACH_BUTTON.get().asItem(), CABlocks.SKYWOOD_BUTTON.get().asItem(), CABlocks.CRYSTAL_BUTTON.get().asItem());
			this.tag(ItemTags.WOODEN_PRESSURE_PLATES).add(CABlocks.APPLE_PRESSURE_PLATE.get().asItem(), CABlocks.CHERRY_PRESSURE_PLATE.get().asItem(), CABlocks.DUPLICATION_PRESSURE_PLATE.get().asItem(), CABlocks.GINKGO_PRESSURE_PLATE.get().asItem(), CABlocks.PEACH_PRESSURE_PLATE.get().asItem(), CABlocks.SKYWOOD_PRESSURE_PLATE.get().asItem(), CABlocks.CRYSTAL_PRESSURE_PLATE.get().asItem());
			...
			this.tag(Tags.Items.STONE).add(CABlocks.KYANITE.get().asItem(), CABlocks.MARBLE.get().asItem(), CABlocks.LIMESTONE.get().asItem());
