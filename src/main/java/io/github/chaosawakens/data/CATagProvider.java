...
public class CATagProvider extends BlockTagsProvider {
	...
	public static class CABlockTagProvider extends BlockTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Blocks.HIRMERIELLA_LOGS).add(CABlocks.HIRMERIELLA_LOG.get());
			this.tag(CATags.Blocks.DENSEWOOD_LOGS).add(CABlocks.DENSEWOOD_LOG.get());
			...
			this.tag(BlockTags.PLANKS).add(CABlocks.APPLE_PLANKS.get(), CABlocks.CHERRY_PLANKS.get(), CABlocks.PEACH_PLANKS.get(), CABlocks.DUPLICATION_PLANKS.get(), CABlocks.SKYWOOD_PLANKS.get(), CABlocks.GINKGO_PLANKS.get(), CABlocks.HIRMERIELLA_PLANKS.get(), CABlocks.MOLDY_PLANKS.get());
			...
			this.tag(BlockTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get(), CABlocks.CHERRY_SLAB.get(), CABlocks.PEACH_SLAB.get(), CABlocks.DUPLICATION_SLAB.get(), CABlocks.SKYWOOD_SLAB.get(), CABlocks.GINKGO_SLAB.get(), CABlocks.HIRMERIELLA_SLAB.get(), CABlocks.MOLDY_SLAB.get(), CABlocks.CRYSTAL_SLAB.get());
			this.tag(BlockTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get(), CABlocks.CHERRY_STAIRS.get(), CABlocks.PEACH_STAIRS.get(), CABlocks.DUPLICATION_STAIRS.get(), CABlocks.SKYWOOD_STAIRS.get(), CABlocks.GINKGO_STAIRS.get(), CABlocks.HIRMERIELLA_STAIRS.get(), CABlocks.CRYSTAL_STAIRS.get());
			this.tag(BlockTags.FENCE_GATES).add(CABlocks.APPLE_FENCE_GATE.get(), CABlocks.CHERRY_FENCE_GATE.get(), CABlocks.PEACH_FENCE_GATE.get(), CABlocks.DUPLICATION_FENCE_GATE.get(), CABlocks.SKYWOOD_FENCE_GATE.get(), CABlocks.GINKGO_FENCE_GATE.get(), CABlocks.HIRMERIELLA_FENCE_GATE.get(), CABlocks.CRYSTAL_FENCE_GATE.get());
			this.tag(BlockTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get(), CABlocks.CHERRY_FENCE.get(), CABlocks.PEACH_FENCE.get(), CABlocks.DUPLICATION_FENCE.get(), CABlocks.SKYWOOD_FENCE.get(), CABlocks.GINKGO_FENCE.get(), CABlocks.HIRMERIELLA_FENCE.get(), CABlocks.MOLDY_FENCE.get(), CABlocks.CRYSTAL_FENCE.get());
			this.tag(BlockTags.WOODEN_BUTTONS).add(CABlocks.APPLE_BUTTON.get(), CABlocks.CHERRY_BUTTON.get(), CABlocks.PEACH_BUTTON.get(), CABlocks.DUPLICATION_BUTTON.get(), CABlocks.SKYWOOD_BUTTON.get(), CABlocks.GINKGO_BUTTON.get(), CABlocks.HIRMERIELLA_BUTTON.get(), CABlocks.CRYSTAL_BUTTON.get());
			this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(CABlocks.APPLE_PRESSURE_PLATE.get(), CABlocks.CHERRY_PRESSURE_PLATE.get(), CABlocks.PEACH_PRESSURE_PLATE.get(), CABlocks.DUPLICATION_PRESSURE_PLATE.get(), CABlocks.SKYWOOD_PRESSURE_PLATE.get(), CABlocks.GINKGO_PRESSURE_PLATE.get(), CABlocks.HIRMERIELLA_PRESSURE_PLATE.get(), CABlocks.CRYSTAL_PRESSURE_PLATE.get());
			...
			this.tag(BlockTags.WOODEN_TRAPDOORS).add(CABlocks.APPLE_TRAPDOOR.get(), CABlocks.CHERRY_TRAPDOOR.get(), CABlocks.DUPLICATION_TRAPDOOR.get(), CABlocks.GINKGO_TRAPDOOR.get(), CABlocks.HIRMERIELLA_TRAPDOOR.get(), CABlocks.PEACH_TRAPDOOR.get(), CABlocks.SKYWOOD_TRAPDOOR.get());
			this.tag(BlockTags.DOORS).add(CABlocks.APPLE_DOOR.get(), CABlocks.CHERRY_DOOR.get(), CABlocks.DUPLICATION_DOOR.get(), CABlocks.GINKGO_DOOR.get(), CABlocks.HIRMERIELLA_DOOR.get(), CABlocks.PEACH_DOOR.get(), CABlocks.SKYWOOD_DOOR.get());
	...
	public static class CAItemTagProvider extends ItemTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Items.HIRMERIELLA_LOGS).add(CABlocks.HIRMERIELLA_LOG.get().asItem());
			this.tag(CATags.Items.DENSEWOOD_LOGS).add(CABlocks.DENSEWOOD_LOG.get().asItem());
