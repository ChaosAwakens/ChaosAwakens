...
public class CATagProvider extends BlockTagsProvider {
    ...
    public static class CABlockTagProvider extends BlockTagsProvider {
        ...
        protected void addTags() {
            ...
            this.tag(BlockTags.STANDING_SIGNS).add(CABlocks.APPLE_SIGN.get(), CABlocks.CHERRY_SIGN.get(), CABlocks.DUPLICATION_SIGN.get(), CABlocks.PEACH_SIGN.get(), CABlocks.SKYWOOD_SIGN.get(), CABlocks.GINKGO_SIGN.get());
            ...
            this.tag(BlockTags.WALLS).add(CABlocks.MARBLE_WALL.get()).add(CABlocks.CHISELED_MARBLE_WALL.get()).add(CABlocks.CRACKED_MARBLE_WALL.get()).add(CABlocks.MARBLE_BRICK_WALL.get()).add(CABlocks.POLISHED_MARBLE_WALL.get()).add(CABlocks.MOSSY_MARBLE_WALL.get()).add(CABlocks.LIMESTONE_WALL.get()).add(CABlocks.CHISELED_LIMESTONE_WALL.get()).add(CABlocks.CRACKED_LIMESTONE_WALL.get()).add(CABlocks.LIMESTONE_BRICK_WALL.get()).add(CABlocks.POLISHED_LIMESTONE_WALL.get()).add(CABlocks.MOSSY_LIMESTONE_WALL.get()).add(CABlocks.ROBO_WALL_I.get()).add(CABlocks.ROBO_WALL_X.get());
