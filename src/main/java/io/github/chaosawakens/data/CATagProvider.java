...
public class CATagProvider extends BlockTagsProvider {
	...
	public static class CABlockTagProvider extends BlockTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Blocks.HIRMERIELLA_LOGS).add(CABlocks.HIRMERIELLA_LOG.get(), CABlocks.HIRMERIELLA_WOOD.get());
			this.tag(CATags.Blocks.DENSEWOOD_LOGS).add(CABlocks.DENSEWOOD_LOG.get(), CABlocks.DENSEWOOD_WOOD.get());
			...
			this.tag(BlockTags.LOGS_THAT_BURN).addTags(CATags.Blocks.APPLE_LOGS, CATags.Blocks.CHERRY_LOGS, CATags.Blocks.GINKGO_LOGS, CATags.Blocks.HIRMERIELLA_LOGS, CATags.Blocks.DENSEWOOD_LOGS, CATags.Blocks.PEACH_LOGS, CATags.Blocks.SKYWOOD_LOGS, CATags.Blocks.CRYSTAL_LOGS);
			this.tag(BlockTags.LEAVES).add(CABlocks.APPLE_LEAVES.get(), CABlocks.CHERRY_LEAVES.get(), CABlocks.GINKGO_LEAVES.get(), CABlocks.HIRMERIELLA_LEAVES.get(), CABlocks.DENSEWOOD_LEAVES.get(), CABlocks.PEACH_LEAVES.get(), CABlocks.SKYWOOD_LEAVES.get());
			this.tag(BlockTags.PLANKS).add(CABlocks.APPLE_PLANKS.get(), CABlocks.CHERRY_PLANKS.get(), CABlocks.PEACH_PLANKS.get(), CABlocks.DUPLICATION_PLANKS.get(), CABlocks.SKYWOOD_PLANKS.get(), CABlocks.GINKGO_PLANKS.get(), CABlocks.HIRMERIELLA_PLANKS.get(), CABlocks.DENSEWOOD_PLANKS.get(), CABlocks.MOLDY_PLANKS.get());
			this.tag(BlockTags.SAPLINGS).add(CABlocks.APPLE_SAPLING.get(), CABlocks.CHERRY_SAPLING.get(), CABlocks.PEACH_SAPLING.get(), CABlocks.HIRMERIELLA_SAPLING.get(), CABlocks.DENSEWOOD_SAPLING.get());
			this.tag(BlockTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get(), CABlocks.CHERRY_SLAB.get(), CABlocks.PEACH_SLAB.get(), CABlocks.DUPLICATION_SLAB.get(), CABlocks.SKYWOOD_SLAB.get(), CABlocks.GINKGO_SLAB.get(), CABlocks.HIRMERIELLA_SLAB.get(), CABlocks.DENSEWOOD_SLAB.get(), CABlocks.MOLDY_SLAB.get(), CABlocks.CRYSTAL_SLAB.get());
			this.tag(BlockTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get(), CABlocks.CHERRY_STAIRS.get(), CABlocks.PEACH_STAIRS.get(), CABlocks.DUPLICATION_STAIRS.get(), CABlocks.SKYWOOD_STAIRS.get(), CABlocks.GINKGO_STAIRS.get(), CABlocks.HIRMERIELLA_STAIRS.get(), CABlocks.DENSEWOOD_STAIRS.get(), CABlocks.CRYSTAL_STAIRS.get());
			this.tag(BlockTags.FENCE_GATES).add(CABlocks.APPLE_FENCE_GATE.get(), CABlocks.CHERRY_FENCE_GATE.get(), CABlocks.PEACH_FENCE_GATE.get(), CABlocks.DUPLICATION_FENCE_GATE.get(), CABlocks.SKYWOOD_FENCE_GATE.get(), CABlocks.GINKGO_FENCE_GATE.get(), CABlocks.HIRMERIELLA_FENCE_GATE.get(), CABlocks.DENSEWOOD_FENCE_GATE.get(), CABlocks.CRYSTAL_FENCE_GATE.get());
			this.tag(BlockTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get(), CABlocks.CHERRY_FENCE.get(), CABlocks.PEACH_FENCE.get(), CABlocks.DUPLICATION_FENCE.get(), CABlocks.SKYWOOD_FENCE.get(), CABlocks.GINKGO_FENCE.get(), CABlocks.HIRMERIELLA_FENCE.get(), CABlocks.DENSEWOOD_FENCE.get(), CABlocks.MOLDY_FENCE.get(), CABlocks.CRYSTAL_FENCE.get());
			this.tag(BlockTags.WOODEN_BUTTONS).add(CABlocks.APPLE_BUTTON.get(), CABlocks.CHERRY_BUTTON.get(), CABlocks.PEACH_BUTTON.get(), CABlocks.DUPLICATION_BUTTON.get(), CABlocks.SKYWOOD_BUTTON.get(), CABlocks.GINKGO_BUTTON.get(), CABlocks.HIRMERIELLA_BUTTON.get(), CABlocks.DENSEWOOD_BUTTON.get(), CABlocks.CRYSTAL_BUTTON.get());
			this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(CABlocks.APPLE_PRESSURE_PLATE.get(), CABlocks.CHERRY_PRESSURE_PLATE.get(), CABlocks.PEACH_PRESSURE_PLATE.get(), CABlocks.DUPLICATION_PRESSURE_PLATE.get(), CABlocks.SKYWOOD_PRESSURE_PLATE.get(), CABlocks.GINKGO_PRESSURE_PLATE.get(), CABlocks.HIRMERIELLA_PRESSURE_PLATE.get(), CABlocks.DENSEWOOD_PRESSURE_PLATE.get(), CABlocks.CRYSTAL_PRESSURE_PLATE.get());
			...
			this.tag(BlockTags.STANDING_SIGNS).add(CABlocks.APPLE_SIGN.get(), CABlocks.CHERRY_SIGN.get(), CABlocks.DUPLICATION_SIGN.get(), CABlocks.GINKGO_SIGN.get(), CABlocks.HIRMERIELLA_SIGN.get(), CABlocks.DENSEWOOD_SIGN.get(), CABlocks.PEACH_SIGN.get(), CABlocks.SKYWOOD_SIGN.get());
			this.tag(BlockTags.WALL_SIGNS).add(CABlocks.APPLE_WALL_SIGN.get(), CABlocks.CHERRY_WALL_SIGN.get(), CABlocks.DUPLICATION_WALL_SIGN.get(), CABlocks.GINKGO_WALL_SIGN.get(), CABlocks.HIRMERIELLA_WALL_SIGN.get(), CABlocks.DENSEWOOD_WALL_SIGN.get(), CABlocks.PEACH_WALL_SIGN.get(), CABlocks.SKYWOOD_WALL_SIGN.get());
			this.tag(BlockTags.WOODEN_TRAPDOORS).add(CABlocks.APPLE_TRAPDOOR.get(), CABlocks.CHERRY_TRAPDOOR.get(), CABlocks.DUPLICATION_TRAPDOOR.get(), CABlocks.GINKGO_TRAPDOOR.get(), CABlocks.HIRMERIELLA_TRAPDOOR.get(), CABlocks.DENSEWOOD_TRAPDOOR.get(), CABlocks.PEACH_TRAPDOOR.get(), CABlocks.SKYWOOD_TRAPDOOR.get());
			this.tag(BlockTags.DOORS).add(CABlocks.APPLE_DOOR.get(), CABlocks.CHERRY_DOOR.get(), CABlocks.DUPLICATION_DOOR.get(), CABlocks.GINKGO_DOOR.get(), CABlocks.HIRMERIELLA_DOOR.get(), CABlocks.DENSEWOOD_DOOR.get(), CABlocks.PEACH_DOOR.get(), CABlocks.SKYWOOD_DOOR.get());
	...
	public static class CAItemTagProvider extends ItemTagsProvider {
		...
		protected void addTags() {
			...
			this.tag(CATags.Items.HIRMERIELLA_LOGS).add(CABlocks.HIRMERIELLA_LOG.get().asItem(), CABlocks.HIRMERIELLA_WOOD.get().asItem());
			this.tag(CATags.Items.DENSEWOOD_LOGS).add(CABlocks.DENSEWOOD_LOG.get().asItem(), CABlocks.DENSEWOOD_WOOD.get().asItem());
			...
			this.tag(CATags.Items.LEAF_CARPETS).add(CABlocks.ACACIA_LEAF_CARPET.get().asItem(), CABlocks.BIRCH_LEAF_CARPET.get().asItem(), CABlocks.DARK_OAK_LEAF_CARPET.get().asItem(), CABlocks.JUNGLE_LEAF_CARPET.get().asItem(), CABlocks.OAK_LEAF_CARPET.get().asItem(), CABlocks.SPRUCE_LEAF_CARPET.get().asItem(), CABlocks.APPLE_LEAF_CARPET.get().asItem(), CABlocks.CHERRY_LEAF_CARPET.get().asItem(), CABlocks.DUPLICATION_LEAF_CARPET.get().asItem(), CABlocks.GINKGO_LEAF_CARPET.get().asItem(), CABlocks.HIRMERIELLA_LEAF_CARPET.get().asItem(), CABlocks.DENSEWOOD_LEAF_CARPET.get().asItem(), CABlocks.PEACH_LEAF_CARPET.get().asItem(), CABlocks.SKYWOOD_LEAF_CARPET.get().asItem());

			this.tag(ItemTags.LOGS).addTags(CATags.Items.DUPLICATION_LOGS);
			this.tag(ItemTags.LOGS_THAT_BURN).addTags(CATags.Items.APPLE_LOGS, CATags.Items.CHERRY_LOGS, CATags.Items.PEACH_LOGS, CATags.Items.SKYWOOD_LOGS, CATags.Items.GINKGO_LOGS, CATags.Items.HIRMERIELLA_LOGS, CATags.Items.DENSEWOOD_LOGS, CATags.Items.CRYSTAL_LOGS);
			this.tag(ItemTags.PLANKS).add(CABlocks.APPLE_PLANKS.get().asItem(), CABlocks.CHERRY_PLANKS.get().asItem(), CABlocks.PEACH_PLANKS.get().asItem(), CABlocks.DUPLICATION_PLANKS.get().asItem(), CABlocks.SKYWOOD_PLANKS.get().asItem(), CABlocks.GINKGO_PLANKS.get().asItem(), CABlocks.HIRMERIELLA_PLANKS.get().asItem(), CABlocks.DENSEWOOD_PLANKS.get().asItem(), CABlocks.MOLDY_PLANKS.get().asItem());
			this.tag(ItemTags.LEAVES).add(CABlocks.APPLE_LEAVES.get().asItem(), CABlocks.CHERRY_LEAVES.get().asItem(), CABlocks.PEACH_LEAVES.get().asItem(), CABlocks.SKYWOOD_LEAVES.get().asItem(), CABlocks.GINKGO_LEAVES.get().asItem(), CABlocks.HIRMERIELLA_LEAVES.get().asItem(), CABlocks.DENSEWOOD_LEAVES.get().asItem());
			this.tag(ItemTags.SAPLINGS).add(CABlocks.APPLE_SAPLING.get().asItem(), CABlocks.CHERRY_SAPLING.get().asItem(), CABlocks.PEACH_SAPLING.get().asItem(), CABlocks.HIRMERIELLA_SAPLING.get().asItem(), CABlocks.DENSEWOOD_SAPLING.get().asItem());
			this.tag(ItemTags.WOODEN_SLABS).add(CABlocks.APPLE_SLAB.get().asItem(), CABlocks.CHERRY_SLAB.get().asItem(), CABlocks.PEACH_SLAB.get().asItem(), CABlocks.DUPLICATION_SLAB.get().asItem(), CABlocks.SKYWOOD_SLAB.get().asItem(), CABlocks.GINKGO_SLAB.get().asItem(), CABlocks.HIRMERIELLA_SLAB.get().asItem(), CABlocks.DENSEWOOD_SLAB.get().asItem(), CABlocks.MOLDY_SLAB.get().asItem(), CABlocks.CRYSTAL_SLAB.get().asItem());
			this.tag(ItemTags.WOODEN_STAIRS).add(CABlocks.APPLE_STAIRS.get().asItem(), CABlocks.CHERRY_STAIRS.get().asItem(), CABlocks.PEACH_STAIRS.get().asItem(), CABlocks.DUPLICATION_STAIRS.get().asItem(), CABlocks.SKYWOOD_STAIRS.get().asItem(), CABlocks.GINKGO_STAIRS.get().asItem(), CABlocks.HIRMERIELLA_STAIRS.get().asItem(), CABlocks.DENSEWOOD_STAIRS.get().asItem(), CABlocks.CRYSTAL_STAIRS.get().asItem());
			this.tag(ItemTags.WOODEN_FENCES).add(CABlocks.APPLE_FENCE.get().asItem(), CABlocks.CHERRY_FENCE.get().asItem(), CABlocks.PEACH_FENCE.get().asItem(), CABlocks.DUPLICATION_FENCE.get().asItem(), CABlocks.SKYWOOD_FENCE.get().asItem(), CABlocks.GINKGO_FENCE.get().asItem(), CABlocks.HIRMERIELLA_FENCE.get().asItem(), CABlocks.DENSEWOOD_FENCE.get().asItem(), CABlocks.MOLDY_FENCE.get().asItem(), CABlocks.CRYSTAL_FENCE.get().asItem());
			this.tag(ItemTags.WOODEN_BUTTONS).add(CABlocks.APPLE_BUTTON.get().asItem(), CABlocks.CHERRY_BUTTON.get().asItem(), CABlocks.PEACH_BUTTON.get().asItem(), CABlocks.DUPLICATION_BUTTON.get().asItem(), CABlocks.SKYWOOD_BUTTON.get().asItem(), CABlocks.GINKGO_BUTTON.get().asItem(), CABlocks.HIRMERIELLA_BUTTON.get().asItem(), CABlocks.DENSEWOOD_BUTTON.get().asItem(), CABlocks.CRYSTAL_BUTTON.get().asItem());
			this.tag(ItemTags.WOODEN_PRESSURE_PLATES).add(CABlocks.APPLE_PRESSURE_PLATE.get().asItem(), CABlocks.CHERRY_PRESSURE_PLATE.get().asItem(), CABlocks.PEACH_PRESSURE_PLATE.get().asItem(), CABlocks.DUPLICATION_PRESSURE_PLATE.get().asItem(), CABlocks.SKYWOOD_PRESSURE_PLATE.get().asItem(), CABlocks.GINKGO_PRESSURE_PLATE.get().asItem(), CABlocks.HIRMERIELLA_PRESSURE_PLATE.get().asItem(), CABlocks.DENSEWOOD_PRESSURE_PLATE.get().asItem(), CABlocks.CRYSTAL_PRESSURE_PLATE.get().asItem());
