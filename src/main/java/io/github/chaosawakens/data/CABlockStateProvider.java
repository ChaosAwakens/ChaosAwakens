...
public class CABlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        this.stairsBlock(CABlocks.CRACKED_MARBLE_STAIRS.get(), chaosRL("cracked_marble_bricks"));
        this.stairsBlock(CABlocks.MOSSY_MARBLE_STAIRS.get(), chaosRL("mossy_marble_bricks"));
        ...
        this.wallBlock(CABlocks.CHISELED_MARBLE_WALL.get(), "chiseled_marble", chaosRL("chiseled_marble_bricks"));
        this.wallBlock(CABlocks.CRACKED_MARBLE_WALL.get(), "cracked_marble", chaosRL("cracked_marble_bricks"));
        this.wallBlock(CABlocks.MOSSY_MARBLE_WALL.get(), "mossy_marble", chaosRL("mossy_marble_bricks"));
        ...
        this.stairsBlock(CABlocks.CRACKED_LIMESTONE_STAIRS.get(), chaosRL("cracked_limestone_bricks"));
        this.stairsBlock(CABlocks.MOSSY_LIMESTONE_STAIRS.get(), chaosRL("mossy_limestone_bricks"));
        ...
        this.wallBlock(CABlocks.LIMESTONE_BRICK_WALL.get(), "limestone", chaosRL("limestone_bricks"));
    ...
    public void doubleCross(DoubleDensePlantBlock block) {
        ...
        getVariantBuilder(block).forAllStatesExcept(state -> ConfiguredModel.builder().modelFile(state.getValue(DoubleDensePlantBlock.HALF) == DoubleBlockHalf.LOWER ? crossLower : crossUpper).build());
    }
    ...
    public void leafCarpetBlock(LeafCarpetBlock block, ResourceLocation textureName) {
        ...
        getVariantBuilder(block).forAllStates(state -> {
            ...
            return ConfiguredModel.builder()
                    .uvLock(uvlock).rotationX(rotX).rotationY(rotY).modelFile(carpet)
                    .build();
        });
    }
