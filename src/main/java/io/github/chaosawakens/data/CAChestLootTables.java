...
public class CAChestLootTables extends ChestLootTables {
	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> register) {
		register.accept(CATreasure.ent_dungeon_acacia_loot.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
		...
		register.accept(CATreasure.ent_dungeon_birch_loot.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
				.setRolls(ConstantRange.exactly(4))
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.ent_dungeon_crimson_loot.lootTable, LootTable
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.ent_dungeon_dark_oak_loot.lootTable, LootTable
				.lootTable().withPool(LootPool.lootPool()
						// Common Loot
						.setRolls(ConstantRange.exactly(4))
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.ent_dungeon_jungle_loot.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
				.setRolls(ConstantRange.exactly(4))
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.ent_dungeon_jungle_trap.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
				.setRolls(ConstantRange.exactly(4))
		...
		register.accept(CATreasure.ent_dungeon_oak_loot.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
				.setRolls(ConstantRange.exactly(4))
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.ent_dungeon_spruce_loot.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
				.setRolls(ConstantRange.exactly(4))
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.ent_dungeon_warped_loot.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
				.setRolls(ConstantRange.exactly(4))
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.ent_dungeon_brown_mushroom_loot.lootTable, LootTable
				.lootTable().withPool(LootPool.lootPool()
						// Common Loot
						.setRolls(ConstantRange.exactly(4))
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.ent_dungeon_red_mushroom_loot.lootTable, LootTable
				.lootTable().withPool(LootPool.lootPool()
						// Common Loot
						.setRolls(ConstantRange.exactly(4))
						.add(ItemLootEntry.lootTableItem(Items.MUSHROOM_STEM)
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 2)))
								.when(RandomChance.randomChance(0.65F)).setWeight(25))));
		register.accept(CATreasure.wasp_dungeon_loot.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
				.setRolls(ConstantRange.exactly(3))
				...
				.withPool(LootPool.lootPool()
						...
						.add(ItemLootEntry.lootTableItem(CAItems.TIGERS_EYE.get())
								.apply(SetCount.setCount(RandomValueRange.between(0, 1)))
								.when(RandomChance.randomChance(0.35F)).setWeight(50))));
		register.accept(CATreasure.village_cherry_house.lootTable, LootTable.lootTable().withPool(LootPool.lootPool()
				// Common Loot
