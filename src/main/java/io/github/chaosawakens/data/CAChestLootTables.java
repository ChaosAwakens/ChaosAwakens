				...
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								...
								.add(ItemLootEntry.lootTableItem(Items.TIPPED_ARROW)
										...
										.apply(SetNBT.setTag(Util.make(new CompoundNBT(), (nbt) -> nbt.putString("Potion", "minecraft:poison")))))
								.add(ItemLootEntry.lootTableItem(Items.TIPPED_ARROW)
										.apply(SetCount.setCount(RandomValueRange.between(2.0F, 6.0F)))
										.apply(SetNBT.setTag(Util.make(new CompoundNBT(), (nbt) -> nbt.putString("Potion", "minecraft:long_poison")))))
								.add(ItemLootEntry.lootTableItem(Items.TIPPED_ARROW)
										.apply(SetCount.setCount(RandomValueRange.between(1.0F, 4.0F)))
										.apply(SetNBT.setTag(Util.make(new CompoundNBT(), (nbt) -> nbt.putString("Potion", "minecraft:strong_poison")))))));
