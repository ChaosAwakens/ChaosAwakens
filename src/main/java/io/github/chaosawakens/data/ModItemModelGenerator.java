...
public class ModItemModelGenerator extends ItemModelProvider {
	...
	protected void registerModels() {
		 ...
		 * ModItems.GOLDEN_PORKCHOP,ModItems.GOLDEN_MELON_SLICE,ModItems.
		 * GOLDEN_MUSHROOM_STEW,ModItems.GOLDEN_STEAK, ModItems.GOLDEN_COOKIE,
		 * ModItems.GOLDEN_POTATO, ModItems.GOLDEN_PUMPKIN_PIE, ModItems.GOLDEN_FLESH,
		 * ModItems.GOLDEN_PUFFERFISH, ModItems.GOLDEN_SALMON,
		 ...
		 * ModItems.AMETHYST_HELMET, ModItems.AMETHYST_CHESTPLATE,
		 * ModItems.AMETHYST_LEGGINGS, ModItems.AMETHYST_BOOTS, ModItems.EMERALD_HELMET,
		 * ModItems.EMERALD_CHESTPLATE, ModItems.EMERALD_LEGGINGS,
		 * ModItems.EMERALD_BOOTS, ModItems.RUBY_HELMET, ModItems.RUBY_CHESTPLATE,
		 * ModItems.RUBY_LEGGINGS, ModItems.RUBY_BOOTS, ModItems.TIGERS_EYE_HELMET,
		 * ModItems.TIGERS_EYE_CHESTPLATE, ModItems.TIGERS_EYE_LEGGINGS,
		 * ModItems.TIGERS_EYE_BOOTS, ModItems.ULTIMATE_HELMET,
		 * ModItems.ULTIMATE_CHESTPLATE, ModItems.ULTIMATE_LEGGINGS,
		 * ModItems.ULTIMATE_BOOTS, ModItems.EXPERIENCE_HELMET,
		 * ModItems.EXPERIENCE_CHESTPLATE, ModItems.EXPERIENCE_LEGGINGS,
		 * ModItems.EXPERIENCE_BOOTS, ModItems.LAPIS_HELMET, ModItems.LAPIS_CHESTPLATE,
		 * ModItems.LAPIS_LEGGINGS, ModItems.LAPIS_BOOTS, ModItems.LAVA_EEL_HELMET,
		 * ModItems.LAVA_EEL_CHESTPLATE, ModItems.LAVA_EEL_LEGGINGS,
		 * ModItems.LAVA_EEL_BOOTS); handHeld(ModItems.AMETHYST_SWORD,
		 * ModItems.AMETHYST_PICKAXE, ModItems.AMETHYST_SHOVEL, ModItems.AMETHYST_AXE,
		 * ModItems.AMETHYST_HOE, ModItems.EMERALD_SWORD, ModItems.EMERALD_PICKAXE,
		 * ModItems.EMERALD_SHOVEL, ModItems.EMERALD_AXE, ModItems.EMERALD_HOE,
		 * ModItems.RUBY_SWORD, ModItems.RUBY_PICKAXE, ModItems.RUBY_SHOVEL,
		 * ModItems.RUBY_AXE, ModItems.RUBY_HOE, ModItems.TIGERS_EYE_SWORD,
		 * ModItems.TIGERS_EYE_PICKAXE, ModItems.TIGERS_EYE_SHOVEL,
		 * ModItems.TIGERS_EYE_AXE, ModItems.TIGERS_EYE_HOE, ModItems.ULTIMATE_SWORD,
		 * ModItems.ULTIMATE_PICKAXE, ModItems.ULTIMATE_SHOVEL, ModItems.ULTIMATE_AXE,
		 * ModItems.ULTIMATE_HOE, ModItems.EXPERIENCE_SWORD, ModItems.THUNDER_STAFF,
