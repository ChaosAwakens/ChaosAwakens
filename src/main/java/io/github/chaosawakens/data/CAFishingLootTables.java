...
public class CAFishingLootTables extends FishingLootTables {
	...
	public void accept(BiConsumer<ResourceLocation, Builder> biConsumer) {
		biConsumer.accept(LootTables.FISHING, LootTable.lootTable().withPool(LootPool.lootPool()
...
//									.add(TableLootEntry.lootTableReference(CALootTables.FISHING_NETHER_FISH).setWeight(50).setQuality(2))));
		...
		biConsumer.accept(CALootTables.FISHING_FISH,
				LootTable.lootTable()
						.withPool(LootPool.lootPool().add(ItemLootEntry.lootTableItem(CAItems.GREEN_FISH.get()))
		...
		biConsumer.accept(CALootTables.FISHING_TREASURE, LootTable.lootTable()
				.withPool(LootPool.lootPool().add(ItemLootEntry.lootTableItem(CAItems.AMETHYST.get()))
						.add(ItemLootEntry.lootTableItem(Items.DIAMOND)).add(ItemLootEntry.lootTableItem(Items.EMERALD))
		...
		biConsumer.accept(CALootTables.FISHING_JUNK,
				LootTable.lootTable()
						.withPool(LootPool.lootPool().add(ItemLootEntry.lootTableItem(CAItems.CANDYCANE.get()))
								.add(ItemLootEntry.lootTableItem(CAItems.CHEESE.get()))));

		biConsumer.accept(CALootTables.FISHING_LAVA_FISH, LootTable.lootTable()
				.withPool(LootPool.lootPool().add(ItemLootEntry.lootTableItem(CAItems.LAVA_EEL.get()))));
...
//								.add(ItemLootEntry.lootTableItem(CAItems.RUBY.get()))));
		...
		biConsumer.accept(CALootTables.FISHING_NETHER_FISH,
				LootTable.lootTable()
						.withPool(LootPool.lootPool().add(ItemLootEntry.lootTableItem(CAItems.RUBY.get()).setWeight(10))
