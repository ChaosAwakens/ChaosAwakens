...
//                .add(TableLootEntry.lootTableReference(CALootTables.FISHING_NETHER_FISH).setWeight(50).setQuality(2))));
        ...
        biConsumer.accept(CALootTables.FISHING_FISH, LootTable.lootTable()
        ...
        biConsumer.accept(CALootTables.FISHING_JUNK, LootTable.lootTable()
                .withPool(LootPool.lootPool()
...
//        biConsumer.accept(CALootTables.FISHING_LAVA_TREASURE, LootTable.lootTable()
//                .withPool(LootPool.lootPool()
//                        .add(ItemLootEntry.lootTableItem(CAItems.RUBY.get()))));

        biConsumer.accept(CALootTables.FISHING_NETHER_FISH, LootTable.lootTable()
                .withPool(LootPool.lootPool()
