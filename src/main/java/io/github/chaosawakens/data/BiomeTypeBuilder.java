...
public class BiomeTypeBuilder {
	...
	JsonObject serialize() {
		...
		if (this.moodSound != null && this.moodSound == "mood_sound") {
			...
			if (sound != null)
				moodSoundArray.getAsJsonObject().addProperty("sound", sound.getPath());
			if (tickDelay != null)
				moodSoundArray.getAsJsonObject().addProperty("tick_delay", tickDelay);
			if (blockSearchExtent != null)
				moodSoundArray.getAsJsonObject().addProperty("block_search_extent", blockSearchExtent);
			if (offset != null)
				moodSoundArray.getAsJsonObject().addProperty("offset", offset);
		...
		if (skyColor != null)
			effectsArray.getAsJsonObject().addProperty("sky_color", skyColor);
		if (fogColor != null)
			effectsArray.getAsJsonObject().addProperty("fog_color", fogColor);
		if (waterColor != null)
			effectsArray.getAsJsonObject().addProperty("water_color", waterColor);
		if (waterFogColor != null)
			effectsArray.getAsJsonObject().addProperty("water_fog_color", waterFogColor);
		if (grassColor != null)
			effectsArray.getAsJsonObject().addProperty("grass_color", grassColor);
		if (foliageColor != null)
			effectsArray.getAsJsonObject().addProperty("foliage_color", foliageColor);
