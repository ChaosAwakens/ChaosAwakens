...
public class CABlockItemColors {
	...
	public static void registerBlockColors(ColorHandlerEvent.Block event) {
		event.getBlockColors().register(GRASS_BLOCK_COLOR, CABlocks.RED_ANT_NEST.get(), CABlocks.BROWN_ANT_NEST.get(), CABlocks.RAINBOW_ANT_NEST.get(), CABlocks.UNSTABLE_ANT_NEST.get(), CABlocks.TERMITE_NEST.get());
		event.getBlockColors().register(FOLIAGE_BLOCK_COLOR, CABlocks.OAK_LEAF_CARPET.get(), CABlocks.JUNGLE_LEAF_CARPET.get(), CABlocks.ACACIA_LEAF_CARPET.get(), CABlocks.DARK_OAK_LEAF_CARPET.get());
	...
	public static void registerItemColors(ColorHandlerEvent.Item event) {
		event.getItemColors().register((stack, color) -> event.getBlockColors().getColor(((BlockItem) stack.getItem()).getBlock().defaultBlockState(), null, null, color),
				...
				CABlocks.OAK_LEAF_CARPET.get(), CABlocks.SPRUCE_LEAF_CARPET.get(), CABlocks.BIRCH_LEAF_CARPET.get(), CABlocks.JUNGLE_LEAF_CARPET.get(), CABlocks.ACACIA_LEAF_CARPET.get(), CABlocks.DARK_OAK_LEAF_CARPET.get());
	}
}
