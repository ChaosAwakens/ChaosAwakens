...
public class CAClientConfig {
	...
	static {
		final Pair<Client, ForgeConfigSpec> commonSpecPair = new ForgeConfigSpec.Builder().configure(Client::new);
	...
	public static class Client {
		...
		public Client(ForgeConfigSpec.Builder builder) {
			...
			builder.comment("(ToolTip color applies to both default tooltip description text and when shift-clicking)" + "\n"			
					+ "Colors include:" + "\n"
					+ "AQUA, BLACK, DARK_AQUA, DARK_BLUE, DARK_GRAY, DARK_GREEN, DARK_PURPLE, DARK_RED," + "\n"
					+ "GREEN, GOLD, LIGHT_PURPLE, RED, WHITE, YELLOW");
			toolTipColor = builder.define("ToolTip Color", TextFormatting.AQUA);
			builder.pop();
