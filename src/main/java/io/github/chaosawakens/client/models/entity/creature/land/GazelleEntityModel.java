...
public class GazelleEntityModel extends ExtendedAnimatedTickingGeoModel<GazelleEntity> {
	...
	public ResourceLocation getTextureLocation(GazelleEntity animatable) {
		...
		default: return ChaosAwakens.prefix("textures/entity/gazelle/brown_gazelle.png");
		case 1: return ChaosAwakens.prefix("textures/entity/gazelle/red_gazelle.png");
		case 2: return ChaosAwakens.prefix("textures/entity/gazelle/dark_red_gazelle.png");
		case 3: return ChaosAwakens.prefix("textures/entity/gazelle/tan_gazelle.png");
		case 4: return ChaosAwakens.prefix("textures/entity/gazelle/beij_gazelle.png");
		case 5: return ChaosAwakens.prefix("textures/entity/gazelle/black_gazelle.png");
		}
	}
