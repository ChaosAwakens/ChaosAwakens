...
public class UltimateBobberRender extends EntityRenderer<UltimateFishingBobberEntity> {
	private static final ResourceLocation BOBBER = new ResourceLocation(ChaosAwakens.MODID,
			"textures/entity/ultimate_fishing_hook.png");
	...
	@Override
	public void render(@Nonnull UltimateFishingBobberEntity p_225623_1_, float p_225623_2_, float p_225623_3_,
