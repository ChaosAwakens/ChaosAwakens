...
public class HerculesBeetleEntityRender extends GeoEntityRenderer<HerculesBeetleEntity> {
	...
	@Override
	public void renderEarly(HerculesBeetleEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(HerculesBeetleEntity animatable, float partialTicks, MatrixStack stack,
