...
public class CarrotPigEntityRender extends GeoEntityRenderer<CarrotPigEntity> {
	...
	@Override
	public void renderEarly(CarrotPigEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(CarrotPigEntity animatable, float partialTicks, MatrixStack stack,
