...
public class EnchantedGoldenAppleCowEntityRender extends GeoEntityRenderer<EnchantedGoldenAppleCowEntity> {
	...
	@Override
	public void renderEarly(EnchantedGoldenAppleCowEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(EnchantedGoldenAppleCowEntity animatable, float partialTicks, MatrixStack stack,
