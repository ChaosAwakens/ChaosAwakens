...
public class RubyBugEntityRender extends GeoEntityRenderer<RubyBugEntity> {
	...
	@Override
	public void renderEarly(RubyBugEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public ResourceLocation getTextureLocation(RubyBugEntity entity) {
		return new ResourceLocation(ChaosAwakens.MODID, "textures/entity/ruby_bug.png");
	}

	@Override
	public RenderType getRenderType(RubyBugEntity animatable, float partialTicks, MatrixStack stack,
