...
import io.github.chaosawakens.client.entity.model.LavaEelEntityModel;
...
public class LavaEelEntityRenderer extends GeoEntityRenderer<LavaEelEntity> {
	public LavaEelEntityRenderer(EntityRendererManager renderManager) {
