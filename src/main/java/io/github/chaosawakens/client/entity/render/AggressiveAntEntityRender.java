...
public class AggressiveAntEntityRender extends GeoEntityRenderer<AggressiveAntEntity> {
	...
	@Override
	public void renderEarly(AggressiveAntEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(AggressiveAntEntity animatable, float partialTicks, MatrixStack stack,
