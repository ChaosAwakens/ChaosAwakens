...
public class UltimateAppleCowEntityModel extends AnimatedTickingGeoModel<UltimateAppleCowEntity> {
	@Override
	...
	@Override
	public ResourceLocation getAnimationFileLocation(UltimateAppleCowEntity object) {
		return new ResourceLocation(ChaosAwakens.MODID, "animations/apple_cow.animation.json");
	}

	@SuppressWarnings("unchecked")
	@Override
	public void setLivingAnimations(UltimateAppleCowEntity entity, Integer uniqueID, @SuppressWarnings("rawtypes") AnimationEvent customPredicate) {
