...
public class RoboSniperGlowLayer extends GeoLayerRenderer<RoboSniperEntity> {
    ...
    private static final ResourceLocation GLOW = new ResourceLocation(ChaosAwakens.MODID, "textures/entity/robos/robo_sniper_glow.png");
    private static final ResourceLocation MODEL = new ResourceLocation(ChaosAwakens.MODID, "geo/robo_sniper.geo.json");
