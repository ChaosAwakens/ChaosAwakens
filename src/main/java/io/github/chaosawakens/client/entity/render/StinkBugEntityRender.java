...
public class StinkBugEntityRender extends GeoEntityRenderer<StinkBugEntity> {
	...
	@Override
	public void renderEarly(StinkBugEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(StinkBugEntity animatable, float partialTicks, MatrixStack stack,
