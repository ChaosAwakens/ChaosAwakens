...
public class CrystalCarrotPigSaddleLayer extends GeoLayerRenderer<CrystalCarrotPigEntity> {
	...
	public CrystalCarrotPigSaddleLayer(IGeoRenderer<CrystalCarrotPigEntity> entityRendererIn) {
		super(entityRendererIn);
	}

	@Override
	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, CrystalCarrotPigEntity entityLivingBaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
