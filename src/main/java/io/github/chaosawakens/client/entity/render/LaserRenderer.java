...
import io.github.chaosawakens.entity.projectile.CAProjectileEntity;
...
@OnlyIn(Dist.CLIENT)
public abstract class LaserRenderer<R extends CAProjectileEntity> extends EntityRenderer {
