...
import io.github.chaosawakens.client.entity.model.WoodFishModel;
...
public class WoodFishRender extends GeoEntityRenderer<WoodFishEntity> {
	...
	@Override
	public void renderEarly(WoodFishEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(WoodFishEntity animatable, float partialTicks, MatrixStack stack,
