...
public class EnchantedGoldenAppleCowModel<T extends Entity> extends CAQuadrupedModel<T> {
	public EnchantedGoldenAppleCowModel() {
		...
		this.modelGlint.setRotationPoint(0.0F, 4.0F, -8.0F);
		this.modelGlint.setTextureOffset(22, 0).addBox(-5.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, 0.0F);
		this.modelGlint.setTextureOffset(22, 0).addBox(4.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, 0.0F);
