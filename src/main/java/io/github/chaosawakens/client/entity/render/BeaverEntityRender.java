...
public class BeaverEntityRender extends GeoEntityRenderer<BeaverEntity> {
	...
	@Override
	public void renderEarly(BeaverEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(BeaverEntity animatable, float partialTicks, MatrixStack stack,
