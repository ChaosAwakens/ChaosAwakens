...
public class SparkFishEntityRender extends GeoEntityRenderer<SparkFishEntity> {
	...
	@Override
	public void renderEarly(SparkFishEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(SparkFishEntity animatable, float partialTicks, MatrixStack stack,
