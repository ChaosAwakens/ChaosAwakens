...
public class CrystalGatorRender extends GeoEntityRenderer<CrystalGatorEntity> {
	...
	@Override
	public void renderEarly(CrystalGatorEntity animatable, MatrixStack stackIn, float ticks,
	...
	@Override
	public RenderType getRenderType(CrystalGatorEntity animatable, float partialTicks, MatrixStack stack,
