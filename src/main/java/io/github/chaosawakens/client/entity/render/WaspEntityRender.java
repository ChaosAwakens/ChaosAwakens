...
public class WaspEntityRender extends GeoEntityRenderer<WaspEntity> {
	...
	@Override
	public void renderEarly(WaspEntity animatable, MatrixStack stackIn, float ticks, IRenderTypeBuffer renderTypeBuffer,
	...
	@Override
	public RenderType getRenderType(WaspEntity animatable, float partialTicks, MatrixStack stack,
