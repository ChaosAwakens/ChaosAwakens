...
import io.github.chaosawakens.blocks.ModBlocks;
...
public class Initializer implements ModInitializer {
    private static final ConfiguredFeature<?, ?> ORE_RUBY_LAVA = registerCustom(ModBlocks.RUBY_ORE.getDefaultState(), new BlockMatchRuleTest(Blocks.LAVA), 8, 24, 24, 28);
    private static final ConfiguredFeature<?, ?> ORE_RUBY_NO_SURFACE = registerNoSurface(ModBlocks.RUBY_ORE.getDefaultState(), 2, 12, 12, 1);
    private static final ConfiguredFeature<?, ?> ORE_AMETHYST = register(ModBlocks.AMETHYST_ORE.getDefaultState(), 4, 24, 28, 4);
    private static final ConfiguredFeature<?, ?> ORE_URANIUM = register(ModBlocks.URANIUM_ORE.getDefaultState(), 3, 12, 12, 2);
    private static final ConfiguredFeature<?, ?> ORE_TITANIUM = register(ModBlocks.TITANIUM_ORE.getDefaultState(), 3, 12, 12, 2);
    private static final ConfiguredFeature<?, ?> ORE_TIGERS_EYE = register(ModBlocks.TIGERS_EYE_ORE.getDefaultState(), 7, 24, 24, 5);
    private static final ConfiguredFeature<?, ?> ORE_ALUMINIUM = register(ModBlocks.ALUMINIUM_ORE.getDefaultState(), 5, 28, 24, 8);
    private static final ConfiguredFeature<?, ?> ORE_SALT = register(ModBlocks.SALT_ORE.getDefaultState(), 10, 64, 64, 28);
    private static final ConfiguredFeature<?, ?> FOSSILISED_ENT = register(ModBlocks.FOSSILISED_ENT.getDefaultState(), 3, 64, 64, 14);
    private static final ConfiguredFeature<?, ?> FOSSILISED_HERCULES_BEETLE = register(ModBlocks.FOSSILISED_HERCULES_BEETLE.getDefaultState(), 3, 64, 64, 14);
    private static final ConfiguredFeature<?, ?> FOSSILISED_RUBY_BUG = register(ModBlocks.FOSSILISED_RUBY_BUG.getDefaultState(), 3, 64, 64, 14);
    private static final ConfiguredFeature<?, ?> FOSSILISED_EMERALD_GATOR = register(ModBlocks.FOSSILISED_EMERALD_GATOR.getDefaultState(), 3, 64, 64, 14);
    private static final ConfiguredFeature<?, ?> RED_ANT_INFESTED_ORE = register(ModBlocks.RED_ANT_INFESTED_ORE.getDefaultState(), 10, 16, 16, 6);
    private static final ConfiguredFeature<?, ?> TERMITE_INFESTED_ORE = register(ModBlocks.TERMITE_INFESTED_ORE.getDefaultState(), 10, 16, 16, 2);
