...
public class UnstableAntEntity extends CreatureEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public UnstableAntEntity(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
