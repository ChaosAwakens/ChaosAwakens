...
public class CrystalCarrotPigEntity extends AnimatableRideableAnimalEntity {
	...
	private final WrappedAnimationController<CrystalCarrotPigEntity> mainController = new WrappedAnimationController<>(this, createMainMappedController("crystalcarrotpigmaincontroller"));
	...
	@Override
	public ObjectArrayList<AnimationController<CrystalCarrotPigEntity>> getControllers() {
		return new ObjectArrayList<AnimationController<CrystalCarrotPigEntity>>(1);
	}
}
