...
public class AnimatableMultiAttackGoal extends AnimatableGoal {
	 ...
	 * bit more of a ranged attack (if the range between the target and the entity
	 * is greater than the melee range of the entity AND the target is far away
	 * while the creature cannot move), and attack 3 being just a quick attack.
	 * 
	...
	// Taken from the AnimatableGoal class because I was too lazy to call for it
	// from the class
