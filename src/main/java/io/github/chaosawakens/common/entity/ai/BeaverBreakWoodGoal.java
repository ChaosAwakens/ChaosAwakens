...
public class BeaverBreakWoodGoal extends MoveToBlockGoal {
    private final Block block;
    private final MobEntity entity;
    private int breakingTime;

    public BeaverBreakWoodGoal(Block blockIn, CreatureEntity creature, double speed, int yMax) {
    ...
    protected boolean shouldMoveTo(IWorldReader worldIn, BlockPos pos) {
        ...
        if (ichunk == null) {
            ...
            return ichunk.getBlockState(pos).matchesBlock(this.block) && ichunk.getBlockState(pos.north()).isAir() && ichunk.getBlockState(pos.north().up()).isAir() ||
                    ichunk.getBlockState(pos.down()).isAir() || ichunk.getBlockState(pos.down(2)).isAir() || ichunk.getBlockState(pos.down(3)).isAir() ||
                    ichunk.getBlockState(pos.down(4)).isAir() || ichunk.getBlockState(pos.down(5)).isAir() || ichunk.getBlockState(pos.down(6)).isAir() ||
                    ichunk.getBlockState(pos.down(7)).isAir() || ichunk.getBlockState(pos.down(8)).isAir();
        }
    }
}