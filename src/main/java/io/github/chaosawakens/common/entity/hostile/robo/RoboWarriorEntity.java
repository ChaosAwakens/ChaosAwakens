...
public class RoboWarriorEntity extends AnimatableMonsterEntity {
	...
	private final SingletonAnimationBuilder burstLaserAttackAnim = new SingletonAnimationBuilder(this, "Laser Burst Attack", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(attackController).setAnimSpeed(0.85D);
	private final SingletonAnimationBuilder chargedLaserAttackAnim = new SingletonAnimationBuilder(this, "Charged Shot Attack", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(attackController);
	private final SingletonAnimationBuilder shieldUpAnim = new SingletonAnimationBuilder(this, "Shield Activation", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(shieldController);
	private final SingletonAnimationBuilder shieldedAnim = new SingletonAnimationBuilder(this, "Shield Active", EDefaultLoopTypes.LOOP).setWrappedController(shieldController);
	private final SingletonAnimationBuilder shieldDownAnim = new SingletonAnimationBuilder(this, "Shield Deactivation", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(shieldController);
	private final SingletonAnimationBuilder shieldDestroyedAnim = new SingletonAnimationBuilder(this, "Shield Destroyed", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(shieldController);
