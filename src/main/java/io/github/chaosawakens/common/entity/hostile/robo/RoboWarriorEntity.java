...
public class RoboWarriorEntity extends AnimatableMonsterEntity {
	...
	private final SingletonAnimationBuilder walkAnim = new SingletonAnimationBuilder(this, "movement.walk", EDefaultLoopTypes.LOOP).setWrappedController(walkController);
	private final SingletonAnimationBuilder deathAnim = new SingletonAnimationBuilder(this, "misc.death", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(shieldController);
	private final SingletonAnimationBuilder idleExtrasAnim = new SingletonAnimationBuilder(this, "misc.always_play", EDefaultLoopTypes.LOOP).setWrappedController(ambienceController);
	private final SingletonAnimationBuilder leftUppercutAnim = new SingletonAnimationBuilder(this, "attack.left_punch", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(attackController);
	private final SingletonAnimationBuilder rightUppercutAnim = new SingletonAnimationBuilder(this, "attack.right_punch", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(attackController);
	private final SingletonAnimationBuilder burstLaserAttackAnim = new SingletonAnimationBuilder(this, "attack.shoot_laser", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(attackController).setAnimSpeed(0.85D);
	private final SingletonAnimationBuilder chargedLaserAttackAnim = new SingletonAnimationBuilder(this, "attack.shoot_charged_laser", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(attackController);
	private final SingletonAnimationBuilder shieldUpAnim = new SingletonAnimationBuilder(this, "misc.activate_shield", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(shieldController);
	private final SingletonAnimationBuilder shieldedAnim = new SingletonAnimationBuilder(this, "misc.shield_activated", EDefaultLoopTypes.LOOP).setWrappedController(shieldController);
	private final SingletonAnimationBuilder shieldDownAnim = new SingletonAnimationBuilder(this, "misc.deactivate_shield", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(shieldController);
	private final SingletonAnimationBuilder shieldDestroyedAnim = new SingletonAnimationBuilder(this, "misc.break_shield", EDefaultLoopTypes.PLAY_ONCE).setWrappedController(shieldController);
