...
public class UltimateFishingBobberEntity extends FishingBobberEntity {
            ...
            if (this.timeUntilHooked > 0) {
                ...
                if (serverworld.getBlockState(new BlockPos((int)d0, (int)d1 - 1, (int)d2)).getMaterial() == net.minecraft.block.material.Material.WATER) {
                    if (this.random.nextFloat() < 0.15F) {
                        serverworld.sendParticles(this.fluid.is(FluidTags.WATER) ? ParticleTypes.BUBBLE : ParticleTypes.LAVA, d0, d1 - (double)0.1F, d2, 1, (double)f1, 0.1D, (double)f2, 0.0D);
                    }
                ...
                serverworld.sendParticles(this.fluid.is(FluidTags.WATER) ? ParticleTypes.BUBBLE : ParticleTypes.LAVA, this.getX(), d3, this.getZ(), (int)(1.0F + this.getBbWidth() * 20.0F), (double)this.getBbWidth(), 0.0D, (double)this.getBbWidth(), (double)0.2F);
    ...
    private UltimateFishingBobberEntity.WaterType getOpenWaterTypeForBlock(BlockPos p_234604_1_) {
        ...
        if (!blockstate.isAir() && !blockstate.is(Blocks.LILY_PAD)) {
            ...
            return (fluidstate.is(FluidTags.WATER) || fluidstate.is(FluidTags.LAVA)) && fluidstate.isSource() && blockstate.getCollisionShape(this.level, p_234604_1_).isEmpty() ? UltimateFishingBobberEntity.WaterType.INSIDE_WATER : UltimateFishingBobberEntity.WaterType.INVALID;
        } else {
