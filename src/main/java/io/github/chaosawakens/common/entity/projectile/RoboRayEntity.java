...
public class RoboRayEntity extends DamagingProjectileEntity implements IAnimatableEntity {
    ...
    public RoboRayEntity(double pX, double pY, double pZ, double pOffsetX, double pOffsetY, double pOffsetZ, World pLevel) {
        super(CAEntityTypes.ROBO_RAY.get(), pX, pY, pZ, pOffsetX, pOffsetY, pOffsetZ, pLevel); // Client-only (apparently)
    }

    public RoboRayEntity(LivingEntity pShooter, double pOffsetX, double pOffsetY, double pOffsetZ, World pLevel) {
    ...
    protected void handleBaseAnimations() {
        ...
        if (!level.isClientSide) {
            ...
            } else if (!hasHit()) playAnimation(getIdleAnim(), false);
        }
    }
}
