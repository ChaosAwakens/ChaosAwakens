...
public class EnchantedGoldenCarrotPigEntity extends AnimatableRideableAnimalEntity {
	...
	private final ObjectArrayList<IAnimationBuilder> enchantedGoldenCarrotPigAnimations = new ObjectArrayList<IAnimationBuilder>(3);
	private static final DataParameter<Boolean> PANICKING = EntityDataManager.defineId(EnchantedGoldenCarrotPigEntity.class, DataSerializers.BOOLEAN);
