...
public class EnchantmentKiller extends Enchantment {
	...
	@Override
	public void doPostHurt(LivingEntity livingentity, Entity entity, int duration) {
		 if (entity instanceof PlayerEntity) {
		    	PlayerEntity playerentity = (PlayerEntity)entity;
		    	if (this.type == 5) {
		     	 int d = 20 + playerentity.getRandom().nextInt(60 * duration);
		    		...
		    		playerentity.addEffect(new EffectInstance(Effects.INVISIBILITY, d, 1));
		    	}
		    }
		}
