...
public final class NameUtil {
	...
	/**
	 * Checks if a certain {@link ResourceLocation} is from a specified mod
	 * @param loc ResourceLocation to check
	 * @param modid Modid of the target mod
	 * @return True if the specified ResourceLocation is from the specified modid, else returns False
	 */
	public static boolean isFromMod(ResourceLocation loc, String modid) {
