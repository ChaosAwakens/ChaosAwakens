...
public class FancyableTree extends Tree {
	...
	public FancyableTree(Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> tree, Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> treeBee,
		Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> fancyTree, Supplier<ConfiguredFeature<BaseTreeFeatureConfig, ?>> fancyTreeBee) {
		this.tree = tree;
