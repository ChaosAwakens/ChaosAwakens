...
public class IronDefossilizerScreen extends ContainerScreen<IronDefossilizerContainer> {
	public static final ResourceLocation TEXTURE = ChaosAwakens.prefix("textures/gui/container/defossilizer.png");

	public IronDefossilizerScreen(IronDefossilizerContainer container, PlayerInventory playerInventory, ITextComponent title) {
