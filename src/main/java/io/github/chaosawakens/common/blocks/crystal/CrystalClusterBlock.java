...
public class CrystalClusterBlock extends DirectionalBlock {
	...
	public boolean canSurvive(BlockState state, IWorldReader worldIn, BlockPos pos) {
		...
		BlockPos sourceBlock = pos.relative(direction.getOpposite());
		BlockState sourceState = worldIn.getBlockState(sourceBlock);
		return sourceState.isFaceSturdy(worldIn, sourceBlock, direction);
	}
}
