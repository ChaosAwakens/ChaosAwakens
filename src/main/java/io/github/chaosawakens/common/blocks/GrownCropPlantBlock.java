...
public class GrownCropPlantBlock extends BushBlock implements IGrowable {
	...
	public GrownCropPlantBlock(Supplier<? extends Item> seedItem, Properties properties) {
		super(properties);
	...
	public GrownCropPlantBlock withMaxAge(int maxAge) {
		this.maxAge = maxAge;
		return this;
	}
