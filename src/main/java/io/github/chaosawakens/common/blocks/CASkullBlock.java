...
public class CASkullBlock extends CAAbstractSkullBlock {
    public static final IntegerProperty ROTATION = BlockStateProperties.ROTATION_0_15;
    protected static final VoxelShape SHAPE = Block.makeCuboidShape(4.0D, 0.0D, 4.0D, 12.0D, 8.0D, 12.0D);

    public CASkullBlock(CASkullBlock.ISkullType type, AbstractBlock.Properties properties) {
    ...
    public enum Types implements CASkullBlock.ISkullType {
        HUSK
    }
}