...
public class CropTopPlantBlock extends AbstractTopPlantBlock implements IGrowable {
	...
	protected final Supplier<? extends CropBodyPlantBlock> bodyBlock;
	protected ItemStack cloneItemStack;
	
	public CropTopPlantBlock(Direction direction, VoxelShape shape, double growPerTickProbability, Supplier<? extends CropBodyPlantBlock> bodyBlock, Properties properties) {
	...
	public CropTopPlantBlock maxHeight(int maxHeight) {
		this.maxHeight = maxHeight;
		
		return this;
	}
	
	public CropTopPlantBlock dropItem(Item cloneItemStack) {
