...
public class CAVillagerInit{
    ...
    public static class MultiItemsForEmeraldsTrade implements VillagerTrades.ITrade{
    	...
    	//MultiItemsForEmeraldsTrade. Specify the items in brackets of course. First 3 integers are the item amounts in respective order. Second 3 integers are emerald amounts each in respective order. after that it's the max uses, then the exp gained for the villager and you (in points).
    }
}
