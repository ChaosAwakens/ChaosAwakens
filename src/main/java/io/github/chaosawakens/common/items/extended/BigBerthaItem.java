...
public class BigBerthaItem extends SwordItem implements IAutoEnchantable, IVanishable, IAnimatable, IUtilityHelper {
    ...
    public BigBerthaItem(EnumUtils.CAItemTier tierIn, int attackDamageIn, float attackSpeedIn, double attackReachIn, double attackKnockbackIn, Properties builderIn, EnchantmentData[] enchantments) {
