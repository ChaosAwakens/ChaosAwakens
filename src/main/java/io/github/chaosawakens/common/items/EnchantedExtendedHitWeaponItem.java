...
public class EnchantedExtendedHitWeaponItem extends ExtendedHitWeaponItem
		implements IAutoEnchantable, IVanishable, IAnimatable {
	public AnimationFactory factory = new AnimationFactory(this);
	private final EnchantmentData[] enchantments;

	public EnchantedExtendedHitWeaponItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, double reachDistance,
			double knockBack, Properties builderIn, EnchantmentData[] enchantments) {
