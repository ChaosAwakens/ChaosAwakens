...
public class AttitudeAdjusterItem extends SwordItem implements IVanishable, IAnimatable {
	...
	public AttitudeAdjusterItem(CAItemTier tierIn, int attackDamageIn, float attackSpeedIn, double attackReachIn, double attackKnockbackIn, Properties builderIn) {
