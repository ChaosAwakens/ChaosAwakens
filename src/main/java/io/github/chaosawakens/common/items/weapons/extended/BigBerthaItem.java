...
public class BigBerthaItem extends EnchantedSwordItem implements IVanishable, IAnimatable {
    ...
    public BigBerthaItem(EnumUtil.CAItemTier tierIn, int attackDamageIn, float attackSpeedIn, double attackReachIn, double attackKnockbackIn, Properties builderIn, Supplier<EnchantmentData[]> enchantments) {
