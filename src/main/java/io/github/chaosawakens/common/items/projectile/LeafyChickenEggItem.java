...
public class LeafyChickenEggItem extends EggItem {

	public LeafyChickenEggItem(Properties properties) {
		super(properties);
	}
	...
	public ActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {		
		...
		if (!world.isClientSide) {		     
			CALeafyChickenEggEntity egg = new CALeafyChickenEggEntity(world, player);		       
