...
public class ExtendedHitAxeItem extends AxeItem implements IVanishable, IAnimatable, IUtilityHelper {
	...
	public static final UUID ATTACK_REACH_MODIFIER = UUID.fromString("ABFC1AB1-BB22-42B2-9BCF-20DD90946940");
	...
	public ExtendedHitAxeItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, double reachDistance,
	...
	// getAttributeModifiers(EquipmentSlotType slot, ItemStack stack) {
	// return slot == EquipmentSlotType.MAINHAND ? LAZY.get() :
