...
public class BattleAxeItem extends EnchantedAxeItem implements IVanishable, IAnimatable {
	...
	public BattleAxeItem(EnumUtil.CAItemTier tierIn, int attackDamageIn, float attackSpeedIn, double attackReachIn, double attackKnockbackIn, Properties builderIn, Supplier<EnchantmentData[]> enchantments) {
