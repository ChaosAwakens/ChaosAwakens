...
public class QueenScaleBattleAxeItem extends EnchantedAxeItem implements IVanishable, IAnimatable {
    ...
    public QueenScaleBattleAxeItem(EnumUtil.CAItemTier tierIn, int attackDamageIn, float attackSpeedIn, double attackReachIn, double attackKnockbackIn, Properties builderIn, Supplier<EnchantmentData[]> enchantments) {
