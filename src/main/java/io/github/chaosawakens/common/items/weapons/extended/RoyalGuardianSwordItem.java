...
public class RoyalGuardianSwordItem extends EnchantedSwordItem implements IVanishable, IAnimatable {
	...
	public RoyalGuardianSwordItem(EnumUtil.CAItemTier tierIn, int attackDamageIn, float attackSpeedIn, double attackReachIn, double attackKnockbackIn, Properties builderIn, Supplier<EnchantmentData[]> enchantments) {
		super(tierIn, attackDamageIn, attackSpeedIn, builderIn, enchantments);
