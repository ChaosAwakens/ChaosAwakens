...
public class EnchantedScytheItem extends ScytheItem implements IAutoEnchantable, IUtilityHelper {
	...
	public EnchantedScytheItem(EnumUtils.CAItemTier tierIn, int attackDamageIn, float attackSpeedIn, double attackReachIn, double attackKnockbackIn, Properties builderIn, EnchantmentData[] enchantments) {
