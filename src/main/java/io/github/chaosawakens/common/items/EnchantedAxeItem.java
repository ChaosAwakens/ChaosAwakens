...
//				.put(CABlocks.APPLE_WOOD.get(), CABlocks.STRIPPED_APPLE_WOOD.get())
//				.put(CABlocks.CHERRY_LOG.get(), CABlocks.STRIPPED_CHERRY_LOG.get())
//				.put(CABlocks.CHERRY_WOOD.get(), CABlocks.STRIPPED_CHERRY_WOOD.get())
//				.put(CABlocks.PEACH_LOG.get(), CABlocks.STRIPPED_PEACH_LOG.get())
//				.put(CABlocks.PEACH_WOOD.get(), CABlocks.STRIPPED_PEACH_WOOD.get())
//				.put(CABlocks.DUPLICATION_LOG.get(), CABlocks.STRIPPED_DUPLICATION_LOG.get())
//				.put(CABlocks.DUPLICATION_WOOD.get(), CABlocks.STRIPPED_DUPLICATION_WOOD.get())
//				.put(CABlocks.SKYWOOD_LOG.get(), CABlocks.STRIPPED_SKYWOOD_LOG.get())
//				.put(CABlocks.SKYWOOD_WOOD.get(), CABlocks.STRIPPED_SKYWOOD_WOOD.get()).build();
//
