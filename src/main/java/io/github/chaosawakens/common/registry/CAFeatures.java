...
public class CAFeatures {
	...
	public static final ConfiguredFeature<?, ?> MINING_ORE_TIGERS_EYE = register("mining_ore_tigers_eye", Feature.ORE.withConfiguration(new OreFeatureConfig(RuleTests.BASE_STONE_MINING, States.TIGERS_EYE_ORE, 7)).withPlacement(Placement.DEPTH_AVERAGE.configure(new DepthAverageConfig(36, 24))).square().count(5));
	public static final ConfiguredFeature<?, ?> MINING_ORE_SUNSTONE = register("mining_ore_sunstone", Feature.ORE.withConfiguration(new OreFeatureConfig(RuleTests.BASE_STONE_MINING, States.SUNSTONE_ORE, 4)).withPlacement(Placement.DEPTH_AVERAGE.configure(new DepthAverageConfig(28, 8))).square().count(8));
