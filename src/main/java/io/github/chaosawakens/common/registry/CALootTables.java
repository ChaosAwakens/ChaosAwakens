...
public class CALootTables {
	public static final ResourceLocation BIRD = new ResourceLocation(ChaosAwakens.MODID, "entities/bird");
	public static final ResourceLocation BIRD_RUBY = new ResourceLocation(ChaosAwakens.MODID, "entities/bird_ruby");

	public static final ResourceLocation TREE_FROG_OVERWORLD = new ResourceLocation(ChaosAwakens.MODID, "entities/tree_frog_overworld");
	public static final ResourceLocation TREE_FROG_NETHER = new ResourceLocation(ChaosAwakens.MODID, "entities/tree_frog_nether");
