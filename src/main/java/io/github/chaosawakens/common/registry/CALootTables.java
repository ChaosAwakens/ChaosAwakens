...
public class CALootTables {
    ...
    public static final ResourceLocation GAMEPLAY_HERO_OF_THE_VILLAGE_DIMENSIONAL_TRADER_GIFT = new ResourceLocation(ChaosAwakens.MODID, "gameplay/hero_of_the_village/dimensional_trader_gift");
}