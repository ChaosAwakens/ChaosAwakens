...
import io.github.chaosawakens.common.items.extended.*;
...
public class CAItems {
	...
	public static final RegistryObject<HoeItem> RUBY_HOE = ITEMS.register("ruby_hoe", () -> new HoeItem(EnumUtils.CAItemTier.TOOL_RUBY, CACommonConfig.COMMON.rubyHoeDamage.get() - 17, 0.0F, new Item.Properties().tab(CAItemGroups.EQUIPMENT)));
	...
	public static final RegistryObject<EnchantedScytheItem> PRISMATIC_REAPER = ITEMS.register("prismatic_reaper", () -> new EnchantedScytheItem(EnumUtils.CAItemTier.TOOL_ULTIMATE, CACommonConfig.COMMON.prismaticReaperDamage.get() - 37, -1.9F, 6.0D, 0, new Item.Properties().tab(CAItemGroups.EQUIPMENT),
	...
	public static final RegistryObject<BigBerthaItem> BIG_BERTHA = ITEMS.register("big_bertha", () -> new BigBerthaItem(EnumUtils.CAItemTier.WEAPON_BERTHA, CACommonConfig.COMMON.berthaDamage.get() - 497, -3.2F, 10.0D, 0, new Item.Properties().rarity(Rarity.EPIC).tab(CAItemGroups.EQUIPMENT).setISTER(() -> BigBerthaItemRender::new),
	...
	public static final RegistryObject<BattleAxeItem> BATTLE_AXE = ITEMS.register("battle_axe", () -> new BattleAxeItem(EnumUtils.CAItemTier.WEAPON_BATTLEAXE, CACommonConfig.COMMON.battleAxeDamage.get() - 48, -3.35F, 7.5D, 0, new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT).setISTER(() -> BattleAxeItemRender::new),
			new EnchantmentData[]{new EnchantmentData(Enchantments.MOB_LOOTING, 3), new EnchantmentData(Enchantments.UNBREAKING, 3)}));
	public static final RegistryObject<QueenScaleBattleAxeItem> QUEEN_SCALE_BATTLE_AXE = ITEMS.register("queen_scale_battle_axe", () -> new QueenScaleBattleAxeItem(EnumUtils.CAItemTier.WEAPON_QUEEN_BATTLEAXE, CACommonConfig.COMMON.queenBattleAxeDamage.get() - 664, -3.25F, 8.5D, 0, new Item.Properties().rarity(RARITY_ROYALTY).tab(CAItemGroups.EQUIPMENT).setISTER(() -> QueenScaleBattleAxeItemRender::new),
	...
	public static final RegistryObject<RoyalGuardianSwordItem> ROYAL_GUARDIAN_SWORD = ITEMS.register("royal_guardian_sword", () -> new RoyalGuardianSwordItem(EnumUtils.CAItemTier.WEAPON_ROYAL_GUARDIAN_SWORD, CACommonConfig.COMMON.royalGuardianSwordDamage.get() - 749, -3.25F, 10.5D, 0, new Item.Properties().rarity(RARITY_ROYALTY).tab(CAItemGroups.EQUIPMENT).setISTER(() -> RoyalGuardianSwordItemRender::new),
			new EnchantmentData[]{new EnchantmentData(Enchantments.UNBREAKING, 3)}));
	public static final RegistryObject<SlayerChainsawItem> SLAYER_CHAINSAW = ITEMS.register("slayer_chainsaw", () -> new SlayerChainsawItem(EnumUtils.CAItemTier.WEAPON_SLAYER_CHAINSAW, CACommonConfig.COMMON.slayerChainsawDamage.get() - 1, -3F, 6.5D, 0, new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT).setISTER(() -> SlayerChainsawItemRender::new)));
