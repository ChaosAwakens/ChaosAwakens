...
public class CAItems {
	...
	// TOOLS
	// Ultimate
	public static final RegistryObject<SwordItem> ULTIMATE_SWORD = ITEMS.register("ultimate_sword", () -> new EnchantedSwordItem(ToolMaterials.TOOL_ULTIMATE, CAConfig.COMMON.ultimateSwordDamage.get() - 37, -2.4F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.SHARPNESS, Enchantments.SMITE, Enchantments.BANE_OF_ARTHROPODS, Enchantments.KNOCKBACK, Enchantments.LOOTING, Enchantments.UNBREAKING, Enchantments.FIRE_ASPECT }, new int[] { 5, 5, 5, 3, 3, 2, 2 }));
	public static final RegistryObject<AxeItem> ULTIMATE_AXE = ITEMS.register("ultimate_axe", () -> new EnchantedAxeItem(ToolMaterials.TOOL_ULTIMATE, CAConfig.COMMON.ultimateAxeDamage.get() - 37, -3, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.EFFICIENCY, Enchantments.FORTUNE, Enchantments.UNBREAKING }, new int[] { 5, 5, 2 }));
	public static final RegistryObject<PickaxeItem> ULTIMATE_PICKAXE = ITEMS.register("ultimate_pickaxe", () -> new EnchantedPickaxeItem(ToolMaterials.TOOL_ULTIMATE, CAConfig.COMMON.ultimatePickaxeDamage.get() - 37, -2.8F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.EFFICIENCY, Enchantments.FORTUNE, Enchantments.UNBREAKING }, new int[] { 5, 5, 2 }));
	...
	public static final RegistryObject<UltimateHoeItem> ULTIMATE_HOE = ITEMS.register("ultimate_hoe", () -> new UltimateHoeItem(ToolMaterials.TOOL_ULTIMATE, CAConfig.COMMON.ultimateHoeDamage.get() - 37, 0.0F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.EFFICIENCY, Enchantments.FORTUNE, Enchantments.UNBREAKING }, new int[] { 5, 5, 2 }));
	...
	public static final RegistryObject<PickaxeItem> EMERALD_PICKAXE = ITEMS.register("emerald_pickaxe", () -> new EnchantedPickaxeItem(ToolMaterials.TOOL_EMERALD, CAConfig.COMMON.emeraldPickaxeDamage.get() - 7, -2.8F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.SILK_TOUCH }, new int[] { 1 }));
	...
	// Misc. Weapons
	public static final RegistryObject<SwordItem> NIGHTMARE_SWORD = ITEMS.register("nightmare_sword", () -> new EnchantedSwordItem(ToolMaterials.TOOL_NIGHTMARE, CAConfig.COMMON.nightmareSwordDamage.get() - 27, -2.4F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.SHARPNESS, Enchantments.KNOCKBACK, Enchantments.FIRE_ASPECT }, new int[] { 1, 3, 1 }));
	public static final RegistryObject<SwordItem> EXPERIENCE_SWORD = ITEMS.register("experience_sword", () -> new EnchantedSwordItem(ToolMaterials.TOOL_EMERALD, CAConfig.COMMON.experienceSwordDamage.get() - 7, -2.4F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.SHARPNESS, Enchantments.UNBREAKING, Enchantments.MENDING }, new int[] { 2, 3, 1 }));
	public static final RegistryObject<SwordItem> POISON_SWORD = ITEMS.register("poison_sword", () -> new PoisonSwordItem(ToolMaterials.TOOL_EMERALD, CAConfig.COMMON.poisonSwordDamage.get() - 7, -2.4F, new Item.Properties().group(CAItemGroups.equipmentItemGroup),new Enchantment[] {Enchantments.SHARPNESS}, new int[] {1}));
