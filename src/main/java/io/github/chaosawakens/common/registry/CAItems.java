...
public class CAItems {
	...
	public static final RegistryObject<SpawnEggItem> IRON_GOLEM_SPAWN_EGG = ITEMS.register("iron_golem_spawn_egg", () -> new SpawnEggItem(EntityType.IRON_GOLEM, 0xffffff, 0x74a332, new Item.Properties().group(CAItemGroups.eggsItemGroup)));
	...
	public static final RegistryObject<SpawnEggItem> ILLUSIONER_SPAWN_EGG = ITEMS.register("illusioner_spawn_egg", () -> new SpawnEggItem(EntityType.ILLUSIONER, 0xffffff, 0x135893, new Item.Properties().group(CAItemGroups.eggsItemGroup)));
