...
public class CADimensions {
	...
	public static final RegistryKey<World> CRYSTALWORLD = RegistryKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(ChaosAwakens.MODID, "crystalworld"));
