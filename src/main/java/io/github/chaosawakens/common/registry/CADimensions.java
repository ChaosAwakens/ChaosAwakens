...
public class CADimensions {
	...
	public static final RegistryKey<World> CRYSTAL_DIMENSION = RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation(ChaosAwakens.MODID + ":crystal_dimension"));
