...
public class CABlocks {
	...
	public static final RegistryObject<Block> ROBO_LAMP = registerBlock("robo_lamp", () -> new Block(Properties.of(Material.BUILDABLE_GLASS).lightLevel((state) -> 10).strength(30.0F, 100.0F).sound(SoundType.GLASS)), CAItemGroups.BLOCKS);
