...
//	private static IPositionPredicate isTrue = (state, reader, pos) -> true; --Unused
	...
	// PLANTS
	public static final RegistryObject<TopTubeBlock> TUBE = BLOCKS.register("tube_worm",() -> new TopTubeBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.WHITE_TERRACOTTA).sound(SoundType.BONE).doesNotBlockMovement().zeroHardnessAndResistance()));
    	public static final RegistryObject<TubeBlock> TUBE_PLANT = BLOCKS.register("tube_worm_plant",() -> new TubeBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.WHITE_TERRACOTTA).sound(SoundType.BONE).doesNotBlockMovement().zeroHardnessAndResistance()));
