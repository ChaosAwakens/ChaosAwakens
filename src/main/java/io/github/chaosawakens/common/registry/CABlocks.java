...
public class CABlocks {
	...
	public static final RegistryObject<CAFallingOreBlock> FOSSILISED_ENDERMAN = registerBlock("fossilised_enderman", () -> new CAFallingOreBlock(Block.Properties.copy(Blocks.IRON_ORE).harvestLevel(1).requiresCorrectToolForDrops()), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<CAFallingOreBlock> FOSSILISED_EVOKER = registerBlock("fossilised_evoker", () -> new CAFallingOreBlock(Block.Properties.copy(Blocks.IRON_ORE).harvestLevel(1).requiresCorrectToolForDrops()), CAItemGroups.blocksItemGroup);
