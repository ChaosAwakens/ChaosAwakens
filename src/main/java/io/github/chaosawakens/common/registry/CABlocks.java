...
//	public static final RegistryObject<Block> CORN_PLANT = registerBlock("corn_plant", () -> new CropsBlock(Block.Properties.from(Blocks.SUGAR_CANE)), CAItemGroups.foodItemGroup);
	...
	public static final RegistryObject<CrystalClusterBlock> PINK_TOURMALINE_CLUSTER = registerBlock("pink_tourmaline_cluster", () -> new CrystalClusterBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(1).setRequiresTool().notSolid().setSuffocates(CABlocks::_false).setBlocksVision(CABlocks::_false).setOpaque(CABlocks::_false).harvestLevel(1)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<CrystalClusterBlock> CATS_EYE_CLUSTER = registerBlock("cats_eye_cluster", () -> new CrystalClusterBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(2).setRequiresTool().notSolid().setSuffocates(CABlocks::_false).setBlocksVision(CABlocks::_false).setOpaque(CABlocks::_false).harvestLevel(2)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<Block> CRYSTAL_ENERGY = registerBlock("crystal_energy", () -> new CrystalEnergyBlock(Block.Properties.from(Blocks.GLASS).setRequiresTool().notSolid().setSuffocates(CABlocks::_false).setBlocksVision(CABlocks::_false).setOpaque(CABlocks::_false).harvestLevel(0).setLightLevel((state) -> 8)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<BuddingBlock> BUDDING_PINK_TOURMALINE = registerBlock("budding_pink_tourmaline", () -> new BuddingBlock(Block.Properties.from(Blocks.STONE).setRequiresTool().tickRandomly().setOpaque(CABlocks::_false), PINK_TOURMALINE_CLUSTER.get()), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<BuddingBlock> BUDDING_CATS_EYE = registerBlock("budding_cats_eye", () -> new BuddingBlock(Block.Properties.from(Blocks.STONE).setRequiresTool().tickRandomly().setOpaque(CABlocks::_false), CATS_EYE_CLUSTER.get()), CAItemGroups.blocksItemGroup);
	...
	public static final RegistryObject<FurnaceBlock> CRYSTAL_FURNACE = registerBlock("crystal_furnace", () -> new FurnaceBlock(Block.Properties.from(Blocks.FURNACE).setRequiresTool().setOpaque(CABlocks::_false).notSolid().setLightLevel(getLightValueLit(13))), CAItemGroups.blocksItemGroup);
