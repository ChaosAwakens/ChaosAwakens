...
public class CABlocks {
	...
	public static final RegistryObject<AggressiveAntNestBlock> CRYSTAL_TERMITE_NEST = registerBlock("crystal_termite_nest", () -> new AggressiveAntNestBlock(() -> CAEntityTypes.TERMITE.get(), Properties.copy(CABlocks.CRYSTAL_GRASS_BLOCK.get()).harvestTool(ToolType.SHOVEL).randomTicks().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<RotatedPillarCrystalBlock> CRYSTALWOOD_LOG = registerBlock("crystalwood_log", () -> new RotatedPillarCrystalBlock(Properties.copy(Blocks.OAK_LOG).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarCrystalBlock> CRYSTALWOOD = registerBlock("crystalwood", () -> new RotatedPillarCrystalBlock(Properties.copy(Blocks.OAK_WOOD).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalBlock> CRYSTALWOOD_PLANKS = registerBlock("crystalwood_planks", () -> new CrystalBlock(Properties.copy(Blocks.OAK_PLANKS).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
