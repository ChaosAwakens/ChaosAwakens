...
public class CABlocks {
	...
	public static final RegistryObject<CrystalGrassBlock> CRYSTAL_GRASS_BLOCK = registerBlock("crystal_grass_block", () -> new CrystalGrassBlock(Properties.of(Material.GRASS).randomTicks().strength(0.6F).sound(SoundType.GRASS).harvestTool(ToolType.SHOVEL).requiresCorrectToolForDrops().isRedstoneConductor(NO_REDSTONE_CONDUCTIVITY).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<AggressiveAntNestBlock> CRYSTAL_TERMITE_NEST = registerBlock("crystal_termite_nest", () -> new AggressiveAntNestBlock(() -> CAEntityTypes.TERMITE.get(), Properties.copy(CABlocks.CRYSTAL_GRASS_BLOCK.get()).harvestTool(ToolType.SHOVEL).randomTicks().isRedstoneConductor(NO_REDSTONE_CONDUCTIVITY).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalBlock> KYANITE = registerBlock("kyanite", () -> new CrystalBlock(Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().isRedstoneConductor(NO_REDSTONE_CONDUCTIVITY).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<EnergizedKyaniteBlock> ENERGIZED_KYANITE = registerBlock("energized_kyanite", () -> new EnergizedKyaniteBlock(Properties.copy(KYANITE.get()).noOcclusion().harvestLevel(2).requiresCorrectToolForDrops().lightLevel((state) -> 5)), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<BuddingBlock> BUDDING_PINK_TOURMALINE = registerBlock("budding_pink_tourmaline", () -> new BuddingBlock(Properties.copy(Blocks.STONE).randomTicks().isRedstoneConductor(NO_REDSTONE_CONDUCTIVITY).noOcclusion(), PINK_TOURMALINE_CLUSTER.get()), CAItemGroups.BLOCKS);
	public static final RegistryObject<BuddingBlock> BUDDING_CATS_EYE = registerBlock("budding_cats_eye", () -> new BuddingBlock(Properties.copy(Blocks.STONE).randomTicks().isRedstoneConductor(NO_REDSTONE_CONDUCTIVITY).noOcclusion(), CATS_EYE_CLUSTER.get()), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<CrystalBlock> PINK_TOURMALINE_BLOCK = registerBlock("pink_tourmaline_block", () -> new CrystalBlock(Properties.copy(Blocks.IRON_BLOCK).harvestLevel(1).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().isRedstoneConductor(NO_REDSTONE_CONDUCTIVITY).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalBlock> CATS_EYE_BLOCK = registerBlock("cats_eye_block", () -> new CrystalBlock(Properties.copy(Blocks.DIAMOND_BLOCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().isRedstoneConductor(NO_REDSTONE_CONDUCTIVITY).noOcclusion()), CAItemGroups.BLOCKS);
