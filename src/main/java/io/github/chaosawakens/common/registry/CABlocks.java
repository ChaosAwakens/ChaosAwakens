...
public class CABlocks {
	...
	public static final RegistryObject<CrystalFlowerBlock> RED_CRYSTAL_FAN = registerBlock("red_crystal_fan", () -> new CrystalFlowerBlock(Effects.GLOWING, 9, AbstractBlock.Properties.copy(Blocks.RED_TULIP).noCollission().instabreak().noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalFlowerBlock> GREEN_CRYSTAL_FAN = registerBlock("green_crystal_fan", () -> new CrystalFlowerBlock(Effects.GLOWING, 6, AbstractBlock.Properties.copy(Blocks.RED_TULIP).noCollission().instabreak().noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalFlowerBlock> YELLOW_CRYSTAL_FAN = registerBlock("yellow_crystal_fan", () -> new CrystalFlowerBlock(Effects.GLOWING, 12, AbstractBlock.Properties.copy(Blocks.RED_TULIP).noCollission().instabreak().noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalFlowerBlock> BLUE_CRYSTAL_FAN = registerBlock("blue_crystal_fan", () -> new CrystalFlowerBlock(Effects.GLOWING, 15, AbstractBlock.Properties.copy(Blocks.RED_TULIP).noCollission().instabreak().noOcclusion()), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<CrystalGrassBlockActual> CRYSTAL_GRASS_BLOCK = registerBlock("crystal_grass_block", () -> new CrystalGrassBlockActual(Block.Properties.copy(Blocks.GRASS_BLOCK).requiresCorrectToolForDrops().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<CrystalGrassBlock> CRYSTAL_GRASS = registerBlock("crystal_grass", () -> new CrystalGrassBlock(AbstractBlock.Properties.of(Material.REPLACEABLE_PLANT).requiresCorrectToolForDrops().noCollission().instabreak().sound(SoundType.GRASS)), CAItemGroups.BLOCKS);
	public static final RegistryObject<DoublePlantBlock> TALL_CRYSTAL_GRASS = registerBlock("tall_crystal_grass", () -> new DoublePlantBlock(AbstractBlock.Properties.of(Material.REPLACEABLE_PLANT).requiresCorrectToolForDrops().noCollission().instabreak().sound(SoundType.GRASS)), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<FlowerPotBlock> POTTED_RED_CRYSTAL_FAN = registerBlock("potted_red_crystal_fan", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, RED_CRYSTAL_FAN, AbstractBlock.Properties.copy(Blocks.FLOWER_POT)), null, false);
	public static final RegistryObject<FlowerPotBlock> POTTED_BLUE_CRYSTAL_FAN = registerBlock("potted_blue_crystal_fan", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, BLUE_CRYSTAL_FAN, AbstractBlock.Properties.copy(Blocks.FLOWER_POT)), null, false);
	public static final RegistryObject<FlowerPotBlock> POTTED_GREEN_CRYSTAL_FAN = registerBlock("potted_green_crystal_fan", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, GREEN_CRYSTAL_FAN, AbstractBlock.Properties.copy(Blocks.FLOWER_POT)), null, false);
	public static final RegistryObject<FlowerPotBlock> POTTED_YELLOW_CRYSTAL_FAN = registerBlock("potted_yellow_crystal_fan", () -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, YELLOW_CRYSTAL_FAN, AbstractBlock.Properties.copy(Blocks.FLOWER_POT)), null, false);
