...
import io.github.chaosawakens.common.blocks.dense.*;
...
public class CABlocks {
	...
	private static final AbstractBlock.IExtendedPositionPredicate<EntityType<?>> NO_SPAWN = (targetState, world, targetPos, targetEntityType) -> false;
	...
	// ROBO BLOCKS
	public static final RegistryObject<Block> ROBO_BLOCK_I = registerBlock("robo_block_l", () -> new Block(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarBlock> ROBO_BLOCK_V = registerBlock("robo_block_v", () -> new RotatedPillarBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarBlock> ROBO_BLOCK_X = registerBlock("robo_block_x", () -> new RotatedPillarBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<SlabBlock> ROBO_SLAB_I = registerBlock("robo_slab_l", () -> new SlabBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<SlabBlock> ROBO_SLAB_X = registerBlock("robo_slab_x", () -> new SlabBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<StairsBlock> ROBO_STAIRS_I = registerBlock("robo_stairs_l", () -> new StairsBlock(Blocks.OBSIDIAN::defaultBlockState, Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<StairsBlock> ROBO_STAIRS_X = registerBlock("robo_stairs_x", () -> new StairsBlock(Blocks.OBSIDIAN::defaultBlockState, Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<WallBlock> ROBO_WALL_I = registerBlock("robo_wall_l", () -> new WallBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<WallBlock> ROBO_WALL_X = registerBlock("robo_wall_x", () -> new WallBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<GlassBlock> ROBO_GLASS = registerBlock("robo_glass", () -> new GlassBlock(Properties.of(CAMaterial.HEAVY_GLASS).isValidSpawn(NO_SPAWN).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.GLASS).noOcclusion().isValidSpawn(CABlocks::never).isRedstoneConductor(CABlocks::never).isSuffocating(CABlocks::never).isViewBlocking(CABlocks::never)), CAItemGroups.BLOCKS);
	public static final RegistryObject<PaneBlock> ROBO_GLASS_PANE = registerBlock("robo_glass_pane", () -> new PaneBlock(Properties.of(CAMaterial.HEAVY_GLASS).isValidSpawn(NO_SPAWN).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.GLASS).noOcclusion().isValidSpawn(CABlocks::never).isRedstoneConductor(CABlocks::never).isSuffocating(CABlocks::never).isViewBlocking(CABlocks::never)), CAItemGroups.BLOCKS);
	public static final RegistryObject<PaneBlock> ROBO_BARS = registerBlock("robo_bars", () -> new PaneBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(55.0F, 1800.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE).sound(SoundType.METAL).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<Block> ROBO_LAMP = registerBlock("robo_lamp", () -> new Block(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).requiresCorrectToolForDrops().lightLevel((state) -> 10).strength(30.0F, 100.0F).sound(SoundType.GLASS)), CAItemGroups.BLOCKS);
	public static final RegistryObject<Block> ROBO_BRICKS = registerBlock("robo_bricks", () -> new Block(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<SlabBlock> ROBO_BRICK_SLAB = registerBlock("robo_brick_slab", () -> new SlabBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<StairsBlock> ROBO_BRICK_STAIRS = registerBlock("robo_brick_stairs", () -> new StairsBlock(Blocks.OBSIDIAN::defaultBlockState, Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<WallBlock> ROBO_BRICK_WALL = registerBlock("robo_brick_wall", () -> new WallBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarBlock> COMPACT_ROBO_BLOCK = registerBlock("compact_robo_block", () -> new RotatedPillarBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarBlock> DOUBLE_COMPACT_ROBO_BLOCK = registerBlock("double_compact_robo_block", () -> new RotatedPillarBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<GateBlock> ROBO_GATE_BLOCK = registerBlock("robo_gate_block", () -> new GateBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	public static final RegistryObject<RoboCrateBlock> ROBO_CRATE = registerBlock("robo_crate", () -> new RoboCrateBlock(Properties.of(Material.HEAVY_METAL).isValidSpawn(NO_SPAWN).strength(55.0F, 1800.0F).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()), CAItemGroups.BLOCKS);
	...
	// WASP BLOCKS
	public static final RegistryObject<Block> WASP_NEST_BLOCK = registerBlock("wasp_nest_block", () -> new Block(Properties.copy(Blocks.BEE_NEST)), CAItemGroups.BLOCKS);
	public static final RegistryObject<Block> PATTERN_WASP_NEST_BLOCK = registerBlock("pattern_wasp_nest_block", () -> new Block(Properties.copy(Blocks.BEE_NEST)), CAItemGroups.BLOCKS);
