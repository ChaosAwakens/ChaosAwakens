...
//	private static IPositionPredicate isTrue = (state, reader, pos) -> true; --Unused
	...
	// PLANTS
	public static final RegistryObject<TopTubeBlock> TUBE = BLOCKS.register("tube_worm",() -> new TopTubeBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.WHITE_TERRACOTTA).sound(SoundType.BONE).doesNotBlockMovement().zeroHardnessAndResistance()), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<TubeBlock> TUBE_PLANT = BLOCKS.register("tube_worm_plant",() -> new TubeBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.WHITE_TERRACOTTA).sound(SoundType.BONE).doesNotBlockMovement().zeroHardnessAndResistance()), CAItemGroups.blocksItemGroup);
	...
	public static final RegistryObject<AntNestBlock> CRYSTAL_TERMITE_NEST = registerBlock("crystal_termite_nest", () -> new AntNestBlock(CAEntityTypes.TERMITE, Block.Properties.from(CABlocks.CRYSTAL_GRASS_BLOCK.get()).tickRandomly()), CAItemGroups.blocksItemGroup);
