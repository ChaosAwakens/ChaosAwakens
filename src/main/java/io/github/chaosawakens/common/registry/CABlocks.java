...
import io.github.chaosawakens.common.blocks.crystal.CrystalAntNestBlock;
...
public class CABlocks {
	...
	public static final RegistryObject<RotatedPillarBlock> STRIPPED_DENSEWOOD_WOOD = registerBlock("stripped_densewood_wood", () -> new RotatedPillarBlock(Properties.copy(Blocks.STRIPPED_OAK_WOOD)), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarBlock> DENSEWOOD_WOOD = registerBlock("densewood_wood", () -> new RotatedPillarBlock(Properties.copy(Blocks.OAK_WOOD)), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<RotatedPillarBlock> STRIPPED_SKYWOOD_WOOD = registerBlock("stripped_skywood_wood", () -> new RotatedPillarBlock(Properties.copy(Blocks.STRIPPED_OAK_WOOD)), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarBlock> SKYWOOD_WOOD = registerBlock("skywood_wood", () -> new RotatedPillarBlock(Properties.copy(Blocks.OAK_WOOD)), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<Block> ROBO_LAMP = registerBlock("robo_lamp", () -> new Block(Properties.of(Material.BUILDABLE_GLASS).lightLevel((state) -> 20).strength(30.0F, 100.0F).sound(SoundType.GLASS)), CAItemGroups.BLOCKS);
	...
	// Crystal World (CA)
	public static final RegistryObject<CAOreBlock> CRYSTALISED_CRYSTAL_APPLE_COW = registerBlock("crystalised_crystal_apple_cow", () -> new CAOreBlock(Properties.copy(Blocks.IRON_ORE).harvestLevel(1).requiresCorrectToolForDrops().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.FOSSILS);
	public static final RegistryObject<CAOreBlock> CRYSTALISED_CRYSTAL_CARROT_PIG = registerBlock("crystalised_crystal_carrot_pig", () -> new CAOreBlock(Properties.copy(Blocks.IRON_ORE).harvestLevel(1).requiresCorrectToolForDrops().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.FOSSILS);
	...
	// TORCHES
	public static final RegistryObject<TorchBlock> CRYSTAL_TORCH = registerBlock("crystal_torch", () -> new TorchBlock(Properties.of(Material.DECORATION).noCollission().instabreak().lightLevel((state) -> 14).sound(SoundType.WOOD), ParticleTypes.FLAME), null, false);
	public static final RegistryObject<WallTorchBlock> WALL_CRYSTAL_TORCH = registerBlock("wall_crystal_torch", () -> new WallTorchBlock(Properties.of(Material.DECORATION).noCollission().instabreak().lightLevel((state) -> 14).sound(SoundType.WOOD).lootFrom(CABlocks.CRYSTAL_TORCH), ParticleTypes.FLAME), null, false);
	...
	public static final RegistryObject<TorchBlock> EXTREME_TORCH = registerBlock("extreme_torch", () -> new TorchBlock(Properties.of(Material.DECORATION).noCollission().instabreak().lightLevel((state) -> 20).sound(SoundType.WOOD), ParticleTypes.FLAME), null, false);
	public static final RegistryObject<WallTorchBlock> WALL_EXTREME_TORCH = registerBlock("wall_extreme_torch", () -> new WallTorchBlock(Properties.of(Material.DECORATION).noCollission().instabreak().lightLevel((state) -> 20).sound(SoundType.WOOD).lootFrom(CABlocks.EXTREME_TORCH), ParticleTypes.FLAME), null, false);
	...
	public static final RegistryObject<CrystalGrassBlock> CRYSTAL_GRASS_BLOCK = registerBlock("crystal_grass_block", () -> new CrystalGrassBlock(Properties.of(Material.GRASS).randomTicks().strength(0.6F).sound(SoundType.GRASS).harvestTool(ToolType.SHOVEL).requiresCorrectToolForDrops().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalAntNestBlock> CRYSTAL_TERMITE_NEST = registerBlock("crystal_termite_nest", () -> new CrystalAntNestBlock(() -> CAEntityTypes.TERMITE.get(), Properties.copy(CABlocks.CRYSTAL_GRASS_BLOCK.get()).harvestTool(ToolType.SHOVEL).randomTicks().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalBlock> KYANITE = registerBlock("kyanite", () -> new CrystalBlock(Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarCrystalBlock> CRYSTAL_LOG = registerBlock("crystal_log", () -> new RotatedPillarCrystalBlock(Properties.copy(Blocks.OAK_LOG).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<RotatedPillarCrystalBlock> CRYSTAL_WOOD = registerBlock("crystal_wood", () -> new RotatedPillarCrystalBlock(Properties.copy(Blocks.OAK_WOOD).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalBlock> CRYSTAL_PLANKS = registerBlock("crystal_planks", () -> new CrystalBlock(Properties.copy(Blocks.OAK_PLANKS).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<Block> RED_CRYSTAL_LEAVES = registerBlock("red_crystal_leaves", () -> new Block(Properties.copy(Blocks.OAK_LEAVES).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<Block> GREEN_CRYSTAL_LEAVES = registerBlock("green_crystal_leaves", () -> new Block(Properties.copy(Blocks.OAK_LEAVES).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<Block> YELLOW_CRYSTAL_LEAVES = registerBlock("yellow_crystal_leaves", () -> new Block(Properties.copy(Blocks.OAK_LEAVES).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<Block> PINK_CRYSTAL_LEAVES = registerBlock("pink_crystal_leaves", () -> new Block(Properties.copy(Blocks.OAK_LEAVES).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<Block> BLUE_CRYSTAL_LEAVES = registerBlock("blue_crystal_leaves", () -> new Block(Properties.copy(Blocks.OAK_LEAVES).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<Block> ORANGE_CRYSTAL_LEAVES = registerBlock("orange_crystal_leaves", () -> new Block(Properties.copy(Blocks.OAK_LEAVES).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<SlabBlock> CRYSTAL_SLAB = registerBlock("crystal_slab", () -> new SlabBlock(Properties.copy(CABlocks.CRYSTAL_PLANKS.get()).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<PressurePlateBlock> CRYSTAL_PRESSURE_PLATE = registerBlock("crystal_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, Properties.copy(CABlocks.CRYSTAL_PLANKS.get()).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<FenceBlock> CRYSTAL_FENCE = registerBlock("crystal_fence", () -> new FenceBlock(Properties.copy(CABlocks.CRYSTAL_PLANKS.get()).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<FenceGateBlock> CRYSTAL_FENCE_GATE = registerBlock("crystal_fence_gate", () -> new FenceGateBlock(Properties.copy(CABlocks.CRYSTAL_PLANKS.get()).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<WoodButtonBlock> CRYSTAL_BUTTON = registerBlock("crystal_button", () -> new WoodButtonBlock(Properties.copy(CABlocks.CRYSTAL_PLANKS.get()).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<StairsBlock> CRYSTAL_STAIRS = registerBlock("crystal_stairs", () -> new StairsBlock(() -> CRYSTAL_PLANKS.get().defaultBlockState(), Properties.copy(CABlocks.CRYSTAL_PLANKS.get()).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalClusterBlock> PINK_TOURMALINE_CLUSTER = registerBlock("pink_tourmaline_cluster", () -> new CrystalClusterBlock(Properties.copy(Blocks.IRON_ORE).noOcclusion().isSuffocating(isFalse).isViewBlocking(isFalse).isRedstoneConductor(isFalse).harvestLevel(1)), CAItemGroups.BLOCKS);
	public static final RegistryObject<BuddingBlock> BUDDING_PINK_TOURMALINE = registerBlock("budding_pink_tourmaline", () -> new BuddingBlock(Properties.copy(Blocks.STONE).randomTicks().isRedstoneConductor(isFalse).noOcclusion(), PINK_TOURMALINE_CLUSTER.get()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalClusterBlock> CATS_EYE_CLUSTER = registerBlock("cats_eye_cluster", () -> new CrystalClusterBlock(Properties.copy(Blocks.IRON_ORE).isSuffocating(isFalse).isViewBlocking(isFalse).isRedstoneConductor(isFalse).noOcclusion().harvestLevel(2)), CAItemGroups.BLOCKS);
	public static final RegistryObject<BuddingBlock> BUDDING_CATS_EYE = registerBlock("budding_cats_eye", () -> new BuddingBlock(Properties.copy(Blocks.STONE).randomTicks().isRedstoneConductor(isFalse).noOcclusion(), CATS_EYE_CLUSTER.get()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalEnergyBlock> CRYSTAL_ENERGY = registerBlock("crystal_energy", () -> new CrystalEnergyBlock(Properties.copy(Blocks.GLASS).isSuffocating(isFalse).isViewBlocking(isFalse).isRedstoneConductor(isFalse).noOcclusion().harvestLevel(0).lightLevel((state) -> 8)), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalCraftingTableBlock> CRYSTAL_CRAFTING_TABLE = registerBlock("crystal_crafting_table", () -> new CrystalCraftingTableBlock(Properties.copy(Blocks.CRAFTING_TABLE).isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalFurnaceBlock> CRYSTAL_FURNACE = registerBlock("crystal_furnace", () -> new CrystalFurnaceBlock(Properties.copy(Blocks.FURNACE).isRedstoneConductor(isFalse).noOcclusion().lightLevel(LIGHT_VALUE_FUNCTION.apply(13))), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalBlock> PINK_TOURMALINE_BLOCK = registerBlock("pink_tourmaline_block", () -> new CrystalBlock(Properties.copy(Blocks.IRON_BLOCK).harvestLevel(1).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	public static final RegistryObject<CrystalBlock> CATS_EYE_BLOCK = registerBlock("cats_eye_block", () -> new CrystalBlock(Properties.copy(Blocks.DIAMOND_BLOCK).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().isRedstoneConductor(isFalse).noOcclusion()), CAItemGroups.BLOCKS);
	...
	public static final RegistryObject<TallDenseGrassBlock> SMALL_CARNIVOROUS_PLANT = registerBlock("small_carnivorous_plant", () -> new TallDenseGrassBlock(Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS)), CAItemGroups.BLOCKS);
	public static final RegistryObject<TallDenseGrassBlock> BIG_CARNIVOROUS_PLANT = registerBlock("big_carnivorous_plant", () -> new TallDenseGrassBlock( Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS)), CAItemGroups.BLOCKS);
