...
public class CAStats {
	...
	public static final ResourceLocation INTERACT_WITH_CRYSTAL_CRAFTING_TABLE = registerCustom(
			"interact_with_crystal_crafting_table");
	public static final ResourceLocation INTERACT_WITH_CRYSTAL_FURNACE = registerCustom(
			"interact_with_crystal_furnace");
