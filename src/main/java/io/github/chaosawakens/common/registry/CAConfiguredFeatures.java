...
public class CAConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> CRYSTAL_FOSSILISED_CRYSTAL_GATOR = registerFeature("crystal_ore_fossilised_crystal_gator", Feature.ORE.configured(new OreFeatureConfig(RuleTests.BASE_STONE_CRYSTAL, States.CRYSTALISED_CRYSTAL_GATOR, 2)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(38, 25))).squared().count(2));
