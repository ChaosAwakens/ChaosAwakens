...
public class CAConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> FOSSILISED_SNOW_GOLEM = register("ore_fossilised_snow_golem", Feature.ORE.configured(new OreFeatureConfig(RuleTests.BASE_ICE, States.FOSSILISED_SNOW_GOLEM, 3)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(63, 5))).squared().count(4));
	...
	public static final ConfiguredFeature<?, ?> FOSSILISED_STRAY = register("ore_fossilised_stray", Feature.ORE.configured(new OreFeatureConfig(RuleTests.BASE_ICE, States.FOSSILISED_STRAY, 3)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(63, 5))).squared().count(4));
	...
	public static final class RuleTests {
		...
		public static final RuleTest BASE_ICE = new BlockMatchRuleTest(Blocks.ICE);
	}
}