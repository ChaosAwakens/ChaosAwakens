...
public class CAConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> FOSSILISED_FROG = registerFeature("ore_fossilised_frog", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, States.FOSSILISED_FROG, 3)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(48, 48))).squared().count(4));
	...
	public static final ConfiguredFeature<?, ?> MINING_FOSSILISED_FROG = registerFeature("mining_ore_fossilised_frog", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, States.FOSSILISED_FROG, 3)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(48, 60))).squared().count(2));
	...
	// CRYSTAL WORLD
	public static final ConfiguredFeature<?, ?> CRYSTAL_ORE_ENERGY = registerFeature("crystal_ore_energy", Feature.ORE.configured(new OreFeatureConfig(RuleTests.BASE_STONE_CRYSTAL, States.CRYSTAL_ENERGY, 16)).decorated(Placement.RANGE.configured(new TopSolidRangeConfig(16, 0, 80))).squared().count(3));
	...
	public static final ConfiguredFeature<?, ?> TREES_DENSE_PLAINS = registerFeature("trees_dense_plains", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(DENSEWOOD_TREE.weighted(0.02F), GINKGO_TREE_FANCY.weighted(0.08F)), Feature.NO_OP.configured(new NoFeatureConfig()))).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(1).decorated(Placement.COUNT_EXTRA.configured(new AtSurfaceWithExtraConfig(1, 0.1F, 1))));
