...
public class CAConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> MINING_RED_ANT_INFESTED = register("mining_ore_red_ant_infested", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, States.RED_ANT_INFESTED_ORE, 8)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(24, 12))).squared().count(5));
	public static final ConfiguredFeature<?, ?> MINING_TERMITE_INFESTED = register("mining_ore_termite_infested", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, States.TERMITE_INFESTED_ORE, 8)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(24, 12))).squared().count(2));
