...
public class GiantConiferTrunkPlacer extends DirtlessGiantTrunkPlacer {
	...
	private Foliage placeBranch(IWorldGenerationReader reader, Random rand, BlockPos.Mutable mutablePos, int offX, int y, int offZ, int baseLength, BlockPos pos, Set<BlockPos> set, MutableBoundingBox bb, BaseTreeFeatureConfig config) {
