...
public class CrystalStraightTrunkPlacer extends AbstractTrunkPlacer {
	public static final Codec<CrystalStraightTrunkPlacer> CODEC = RecordCodecBuilder
			.create((builderInstance) -> trunkPlacerParts(builderInstance).apply(builderInstance,
					CrystalStraightTrunkPlacer::new));
	...
	@Override
	public List<FoliagePlacer.Foliage> placeTrunk(IWorldGenerationReader reader, Random rand, int treeHeight,
