...
public class ConfiguredStructures {
	...
	public static StructureFeature<?, ?> CONFIGURED_ENT_DUNGEON = CAStructures.ENT_DUNGEON.get().configured(IFeatureConfig.NONE);
	...
	public static void registerConfiguredStructures() {
		...
		FlatGenerationSettings.STRUCTURE_FEATURES.put(CAStructures.ENT_DUNGEON.get(), CONFIGURED_ENT_DUNGEON);
