...
public class DarkOakEntStructureOverworld extends Structure<NoFeatureConfig> {

	public DarkOakEntStructureOverworld(Codec<NoFeatureConfig> codec) {
		super(codec);
	}
	
	@Override
	public IStartFactory<NoFeatureConfig> getStartFactory() {
		return DarkOakEntStructureOverworld.Start::new;
	}
	...
	public class Start extends StructureStart<NoFeatureConfig> {
		...
		public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
			...
			JigsawManager.addPieces(dynamicRegistryManager,
					new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).get(new ResourceLocation(ChaosAwakens.MODID, "dungeon/ent_tree/dark_oak")), 10),
