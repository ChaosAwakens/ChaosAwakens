...
public class CAItems {
	...
	// TOOLS
	// Ultimate
	public static final RegistryObject<EnchantedSwordItem> ULTIMATE_SWORD = ITEMS.register("ultimate_sword", () -> new EnchantedSwordItem(ToolMaterials.TOOL_ULTIMATE, (int) (CAConfig.COMMON.ultimateSwordDamage.get() - 37), -2.4F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.SHARPNESS, Enchantments.SMITE, Enchantments.BANE_OF_ARTHROPODS, Enchantments.KNOCKBACK, Enchantments.LOOTING, Enchantments.UNBREAKING, Enchantments.FIRE_ASPECT }, new int[] { 5, 5, 5, 3, 3, 2, 2 }));
	...
	public static final RegistryObject<EnchantedPickaxeItem> ULTIMATE_PICKAXE = ITEMS.register("ultimate_pickaxe", () -> new EnchantedPickaxeItem(ToolMaterials.TOOL_ULTIMATE, (int) (CAConfig.COMMON.ultimatePickaxeDamage.get() - 37), -2.8F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.EFFICIENCY, Enchantments.FORTUNE, Enchantments.UNBREAKING }, new int[] { 5, 5, 2 }));
	...
	public static final RegistryObject<EnchantedPickaxeItem> EMERALD_PICKAXE = ITEMS.register("emerald_pickaxe", () -> new EnchantedPickaxeItem(ToolMaterials.TOOL_EMERALD, (int) (CAConfig.COMMON.emeraldPickaxeDamage.get() - 7), -2.8F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.SILK_TOUCH }, new int[] { 1 }));
	...
	public static final RegistryObject<EnchantedSwordItem> EXPERIENCE_SWORD = ITEMS.register("experience_sword", () -> new EnchantedSwordItem(ToolMaterials.TOOL_EMERALD, (int) (CAConfig.COMMON.experienceSwordDamage.get() - 7), -2.4F, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.SHARPNESS, Enchantments.UNBREAKING, Enchantments.MENDING }, new int[] { 2, 3, 1 }));
	public static final RegistryObject<PoisonSwordItem> POISON_SWORD = ITEMS.register("poison_sword", () -> new PoisonSwordItem(ToolMaterials.TOOL_EMERALD, (int) (CAConfig.COMMON.poisonSwordDamage.get() - 7), -2.4F, new Item.Properties().group(CAItemGroups.equipmentItemGroup),new Enchantment[] {Enchantments.SHARPNESS}, new int[] {1}));
	...
	public static final RegistryObject<EnchantedArmorItem> LAVA_EEL_CHESTPLATE = ITEMS.register("lava_eel_chestplate", () -> new EnchantedArmorItem(ArmorMaterials.LAVA_EEL, EquipmentSlotType.CHEST, new Item.Properties().group(CAItemGroups.equipmentItemGroup).isImmuneToFire(), new Enchantment[] { Enchantments.FIRE_PROTECTION }, new int[] { 4 }));
	public static final RegistryObject<EnchantedArmorItem> LAVA_EEL_LEGGINGS = ITEMS.register("lava_eel_leggings", () -> new EnchantedArmorItem(ArmorMaterials.LAVA_EEL, EquipmentSlotType.LEGS, new Item.Properties().group(CAItemGroups.equipmentItemGroup).isImmuneToFire(), new Enchantment[] { Enchantments.FIRE_PROTECTION }, new int[] { 4 }));
	public static final RegistryObject<EnchantedArmorItem> LAVA_EEL_BOOTS = ITEMS.register("lava_eel_boots", () -> new EnchantedArmorItem(ArmorMaterials.LAVA_EEL, EquipmentSlotType.FEET, new Item.Properties().group(CAItemGroups.equipmentItemGroup).isImmuneToFire(), new Enchantment[] { Enchantments.FIRE_PROTECTION }, new int[] { 4 }));
	...
	public static final RegistryObject<EnchantedArmorItem> LAPIS_BOOTS = ITEMS.register("lapis_boots", () -> new EnchantedArmorItem(ArmorMaterials.LAPIS, EquipmentSlotType.FEET, new Item.Properties().group(CAItemGroups.equipmentItemGroup), new Enchantment[] { Enchantments.PROTECTION, Enchantments.PROJECTILE_PROTECTION }, new int[] { 1, 1 }));
	...
	public static final RegistryObject<PeacockBootsItem> PEACOCK_FEATHER_BOOTS = ITEMS.register("peacock_feather_boots", () -> new PeacockBootsItem(ArmorMaterials.PEACOCK_FEATHER, EquipmentSlotType.FEET, new Item.Properties().group(CAItemGroups.equipmentItemGroup)));
