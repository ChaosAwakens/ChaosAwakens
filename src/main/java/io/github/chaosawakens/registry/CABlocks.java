...
public class CABlocks {
    ...
    // SPAWNER BLOCK
	public static final RegistryObject<ModSpawnerBlock> SPAWNER_BLOCK = registerBlock("spawner_block", () -> new ModSpawnerBlock(Block.Properties.create(Material.IRON, MaterialColor.IRON).hardnessAndResistance(-1.0F).notSolid().sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).harvestLevel(2)), CAItemGroups.blocksItemGroup);
	...
	public static final RegistryObject<ModOreBlock> RUBY_ORE = registerBlock("ruby_ore", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(3)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> TIGERS_EYE_ORE = registerBlock("tigers_eye_ore", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(2)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> TITANIUM_ORE = registerBlock("titanium_ore", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(3)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> URANIUM_ORE = registerBlock("uranium_ore", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(3)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> ALUMINIUM_ORE = registerBlock("aluminium_ore", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(2)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> SALT_ORE = registerBlock("salt_ore", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(0)), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> COPPER_ORE = registerBlock("copper_ore", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(1)), CAItemGroups.blocksItemGroup);
	...
	// MOB ORES
	public static final RegistryObject<ModOreBlock> FOSSILISED_ENT = registerBlock("fossilised_ent", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(1), true), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> FOSSILISED_HERCULES_BEETLE = registerBlock("fossilised_hercules_beetle", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(1), true), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> FOSSILISED_RUBY_BUG = registerBlock("fossilised_ruby_bug", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(1), true), CAItemGroups.blocksItemGroup);
	public static final RegistryObject<ModOreBlock> FOSSILISED_EMERALD_GATOR = registerBlock("fossilised_emerald_gator", () -> new ModOreBlock(Block.Properties.from(Blocks.IRON_ORE).harvestLevel(1), true), CAItemGroups.blocksItemGroup);
