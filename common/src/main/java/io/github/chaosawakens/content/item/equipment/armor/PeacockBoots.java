...
public class PeacockBoots extends EnchantedArmorItem {
    public PeacockBoots(ArmorMaterial material, Type type, Properties properties, Map<Enchantment, Integer> enchantments) {
