package io.github.chaosawakens.content.worldgen.config.mining_paradise.biome.layer_1;
...
public class MesozoicJungleConfig implements BiomeConfig {
    ...
    public @Nullable BiomeGenerationSettings getGenerationSettings(BootstapContext<Biome> regCtx) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatureGetter.getOrThrow(CAFeatures.CAPlacedFeatures.TREES_MESOZOIC.get()));
