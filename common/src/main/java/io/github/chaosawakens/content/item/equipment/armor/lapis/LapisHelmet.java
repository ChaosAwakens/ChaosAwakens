...
public class LapisHelmet extends EnchantedArmorItem {
    public LapisHelmet(ArmorMaterial material, Type type, Properties properties, Map<Enchantment, Integer> enchantments) {
