...
public class IronDefossilizingRecipe extends AbstractDefossilizingRecipe {
    ...
    public Predicate<ItemStack> getBucketStackPredicate() {
        return getBucketIngredient().and(bucketStack -> AbstractDefossilizerBlockEntity.isBucketComponent(bucketStack) && bucketStack.is(CATags.CAItemTags.IRON_DEFOSSILIZER_BUCKETS.get()));
    }
    ...
    public @NotNull RecipeSerializer<?> getSerializer() {
        return CARecipeData.CARecipeSerializers.IRON_DEFOSSILIZING.get();
    }
}
