package io.github.chaosawakens.content.item.mob;
...
public class WrappedFoodOnAStickItem<EIS extends Entity & ItemSteerable> extends FoodOnAStickItem<EIS> {
    ...
    @Override
    public @NotNull InteractionResultHolder<ItemStack> use(Level curLevel, Player interactingOwnerPlayer, InteractionHand curHand) {
