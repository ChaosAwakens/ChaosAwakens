package io.github.chaosawakens.content.worldgen.config.crystal_world.biome.crystalwood_forest;
...
public class CrystalwoodForestConfig implements BiomeConfig {
    ...
    public CrystalwoodForestConfig() {
    }
    ...
    public @Nullable BiomeGenerationSettings getGenerationSettings(BootstapContext<Biome> regCtx) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatureGetter.getOrThrow(CAFeatures.CAPlacedFeatures.BLACK_CRYSTAL_GROWTH_PATCH.get()));
