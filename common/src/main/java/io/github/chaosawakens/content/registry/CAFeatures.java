...
import io.github.chaosawakens.content.worldgen.feature.*;
...
import io.github.chaosawakens.content.worldgen.feature.configuration.StalagmiteConfiguration;
import io.github.chaosawakens.content.worldgen.placement_modifier.InSquareBBPlacementModifier;
import io.github.chaosawakens.content.worldgen.placement_modifier.PickLowestHeightPlacementModifier;
import io.github.chaosawakens.content.worldgen.placement_modifier.SurfaceAreaCheckPlacementModifier;
import io.github.chaosawakens.content.worldgen.placement_modifier.SurfaceCheckPlacementModifier;
import io.github.chaosawakens.content.worldgen.structure.processor.BeeHiveProcessor;
import io.github.chaosawakens.content.worldgen.structure.processor.MesozoicVineProcessor;
...
public class CAFeatures {
    ...
    public static class Features {
        ...
        private static <FC extends FeatureConfiguration, F extends Feature<FC>> Supplier<F> registerFeature(String id, Supplier<Feature<?>> featureSup) {
            Supplier<F> placedFeatureSup = (Supplier<F>) NexusServices.REGISTRAR.registerObject(CAConstants.prefix(id), featureSup, BuiltInRegistries.FEATURE);
    ...
    public static class CAConfiguredFeatures {
        ...
        // Mining Paradise
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> STALAGMITE = registerConfiguredFeature("stalagmite", () -> new ConfiguredFeature<>(Features.STALAGMITE.get(), new StalagmiteConfiguration(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get(), 6, 8, 0.8f, 0.5f)));
        ...
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_ROCK = registerConfiguredFeature("dredgestone_rock", () -> new ConfiguredFeature<>(Feature.FOREST_ROCK, new BlockStateConfiguration(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get().defaultBlockState())));
        ...
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GINKGO_TREE_VARIANT_1 = registerConfiguredFeature("ginkgo_tree_variant_1", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/ginkgo_tree/ginkgo_tree_1")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GINKGO_TREE_VARIANT_2 = registerConfiguredFeature("ginkgo_tree_variant_2", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/ginkgo_tree/ginkgo_tree_2")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GINKGO_TREE_VARIANT_3 = registerConfiguredFeature("ginkgo_tree_variant_3", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/ginkgo_tree/ginkgo_tree_3")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GINKGO_TREE_VARIANT_4 = registerConfiguredFeature("ginkgo_tree_variant_4", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/ginkgo_tree/ginkgo_tree_4")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GINKGO_TREE_VARIANT_5 = registerConfiguredFeature("ginkgo_tree_variant_5", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/ginkgo_tree/ginkgo_tree_5")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DENSEWOOD_TREE_VARIANT_1 = registerConfiguredFeature("densewood_tree_variant_1", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/densewood_tree/densewood_tree_1")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DENSEWOOD_TREE_VARIANT_2 = registerConfiguredFeature("densewood_tree_variant_2", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/densewood_tree/densewood_tree_2")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DENSEWOOD_TREE_VARIANT_3 = registerConfiguredFeature("densewood_tree_variant_3", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/densewood_tree/densewood_tree_3")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DENSEWOOD_TREE_VARIANT_4 = registerConfiguredFeature("densewood_tree_variant_4", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/densewood_tree/densewood_tree_4")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DENSEWOOD_TREE_VARIANT_5 = registerConfiguredFeature("densewood_tree_variant_5", () -> new ConfiguredFeature<>(Features.NBT_TREE.get(), new NBTTreeConfiguration(Either.left(CAConstants.prefix("feature_presets/nbt_tree/densewood_tree/densewood_tree_5")), 0, Optional.of(new StructureProcessorList(ObjectArrayList.of())))));
        ...
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_URANIUM_ORE = registerConfiguredFeature("dredgestone_uranium_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_URANIUM_ORE.get().defaultBlockState(), 3)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_URANIUM_ORE = registerConfiguredFeature("gloomstone_uranium_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_URANIUM_ORE.get().defaultBlockState(), 4)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_TITANIUM_ORE = registerConfiguredFeature("dredgestone_titanium_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_TITANIUM_ORE.get().defaultBlockState(), 3)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_TITANIUM_ORE = registerConfiguredFeature("gloomstone_titanium_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_TITANIUM_ORE.get().defaultBlockState(), 4)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_SUNSTONE_ORE = registerConfiguredFeature("dredgestone_sunstone_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_SUNSTONE_ORE.get().defaultBlockState(), 16)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_SUNSTONE_ORE = registerConfiguredFeature("gloomstone_sunstone_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_SUNSTONE_ORE.get().defaultBlockState(), 10)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_RUBY_ORE = registerConfiguredFeature("dredgestone_ruby_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_RUBY_ORE.get().defaultBlockState(), 2)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_RUBY_ORE = registerConfiguredFeature("gloomstone_ruby_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_RUBY_ORE.get().defaultBlockState(), 3)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_REDSTONE_ORE = registerConfiguredFeature("dredgestone_redstone_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_REDSTONE_ORE.get().defaultBlockState(), 5)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_REDSTONE_ORE = registerConfiguredFeature("gloomstone_redstone_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_REDSTONE_ORE.get().defaultBlockState(), 6)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_PLATINUM_ORE = registerConfiguredFeature("dredgestone_platinum_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_PLATINUM_ORE.get().defaultBlockState(), 4)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_PLATINUM_ORE = registerConfiguredFeature("gloomstone_platinum_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_PLATINUM_ORE.get().defaultBlockState(), 5)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_LAPIS_ORE = registerConfiguredFeature("dredgestone_lapis_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_LAPIS_ORE.get().defaultBlockState(), 7)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_LAPIS_ORE = registerConfiguredFeature("gloomstone_lapis_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_LAPIS_ORE.get().defaultBlockState(), 7)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_KUNZITE_ORE = registerConfiguredFeature("dredgestone_kunzite_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_KUNZITE_ORE.get().defaultBlockState(), 4)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_KUNZITE_ORE = registerConfiguredFeature("gloomstone_kunzite_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_KUNZITE_ORE.get().defaultBlockState(), 5)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_IRON_ORE = registerConfiguredFeature("dredgestone_iron_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_IRON_ORE.get().defaultBlockState(), 9)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_IRON_ORE = registerConfiguredFeature("gloomstone_iron_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_IRON_ORE.get().defaultBlockState(), 9)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_GOLD_ORE = registerConfiguredFeature("dredgestone_gold_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_GOLD_ORE.get().defaultBlockState(), 9)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_GOLD_ORE = registerConfiguredFeature("gloomstone_gold_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_GOLD_ORE.get().defaultBlockState(), 9)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_DIAMOND_ORE = registerConfiguredFeature("dredgestone_diamond_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_DIAMOND_ORE.get().defaultBlockState(), 4)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_DIAMOND_ORE = registerConfiguredFeature("gloomstone_diamond_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_DIAMOND_ORE.get().defaultBlockState(), 12)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_COPPER_ORE = registerConfiguredFeature("dredgestone_copper_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_COPPER_ORE.get().defaultBlockState(), 18)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_COPPER_ORE = registerConfiguredFeature("gloomstone_copper_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_COPPER_ORE.get().defaultBlockState(), 14)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_COAL_ORE = registerConfiguredFeature("dredgestone_coal_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_COAL_ORE.get().defaultBlockState(), 24)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_COAL_ORE = registerConfiguredFeature("gloomstone_coal_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_COAL_ORE.get().defaultBlockState(), 17)));

        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> DREDGESTONE_ALUMINUM_ORE = registerConfiguredFeature("dredgestone_aluminum_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.DREDGESTONE.stoneBlockFamily().get(CAConstants.prefix("dredgestone")).get()), CABlocks.DREDGESTONE_ALUMINUM_ORE.get().defaultBlockState(), 15)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> GLOOMSTONE_ALUMINUM_ORE = registerConfiguredFeature("gloomstone_aluminum_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(new BlockMatchTest(CABlocks.GLOOMSTONE.stoneBlockFamily().get(CAConstants.prefix("gloomstone")).get()), CABlocks.GLOOMSTONE_ALUMINUM_ORE.get().defaultBlockState(), 20)));
        ...
        private static Supplier<ResourceKey<ConfiguredFeature<?, ?>>> registerConfiguredFeature(ResourceLocation id, Supplier<ConfiguredFeature<?, ?>> actualPlacedFeatureSup) {
            Supplier<ResourceKey<ConfiguredFeature<?, ?>>> placedFeatureSup = NexusServices.REGISTRAR.registerDatapackObject(id, b -> actualPlacedFeatureSup, Registries.CONFIGURED_FEATURE);
    ...
    public static class CAPlacedFeatures {
        ...
        public static final Supplier<ResourceKey<PlacedFeature>> DREDGESTONE_SUNSTONE_ORE = registerPlacedFeature("dredgestone_sunstone_ore", CAConfiguredFeatures.DREDGESTONE_SUNSTONE_ORE, commonOrePlacement(14, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(48))));
        public static final Supplier<ResourceKey<PlacedFeature>> GLOOMSTONE_SUNSTONE_ORE = registerPlacedFeature("gloomstone_sunstone_ore", CAConfiguredFeatures.GLOOMSTONE_SUNSTONE_ORE, commonOrePlacement(10, HeightRangePlacement.triangle(VerticalAnchor.absolute(-128), VerticalAnchor.absolute(-5))));
        ...
        public static final Supplier<ResourceKey<PlacedFeature>> DREDGESTONE_IRON_ORE = registerPlacedFeature("dredgestone_iron_ore", CAConfiguredFeatures.DREDGESTONE_IRON_ORE, commonOrePlacement(15, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(140))));
        ...
        public static final Supplier<ResourceKey<PlacedFeature>> DREDGESTONE_COPPER_ORE = registerPlacedFeature("dredgestone_copper_ore", CAConfiguredFeatures.DREDGESTONE_COPPER_ORE, commonOrePlacement(22, HeightRangePlacement.triangle(VerticalAnchor.absolute(1), VerticalAnchor.absolute(144))));
        ...
        private static Supplier<ResourceKey<PlacedFeature>> registerPlacedFeature(ResourceLocation id, Supplier<ResourceKey<ConfiguredFeature<?, ?>>> configuredFeatureHolder, List<PlacementModifier> placementModifiers) {
            Supplier<ResourceKey<PlacedFeature>> placedFeatureSup = NexusServices.REGISTRAR.registerDatapackObject(id, b -> () -> new PlacedFeature(b.lookup(Registries.CONFIGURED_FEATURE).getOrThrow(configuredFeatureHolder.get()), List.copyOf(placementModifiers)), Registries.PLACED_FEATURE);
        ...
        private static ObjectArrayList<PlacementModifier> nbtTreePlacement(BoundingBox trunkBB, int x, int z) {
            return ObjectArrayList.of(
                    new InSquareBBPlacementModifier(x, z),
                    SurfaceWaterDepthFilter.forMaxDepth(0),
                    PlacementUtils.HEIGHTMAP_OCEAN_FLOOR,
                    new SurfaceAreaCheckPlacementModifier(new SimpleSupplierStateProvider(() -> CABlocks.DENSE_GRASS_BLOCK.get().defaultBlockState()), trunkBB),
                    new PickLowestHeightPlacementModifier(trunkBB)
            );
        }
    ...
    public static class PlacementModifiers {
        ...
        public static final Supplier<PlacementModifierType<InSquareBBPlacementModifier>> IN_BB_SQUARE = registerModifier("in_bb_square", () -> () -> InSquareBBPlacementModifier.CODEC);
        public static final Supplier<PlacementModifierType<SurfaceCheckPlacementModifier>> SURFACE_CHECK = registerModifier("surface_check", () -> () -> SurfaceCheckPlacementModifier.CODEC);
        public static final Supplier<PlacementModifierType<SurfaceAreaCheckPlacementModifier>> SURFACE_AREA_CHECK = registerModifier("surface_area_check", () -> () -> SurfaceAreaCheckPlacementModifier.CODEC);
        public static final Supplier<PlacementModifierType<PickLowestHeightPlacementModifier>> PICK_LOWEST_HEIGHT = registerModifier("pick_lowest_height", () -> () -> PickLowestHeightPlacementModifier.CODEC);
        ...
        private static <P extends PlacementModifier> Supplier<PlacementModifierType<P>> registerModifier(String id, Supplier<PlacementModifierType<P>> codecSup) {
            Supplier<PlacementModifierType<P>> typeSupplier = NexusServices.REGISTRAR.registerObject(CAConstants.prefix(id), codecSup, BuiltInRegistries.PLACEMENT_MODIFIER_TYPE);
    ...
    public static class StructureProcessors {
        ...
        private static <P extends StructureProcessor> Supplier<StructureProcessorType<P>> registerProcessor(String id, Supplier<StructureProcessorType<P>> codecSup) {
            Supplier<StructureProcessorType<P>> typeSupplier = NexusServices.REGISTRAR.registerObject(CAConstants.prefix(id), codecSup, BuiltInRegistries.STRUCTURE_PROCESSOR);
    ...
    public static class StateProviders {
        ...
        private static <P extends BlockStateProvider> Supplier<BlockStateProviderType<P>> registerProvider(String id, Codec<P> codec) {
            Supplier<BlockStateProviderType<P>> typeSupplier = NexusServices.REGISTRAR.registerObject(CAConstants.prefix(id), () -> new BlockStateProviderType(codec), BuiltInRegistries.BLOCKSTATE_PROVIDER_TYPE);
