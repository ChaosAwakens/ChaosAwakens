package io.github.chaosawakens.content.item.equipment.armor.lapis;
...
public class LapisChestplate extends EnchantedArmorItem {
    public LapisChestplate(ArmorMaterial material, Type type, Properties properties, Map<Enchantment, Integer> enchantments) {
