...
public class ExperienceArmorItem extends ArmorItem {
    public ExperienceArmorItem(ArmorMaterial material, Type type, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        tooltipComponents.add(Component.translatable(CAExtraLocalizations.EXPERIENCE_BONUS_DESCRIPTION.key()));
