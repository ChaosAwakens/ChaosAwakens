...
public class PrismaticReaper extends EnchantedSwordItem {
    public static final int ATTACK_DAMAGE = 49;

    public PrismaticReaper(Tier tier, int attackDamage, float attackSpeedModifier, Item.Properties properties, Map<Enchantment, Integer> enchantment) {
