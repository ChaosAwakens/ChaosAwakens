...
public final class CAFood {
    ...
    public static final FoodProperties FOOD_BAKED_GOLDEN_POTATO = new FoodProperties.Builder().nutrition(6).saturationMod(0.65F).alwaysEat().effect(new MobEffectInstance(MobEffects.REGENERATION, 400, 0), 1.0F).build();
