...
public final class CAFood {
    ...
    // Crystal Plants
    public static final FoodProperties FOOD_CRYSTAL_APPLE = new FoodProperties.Builder().nutrition(5).saturationMod(0.85F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1000, 1), 0.8F)
            .effect(new MobEffectInstance(MobEffects.REGENERATION, 50, 1), 0.65F)
            .build();
    public static final FoodProperties FOOD_CRYSTAL_BEETROOT = new FoodProperties.Builder().nutrition(1).saturationMod(0.15F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 750, 1), 0.7F)
            .effect(new MobEffectInstance(MobEffects.REGENERATION, 50, 1), 0.25F)
            .build();
    public static final FoodProperties FOOD_CRYSTAL_CARROT = new FoodProperties.Builder().nutrition(3).saturationMod(0.40F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 3000, 0), 0.2F)
            .effect(new MobEffectInstance(MobEffects.REGENERATION, 50, 1), 0.25F)
            .build();
    public static final FoodProperties FOOD_CRYSTAL_POTATO = new FoodProperties.Builder().nutrition(2).saturationMod(0.30F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.SATURATION, 150, 0), 0.1F)
            .effect(new MobEffectInstance(MobEffects.REGENERATION, 50, 1), 0.25F)
            .build();
    public static final FoodProperties FOOD_CATS_EYE_CHORUS = new FoodProperties.Builder().nutrition(2).saturationMod(0.30F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 333, 0), 1.0F)
            .effect(new MobEffectInstance(MobEffects.REGENERATION, 250, 1), 0.5F)
            .build();
    ...
    public static final FoodProperties FOOD_POPCORN_BAG = new FoodProperties.Builder().nutrition(8).saturationMod(0.25F).build();
    public static final FoodProperties FOOD_SALTED_POPCORN_BAG = new FoodProperties.Builder().nutrition(10).saturationMod(0.15F).build();
    public static final FoodProperties FOOD_BUTTERED_POPCORN_BAG = new FoodProperties.Builder().nutrition(10).saturationMod(0.3F).build();

    // Candy
    public static final FoodProperties FOOD_BUTTER_CANDY = new FoodProperties.Builder().nutrition(4).saturationMod(0.15F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 1), 1.0F)
            .build();
    public static final FoodProperties FOOD_CANDYCANE = new FoodProperties.Builder().nutrition(4).saturationMod(0.15F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.DIG_SPEED, 400, 1), 1.0F)
            .build();

    // Fish
    public static final FoodProperties FOOD_BLUE_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.6F).build();
    public static final FoodProperties FOOD_GRAY_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.6F).build();
    public static final FoodProperties FOOD_GREEN_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.6F).build();
    public static final FoodProperties FOOD_ROCK_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.8F).build();
    public static final FoodProperties FOOD_PINK_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.6F).build();
    public static final FoodProperties FOOD_WOOD_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.4F).build();

    public static final FoodProperties FOOD_SPARK_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.2F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 100, 0), 1.0F)
            .build();
    public static final FoodProperties FOOD_FIRE_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.4F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 200, 0), 1.0F)
            .build();
    public static final FoodProperties FOOD_LAVA_EEL = new FoodProperties.Builder().nutrition(1).saturationMod(0.4F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 400, 0), 1.0F)
            .build();
    public static final FoodProperties FOOD_SUN_FISH = new FoodProperties.Builder().nutrition(1).saturationMod(0.6F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 600, 0), 1.0F)
            .build();

    // Golden Food
    public static final FoodProperties FOOD_GOLDEN_MELON_SLICE = new FoodProperties.Builder().nutrition(2).saturationMod(2.0F).alwaysEat().build();
    public static final FoodProperties FOOD_GOLDEN_BEETROOT = new FoodProperties.Builder().nutrition(4).saturationMod(0.45F).alwaysEat().build();
    public static final FoodProperties FOOD_GOLDEN_POTATO = new FoodProperties.Builder().nutrition(4).saturationMod(0.65F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.LUCK, 400, 0), 1.0F)
            .build();
    public static final FoodProperties FOOD_BAKED_GOLDEN_POTATO = new FoodProperties.Builder().nutrition(6).saturationMod(0.65F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.LUCK, 400, 0), 1.0F)
            .effect(new MobEffectInstance(MobEffects.GLOWING, 400, 0), 1.0F)
            .build();
    public static final FoodProperties FOOD_ENCHANTED_GOLDEN_CARROT = new FoodProperties.Builder().nutrition(6).saturationMod(0.85F).alwaysEat()
            ...
            .build();
    public static final FoodProperties FOOD_ENCHANTED_GOLDEN_BEETROOT = new FoodProperties.Builder().nutrition(6).saturationMod(0.85F).alwaysEat()
            .effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 4500, 4), 1.0F)
            .effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 4500, 4), 1.0F)
    ...
    public static final FoodProperties FOOD_ULTIMATE_APPLE = new FoodProperties.Builder().nutrition(1).saturationMod(1.0F)
            ...
            .effect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 5400, 2), 1.0F)
            .effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 7200, 2), 1.0F)
            .effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 7200, 2), 1.0F)
