...
public final class CAItems {
    ...
    public static final Supplier<ArmorItem> EXPERIENCE_HELMET = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("experience_helmet"), () -> new ExperienceArmorItem(CAArmorMaterialTemplates.EXPERIENCE, ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.UNCOMMON)), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> EXPERIENCE_CHESTPLATE = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("experience_chestplate"), () -> new ExperienceArmorItem(CAArmorMaterialTemplates.EXPERIENCE, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON)), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> EXPERIENCE_LEGGINGS = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("experience_leggings"), () -> new ExperienceArmorItem(CAArmorMaterialTemplates.EXPERIENCE, ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.UNCOMMON)), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> EXPERIENCE_BOOTS = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("experience_boots"), () -> new ExperienceArmorItem(CAArmorMaterialTemplates.EXPERIENCE, ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.UNCOMMON)), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);

    public static final Supplier<ArmorItem> EMERALD_HELMET = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("emerald_helmet"), () -> new EmeraldArmorItem(CAArmorMaterialTemplates.EMERALD, ArmorItem.Type.HELMET, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> EMERALD_CHESTPLATE = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("emerald_chestplate"), () -> new EmeraldArmorItem(CAArmorMaterialTemplates.EMERALD, ArmorItem.Type.CHESTPLATE, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> EMERALD_LEGGINGS = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("emerald_leggings"), () -> new EmeraldArmorItem(CAArmorMaterialTemplates.EMERALD, ArmorItem.Type.LEGGINGS, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> EMERALD_BOOTS = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("emerald_boots"), () -> new EmeraldArmorItem(CAArmorMaterialTemplates.EMERALD, ArmorItem.Type.BOOTS, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    ...
    public static final Supplier<ArmorItem> LAPIS_HELMET = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("lapis_helmet"), () -> new LapisArmorItem(CAArmorMaterialTemplates.LAPIS, ArmorItem.Type.HELMET, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> LAPIS_CHESTPLATE = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("lapis_chestplate"), () -> new LapisArmorItem(CAArmorMaterialTemplates.LAPIS, ArmorItem.Type.CHESTPLATE, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> LAPIS_LEGGINGS = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("lapis_leggings"), () -> new LapisArmorItem(CAArmorMaterialTemplates.LAPIS, ArmorItem.Type.LEGGINGS, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> LAPIS_BOOTS = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("lapis_boots"), () -> new LapisArmorItem(CAArmorMaterialTemplates.LAPIS, ArmorItem.Type.BOOTS, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);

    public static final Supplier<ArmorItem> LAVA_EEL_HELMET = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("lava_eel_helmet"), () -> new LavaEelArmorItem(CAArmorMaterialTemplates.LAVA_EEL, ArmorItem.Type.HELMET, new Item.Properties()), CAIPWTemplates.SET_BONUS_IPW, EQUIPMENT);
    public static final Supplier<ArmorItem> LAVA_EEL_CHESTPLATE = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("lava_eel_chestplate"), () -> new LavaEelArmorItem(CAArmorMaterialTemplates.LAVA_EEL, ArmorItem.Type.CHESTPLATE, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> LAVA_EEL_LEGGINGS = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("lava_eel_leggings"), () -> new LavaEelArmorItem(CAArmorMaterialTemplates.LAVA_EEL, ArmorItem.Type.LEGGINGS, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
    public static final Supplier<ArmorItem> LAVA_EEL_BOOTS = ItemPropertyWrapperTemplates.registerItemFromTemplate(CAConstants.prefix("lava_eel_boots"), () -> new LavaEelArmorItem(CAArmorMaterialTemplates.LAVA_EEL, ArmorItem.Type.BOOTS, new Item.Properties()), ItemPropertyWrapperTemplates.BASIC_GENERATED, EQUIPMENT);
