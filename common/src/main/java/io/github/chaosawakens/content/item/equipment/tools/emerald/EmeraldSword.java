...
public class EmeraldSword extends EnchantedSwordItem {
    public static final int ATTACK_DAMAGE = 8;

    public EmeraldSword(Tier tier, int attackDamage, float attackSpeedModifier, Properties properties, Map<Enchantment, Integer> enchantment) {
