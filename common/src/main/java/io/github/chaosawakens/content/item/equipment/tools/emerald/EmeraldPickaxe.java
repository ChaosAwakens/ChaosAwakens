...
public class EmeraldPickaxe extends EnchantedSwordItem {
    public static final int ATTACK_DAMAGE = 8;

    public EmeraldPickaxe(Tier tier, int attackDamage, float attackSpeedModifier, Properties properties, Map<Enchantment, Integer> enchantment) {
