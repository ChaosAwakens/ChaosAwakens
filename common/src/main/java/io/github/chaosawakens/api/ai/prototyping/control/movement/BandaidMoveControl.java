package io.github.chaosawakens.api.ai.prototyping.control.movement;
...
public class BandaidMoveControl extends MoveControl {

    public BandaidMoveControl(Mob pMob) {
        super(pMob);
    }

    @Override
    public void tick() {
        if (mob instanceof StatefulMonster statefulOwner && statefulOwner.isAttackingStatically()) {
            statefulOwner.setZza(0.0F);
            return;
        }
