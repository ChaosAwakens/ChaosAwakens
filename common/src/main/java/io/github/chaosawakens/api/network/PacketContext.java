...
public interface PacketContext {
     ...
     *
     * @param packetSender The {@link ServerPlayer} responsible for sending this packet, if it was C2S. Is otherwise {@link Minecraft#player}.
     ...
     */
    void handlePacket(Player packetSender, Level curLevel, NetworkSide curSide);
}
