...
public record NBTTreeConfiguration(Either<ResourceLocation, StructureTemplate> template, BlockStateProvider validSurface, int groundLevel, Optional<StructureProcessorList> list) implements FeatureConfiguration {
    ...
    public static final Codec<NBTTreeConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            StructureProcessorType.LIST_OBJECT_CODEC.optionalFieldOf("processors").forGetter(conf -> conf.list)
