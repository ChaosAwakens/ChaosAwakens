...
public class CADensityFunctions { // Needed so that Vanilla datapacks don't directly affect CA dimension terrain gen (plus some other density functions or optimizations, probably)
    ...
    public static final Supplier<ResourceKey<DensityFunction>> MINING_PARADISE_DEPTH = registerDensityFunction("mining_paradise/land/depth", b -> () -> DensityFunctions.add(DensityFunctions.yClampedGradient(-436, 550, 4.0D, -6.0D), getWrappedDensityFunctionHolder(b, MINING_PARADISE_OFFSET)));
