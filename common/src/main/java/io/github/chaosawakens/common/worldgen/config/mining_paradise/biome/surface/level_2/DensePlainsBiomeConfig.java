...
public class DensePlainsBiomeConfig implements BiomeConfig {
    ...
    public @Nullable BiomeGenerationSettings getGenerationSettings(BootstapContext<Biome> regCtx) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatureGetter.getOrThrow(CAFeatures.CAPlacedFeatures.DENSEWOOD_TREE_VARIANT_1.get()));
