...
public class MiningParadiseBiomeBuilder implements BiomeBuilder {
    ...
    public void mapBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> biomeClimateParameterPointMapper) {
        addSurfaceBiome(biomeClimateParameterPointMapper, Climate.Parameter.span(0.4F, 0.8F), Climate.Parameter.span(0.11F, 0.5F), Climate.Parameter.span(0.6F, 1.85F), Climate.Parameter.span(-0.9F, -0.1F), Climate.Parameter.point(0.0F), 0, CABiomes.DENSE_MOUNTAINS.get());
