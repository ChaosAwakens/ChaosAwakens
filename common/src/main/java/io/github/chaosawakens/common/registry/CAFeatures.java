...
public class CAFeatures {
    ...
    public static class CAConfiguredFeatures {
        ...
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> TREES_MESOZOIC = registerConfiguredFeature("trees_mesozoic", () -> new ConfiguredFeature<>(Features.RANDOM_KEY_SELECTOR.get(), new RandomFeatureKeyConfiguration(ObjectArrayList.of(new WeightedPlacedFeatureKey(CAPlacedFeatures.MESOZOIC_TREE_VARIANT_1, 0.2f), new WeightedPlacedFeatureKey(CAPlacedFeatures.MESOZOIC_TREE_VARIANT_2, 0.2f), new WeightedPlacedFeatureKey(CAPlacedFeatures.MESOZOIC_TREE_VARIANT_3, 0.2f), new WeightedPlacedFeatureKey(CAPlacedFeatures.MESOZOIC_TREE_VARIANT_4, 0.2f), new WeightedPlacedFeatureKey(CAPlacedFeatures.MESOZOIC_TREE_VARIANT_5, 0.2f)), CAPlacedFeatures.MESOZOIC_TREE_VARIANT_6)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> TREES_DENSEWOOD = registerConfiguredFeature("trees_densewood", () -> new ConfiguredFeature<>(Features.RANDOM_KEY_SELECTOR.get(), new RandomFeatureKeyConfiguration(ObjectArrayList.of(new WeightedPlacedFeatureKey(CAPlacedFeatures.DENSEWOOD_TREE_VARIANT_1, 0.25f), new WeightedPlacedFeatureKey(CAPlacedFeatures.DENSEWOOD_TREE_VARIANT_2, 0.25f), new WeightedPlacedFeatureKey(CAPlacedFeatures.DENSEWOOD_TREE_VARIANT_3, 0.25f), new WeightedPlacedFeatureKey(CAPlacedFeatures.DENSEWOOD_TREE_VARIANT_4, 0.25f)), CAPlacedFeatures.DENSEWOOD_TREE_VARIANT_5)));
        public static final Supplier<ResourceKey<ConfiguredFeature<?, ?>>> TREES_GINKGO = registerConfiguredFeature("trees_ginkgo", () -> new ConfiguredFeature<>(Features.RANDOM_KEY_SELECTOR.get(), new RandomFeatureKeyConfiguration(ObjectArrayList.of(new WeightedPlacedFeatureKey(CAPlacedFeatures.GINKGO_TREE_VARIANT_1, 0.25f), new WeightedPlacedFeatureKey(CAPlacedFeatures.GINKGO_TREE_VARIANT_2, 0.25f), new WeightedPlacedFeatureKey(CAPlacedFeatures.GINKGO_TREE_VARIANT_3, 0.25f), new WeightedPlacedFeatureKey(CAPlacedFeatures.GINKGO_TREE_VARIANT_4, 0.25f)), CAPlacedFeatures.GINKGO_TREE_VARIANT_5)));
    ...
    public static class CAPlacedFeatures {
        ...
        public static final Supplier<ResourceKey<PlacedFeature>> MESOZOIC_TREE_VARIANT_1 = registerPlacedFeature("mesozoic_tree_variant_1", CAConfiguredFeatures.MESOZOIC_TREE_VARIANT_1, nbtTreePlacement(new BoundingBox(6, 0, 8, 10, 16, 12), 16, 18));
        public static final Supplier<ResourceKey<PlacedFeature>> MESOZOIC_TREE_VARIANT_2 = registerPlacedFeature("mesozoic_tree_variant_2", CAConfiguredFeatures.MESOZOIC_TREE_VARIANT_2, nbtTreePlacement(new BoundingBox(8, 0, 7, 11, 16, 12), 18, 18));
        public static final Supplier<ResourceKey<PlacedFeature>> MESOZOIC_TREE_VARIANT_3 = registerPlacedFeature("mesozoic_tree_variant_3", CAConfiguredFeatures.MESOZOIC_TREE_VARIANT_3, nbtTreePlacement(new BoundingBox(8, 0, 7, 11, 16, 10), 18, 17));
        public static final Supplier<ResourceKey<PlacedFeature>> MESOZOIC_TREE_VARIANT_4 = registerPlacedFeature("mesozoic_tree_variant_4", CAConfiguredFeatures.MESOZOIC_TREE_VARIANT_4, nbtTreePlacement(new BoundingBox(8, 0, 4, 12, 16, 8), 18, 14));
        public static final Supplier<ResourceKey<PlacedFeature>> MESOZOIC_TREE_VARIANT_5 = registerPlacedFeature("mesozoic_tree_variant_5", CAConfiguredFeatures.MESOZOIC_TREE_VARIANT_5, nbtTreePlacement(new BoundingBox(8, 0, 3, 11, 16, 8), 18, 14));
        public static final Supplier<ResourceKey<PlacedFeature>> MESOZOIC_TREE_VARIANT_6 = registerPlacedFeature("mesozoic_tree_variant_6", CAConfiguredFeatures.MESOZOIC_TREE_VARIANT_6, nbtTreePlacement(new BoundingBox(8, 0, 8, 11, 16, 11), 18, 14));

        public static final Supplier<ResourceKey<PlacedFeature>> GINKGO_TREE_VARIANT_1 = registerPlacedFeature("ginkgo_tree_variant_1", CAConfiguredFeatures.GINKGO_TREE_VARIANT_1, nbtTreePlacement(new BoundingBox(4, 0, 4, 5, 10, 5), 9, 8));
        public static final Supplier<ResourceKey<PlacedFeature>> GINKGO_TREE_VARIANT_2 = registerPlacedFeature("ginkgo_tree_variant_2", CAConfiguredFeatures.GINKGO_TREE_VARIANT_2, nbtTreePlacement(new BoundingBox(4, 0, 5, 5, 10, 6), 8, 9));
        public static final Supplier<ResourceKey<PlacedFeature>> GINKGO_TREE_VARIANT_3 = registerPlacedFeature("ginkgo_tree_variant_3", CAConfiguredFeatures.GINKGO_TREE_VARIANT_3, nbtTreePlacement(new BoundingBox(3, 0, 3, 4, 10, 4), 7, 7));
        public static final Supplier<ResourceKey<PlacedFeature>> GINKGO_TREE_VARIANT_4 = registerPlacedFeature("ginkgo_tree_variant_4", CAConfiguredFeatures.GINKGO_TREE_VARIANT_4, nbtTreePlacement(new BoundingBox(3, 0, 4, 4, 10, 5), 6, 7));
        public static final Supplier<ResourceKey<PlacedFeature>> GINKGO_TREE_VARIANT_5 = registerPlacedFeature("ginkgo_tree_variant_5", CAConfiguredFeatures.GINKGO_TREE_VARIANT_5, nbtTreePlacement(new BoundingBox(4, 0, 4, 5, 10, 5), 8, 8));

        public static final Supplier<ResourceKey<PlacedFeature>> DENSEWOOD_TREE_VARIANT_1 = registerPlacedFeature("densewood_tree_variant_1", CAConfiguredFeatures.DENSEWOOD_TREE_VARIANT_1, nbtTreePlacement(new BoundingBox(5, 0, 5, 7, 10, 7), 10, 11));
        public static final Supplier<ResourceKey<PlacedFeature>> DENSEWOOD_TREE_VARIANT_2 = registerPlacedFeature("densewood_tree_variant_2", CAConfiguredFeatures.DENSEWOOD_TREE_VARIANT_2, nbtTreePlacement(new BoundingBox(4, 0, 3, 6, 10, 5), 9, 7));
        public static final Supplier<ResourceKey<PlacedFeature>> DENSEWOOD_TREE_VARIANT_3 = registerPlacedFeature("densewood_tree_variant_3", CAConfiguredFeatures.DENSEWOOD_TREE_VARIANT_3, nbtTreePlacement(new BoundingBox(3, 0, 3, 5, 10, 5), 7, 7));
        public static final Supplier<ResourceKey<PlacedFeature>> DENSEWOOD_TREE_VARIANT_4 = registerPlacedFeature("densewood_tree_variant_4", CAConfiguredFeatures.DENSEWOOD_TREE_VARIANT_4, nbtTreePlacement(new BoundingBox(4, 0, 5, 6, 10, 7), 10, 10));
        public static final Supplier<ResourceKey<PlacedFeature>> DENSEWOOD_TREE_VARIANT_5 = registerPlacedFeature("densewood_tree_variant_5", CAConfiguredFeatures.DENSEWOOD_TREE_VARIANT_5, nbtTreePlacement(new BoundingBox(4, 0, 4, 6, 10, 6), 10, 9));
