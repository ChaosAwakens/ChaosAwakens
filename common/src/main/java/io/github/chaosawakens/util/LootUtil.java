...
public final class LootUtil {
    ...
    public static LootTable.Builder createAcaciaEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(Items.ACACIA_LOG)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(18.0F, 24.0F)))
    ...
    public static LootTable.Builder createAppleEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(CABlocks.APPLE_LOG.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(18.0F, 24.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 3.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer())))
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(CABlocks.APPLE_LEAVES.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 1.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer()))
           /*             .add(LootItem.lootTableItem(CABlocks.APPLE_SAPLING.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 1.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer()))*/)
                .withPool(LootPool.lootPool()
    ...
    public static LootTable.Builder createBirchEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
    ...
    public static LootTable.Builder createCherryEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                ...
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(Blocks.CHERRY_LEAVES)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 1.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer()))
                        .add(LootItem.lootTableItem(Blocks.CHERRY_SAPLING)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 1.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer())))
                .withPool(LootPool.lootPool()
    ...
    public static LootTable.Builder createCrimsonEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
    ...
    public static LootTable.Builder createDarkOakEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                ...
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1)).add(
                                LootItem.lootTableItem(Items.CORNFLOWER)
                                        .when(LootItemKilledByPlayerCondition.killedByPlayer())))
                .withPool(LootPool.lootPool()
                        .setRolls(UniformGenerator.between(1, 2))
                        .add(LootItem.lootTableItem(Items.DIAMOND)
    ...
    public static LootTable.Builder createGinkgoEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(CABlocks.GINKGO_LOG.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(18.0F, 24.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 3.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer())))
                .withPool(LootPool.lootPool()
    ...
    public static LootTable.Builder createJungleEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
    ...
    public static LootTable.Builder createOakEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
    ...
    public static LootTable.Builder createPeachEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(CABlocks.PEACH_LOG.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(18.0F, 24.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 3.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer())))
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(CABlocks.PEACH_LEAVES.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 1.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer()))
              /*          .add(LootItem.lootTableItem(CABlocks.PEACH_SAPLING.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 1.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer()))*/)
                .withPool(LootPool.lootPool()
    ...
    public static LootTable.Builder createSpruceEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
    ...
    public static LootTable.Builder createSkywoodEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(CABlocks.SKYWOOD_LOG.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(18.0F, 24.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 3.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer())))
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(CABlocks.SKYWOOD_LEAVES.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F)))
                                .apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1.0F, 1.0F)))
                                .when(LootItemKilledByPlayerCondition.killedByPlayer())))
                .withPool(LootPool.lootPool()
    ...
    public static LootTable.Builder createWarpedEntLootTable(Supplier<EntityType<Ent>> ownerType) {
        return LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1))
