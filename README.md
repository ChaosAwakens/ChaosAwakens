...
**A:** This was started as an idea from the admins of the [*formerly named DangerZone modding Discord*](https://discord.gg/9dFVHCWj9v), about a small while after the official *OreSpawn* update was cancelled due to social media drama. This grew to grow in its own path, and hopefully it keeps doing so.
